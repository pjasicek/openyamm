...
script.labels["Onblabber"] = function(ctx)
    -- KNUTSPEECH.scr:22
    -- knuts blabber
    ctx:command("wait", "1 1, Speak") -- KNUTSPEECH.scr:26
...
script.labels["Speak"] = function(ctx)
    ...
    if ctx:condition("sound==0") then -- KNUTSPEECH.scr:34
        ctx:command("set", "sound, 1") -- KNUTSPEECH.scr:35
        ctx:giveKey(114) -- KNUTSPEECH.scr:36
        ctx:command("playsoundhandle", "voices\\cinema\\socialism\\KnutFAstmouth01.wav, soundhandle, 768, FALSE, 100") -- KNUTSPEECH.scr:37
        ctx:command("getsoundduration", ", soundhandle, sounddur") -- KNUTSPEECH.scr:38
        -- trigger ake's script to start heckles
        ctx:command("getobjecthandle", "params, g_hobject") -- KNUTSPEECH.scr:41
        ctx:trigger("g_hobject", "blabber") -- KNUTSPEECH.scr:42
        ctx:command("subtract", "sounddur, 5") -- KNUTSPEECH.scr:43
        ctx:command("wait", "1 sounddur, shutup") -- KNUTSPEECH.scr:44
...
script.labels["Conv"] = function(ctx)
    ...
    ctx:command("converse", "-1 conv") -- KNUTSPEECH.scr:56
...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:condition("sound==1") then -- KNUTSPEECH.scr:64
        ctx:command("killsound", "soundhandle") -- KNUTSPEECH.scr:65
        ctx:command("set", "sound, 0") -- KNUTSPEECH.scr:67
        ctx:command("set", "g_ntemp, 0") -- KNUTSPEECH.scr:68
...
script.labels["shutup"] = function(ctx)
    -- KNUTSPEECH.scr:75
    ctx:command("set", "nShutup, True") -- KNUTSPEECH.scr:78
    ctx:trigger("g_hobject", "shutup") -- KNUTSPEECH.scr:79
    ctx:command("wait", "1 6, onexit") -- KNUTSPEECH.scr:80
...
script.labels["Onexit"] = function(ctx)
    ...
    ctx:command("issounddone", "soundhandle, sounddone") -- KNUTSPEECH.scr:89
    if ctx:condition("sounddone==1") then -- KNUTSPEECH.scr:90
        ctx:command("killsound", "soundhandle") -- KNUTSPEECH.scr:91
...
script.labels["GoPosition1"] = function(ctx)
    -- KNUTSPEECH.scr:97
    ctx:command("setpos", "g_hMyObject,3424.0 1344.0 -672.0") -- KNUTSPEECH.scr:99
    ctx:command("facedir", "0,0,0,0") -- KNUTSPEECH.scr:100
    do return ctx:exit("") end -- KNUTSPEECH.scr:102
end

script.labels["GoPosition2"] = function(ctx)
    -- KNUTSPEECH.scr:105
    ctx:command("setpos", "g_hMyObject,3494,1254,3166") -- KNUTSPEECH.scr:107
    ctx:command("facedir", "0.78,0,0.63,0") -- KNUTSPEECH.scr:108
    do return ctx:exit("") end -- KNUTSPEECH.scr:110
end

script.labels["GoPosition3"] = function(ctx)
    -- KNUTSPEECH.scr:113
    ctx:command("setpos", "g_hMyObject,-933,1254,2036") -- KNUTSPEECH.scr:116
    ctx:command("facedir", "0.7,0,0.72,0") -- KNUTSPEECH.scr:117
    do return ctx:exit("") end -- KNUTSPEECH.scr:119
end

script.labels["GoPosition4"] = function(ctx)
    -- KNUTSPEECH.scr:122
    ctx:command("setpos", "g_hMyObject,-2324,1254,4559") -- KNUTSPEECH.scr:125
    ctx:command("facedir", "0.75,0,0.67,0") -- KNUTSPEECH.scr:126
    do return ctx:exit("") end -- KNUTSPEECH.scr:128
end

script.labels["SetupPosition"] = function(ctx)
    -- KNUTSPEECH.scr:131
    ctx:command("getmyhandle", "g_hMyObject") -- KNUTSPEECH.scr:134
    ctx:command("add", "nPosition,1") -- KNUTSPEECH.scr:136
    if ctx:condition("nPosition>4") then -- KNUTSPEECH.scr:138
        ctx:command("nposition", "= 1") -- KNUTSPEECH.scr:139
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("onfoundplayer", "OnBlabber") -- KNUTSPEECH.scr:174
    ctx:getParam(0, "Params") -- KNUTSPEECH.scr:175
    ctx:command("set", "sound, 0") -- KNUTSPEECH.scr:176
    ctx:command("set", "g_ntemp, 0") -- KNUTSPEECH.scr:177
    if ctx:hasKey(114) then -- KNUTSPEECH.scr:178-179
        ctx:command("set", "sound, 1") -- KNUTSPEECH.scr:180
    end -- KNUTSPEECH.scr:181
    mm9.gosub(script, ctx, "SetupPosition") -- KNUTSPEECH.scr:183
    ctx:command("onpostminisaveload", "PostMiniSaveLoad") -- KNUTSPEECH.scr:185
