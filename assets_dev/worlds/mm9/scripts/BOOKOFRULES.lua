...
script.labels["Onuse"] = function(ctx)
    ...
    if ctx:condition("g_ntemp==1") then -- BOOKOFRULES.scr:21
        ...
        if ctx:condition("keycheck==0") then -- BOOKOFRULES.scr:24
            ...
            ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- BOOKOFRULES.scr:34
            ctx:command("getobjecthandle", "BookRules g_hobject") -- BOOKOFRULES.scr:35
            ctx:command("removeobject", "g_hobject") -- BOOKOFRULES.scr:36
    ...
    if ctx:condition("keycheck==0") then -- BOOKOFRULES.scr:42
        ...
        ctx:command("set", "keydata, 166") -- BOOKOFRULES.scr:45
        ...
        ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- BOOKOFRULES.scr:53
        ctx:command("getobjecthandle", "BookRules g_hobject") -- BOOKOFRULES.scr:54
        ctx:command("removeobject", "g_hobject") -- BOOKOFRULES.scr:55
...
script.labels["Main"] = function(ctx)
    ...
    if ctx:condition("g_ntemp==1") then -- BOOKOFRULES.scr:71
        ctx:command("getobjecthandle", "manuscript g_hobject") -- BOOKOFRULES.scr:72
        ctx:command("removeobject", "g_hobject") -- BOOKOFRULES.scr:73
        ctx:command("exitscript", "") -- BOOKOFRULES.scr:74
    ...
    if ctx:condition("g_ntemp==1") then -- BOOKOFRULES.scr:79
        ctx:command("getobjecthandle", "manuscript g_hobject") -- BOOKOFRULES.scr:80
        ctx:command("removeobject", "g_hobject") -- BOOKOFRULES.scr:81
        ctx:command("exitscript", "") -- BOOKOFRULES.scr:82
