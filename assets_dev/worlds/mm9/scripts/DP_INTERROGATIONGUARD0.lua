...
script.labels["Directions"] = function(ctx)
    ...
    ctx:set("nCount", "nCount + 1") -- DP_INTERROGATIONGUARD0.scr:50
                ...
                if ctx:condition("nCount==4") then -- DP_INTERROGATIONGUARD0.scr:61
                    ...
                    if ctx:condition("nCount==5") then -- DP_INTERROGATIONGUARD0.scr:64
                        ...
                        if ctx:condition("nCount==6") then -- DP_INTERROGATIONGUARD0.scr:67
                            ctx:state().nCount = 0 -- DP_INTERROGATIONGUARD0.scr:68
...
script.labels["WalkToLastMarker"] = function(ctx)
    ...
    if ctx:condition("nNumA==1") then -- DP_INTERROGATIONGUARD0.scr:80
        ctx:set("nMarker", "nMarker + 1") -- DP_INTERROGATIONGUARD0.scr:81
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:82
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:83
        ctx:state().hCellDoor = nil -- DP_INTERROGATIONGUARD0.scr:84
        ctx:state().hCellDoor = ctx:objectOrNil("sCellDoorA") -- DP_INTERROGATIONGUARD0.scr:85
        ctx:self():walkTo(ctx:object("hMarker"), 10, "Cell") -- DP_INTERROGATIONGUARD0.scr:86
    end -- DP_INTERROGATIONGUARD0.scr:87
    if ctx:condition("nNumA==2") then -- DP_INTERROGATIONGUARD0.scr:88
        ctx:set("nMarker", "nMarker + 2") -- DP_INTERROGATIONGUARD0.scr:89
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:90
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:91
        ctx:state().hCellDoor = nil -- DP_INTERROGATIONGUARD0.scr:92
        ctx:state().hCellDoor = ctx:objectOrNil("sCellDoorB") -- DP_INTERROGATIONGUARD0.scr:93
        ctx:self():walkTo(ctx:object("hMarker"), 10, "Cell") -- DP_INTERROGATIONGUARD0.scr:94
    end -- DP_INTERROGATIONGUARD0.scr:95
    if ctx:condition("nNumA==3") then -- DP_INTERROGATIONGUARD0.scr:96
        ctx:set("nMarker", "nMarker + 3") -- DP_INTERROGATIONGUARD0.scr:97
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:98
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:99
        ctx:state().hCellDoor = nil -- DP_INTERROGATIONGUARD0.scr:100
        ctx:state().hCellDoor = ctx:objectOrNil("sCellDoorC") -- DP_INTERROGATIONGUARD0.scr:101
        ctx:self():walkTo(ctx:object("hMarker"), 10, "Cell") -- DP_INTERROGATIONGUARD0.scr:102
...
script.labels["DoTheWalk"] = function(ctx)
    ...
    ctx:set("nReset", "nReset + 1") -- DP_INTERROGATIONGUARD0.scr:111
    ctx:cprint("DoTheWalk") -- DP_INTERROGATIONGUARD0.scr:112
    ctx:cprint("nReset") -- DP_INTERROGATIONGUARD0.scr:113
    if ctx:condition("nVarPath==0") then -- DP_INTERROGATIONGUARD0.scr:114
        ctx:state().nVarPath = 1 -- DP_INTERROGATIONGUARD0.scr:115
        ctx:set("nNumA", "nNumA + 1") -- DP_INTERROGATIONGUARD0.scr:116
        mm9.gosub(script, ctx, "ToTheWarden") -- DP_INTERROGATIONGUARD0.scr:117
    else -- DP_INTERROGATIONGUARD0.scr:118
        ctx:state().nVarPath = 0 -- DP_INTERROGATIONGUARD0.scr:119
...
script.labels["ToTheWarden"] = function(ctx)
    ...
    if ctx:condition("nMarker == 0") then -- DP_INTERROGATIONGUARD0.scr:131
        ctx:playSound("Sounds\\Door\\doorslammetal02.wav", "DoNothing", "hDummy", 5000, "FALSE", 100) -- DP_INTERROGATIONGUARD0.scr:133
        ctx:wait(0, .3, "DoNothing") -- DP_INTERROGATIONGUARD0.scr:134
    ...
    if ctx:condition("nMarker < nNumMarkers") then -- DP_INTERROGATIONGUARD0.scr:138
        ctx:set("nMarker", "nMarker + 1") -- DP_INTERROGATIONGUARD0.scr:139
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:140
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:141
        ctx:self():walkTo(ctx:object("hMarker"), 10, "ToTheWarden") -- DP_INTERROGATIONGUARD0.scr:142
...
script.labels["ToTheInterrogation"] = function(ctx)
    ...
    if ctx:condition("nMarker != 0") then -- DP_INTERROGATIONGUARD0.scr:152
        ctx:set("nMarker", "nMarker - 1") -- DP_INTERROGATIONGUARD0.scr:153
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:154
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:155
        ctx:self():walkTo(ctx:object("hMarker"), 10, "ToTheInterrogation") -- DP_INTERROGATIONGUARD0.scr:156
...
script.labels["InterrogationRoom"] = function(ctx)
    ...
    if ctx:condition("nReset==6") then -- DP_INTERROGATIONGUARD0.scr:166
        ctx:state().nReset = 0 -- DP_INTERROGATIONGUARD0.scr:167
        ctx:self():stop() -- DP_INTERROGATIONGUARD0.scr:168
    else -- DP_INTERROGATIONGUARD0.scr:169
        ctx:state().nMarker = 0 -- DP_INTERROGATIONGUARD0.scr:170
        ctx:trigger("hDoorMan", "LockRoom") -- DP_INTERROGATIONGUARD0.scr:171
        ctx:self():stop() -- DP_INTERROGATIONGUARD0.scr:172
        ctx:self():playAnimation("Aware", "DoNothing") -- DP_INTERROGATIONGUARD0.scr:173
        ctx:playSound("sounds\\BeatdownMixChained_8.wav", "DoNothing", 100, 500, "FALSE", 90) -- DP_INTERROGATIONGUARD0.scr:174
        ctx:wait(1, 15, "DoTheWalk") -- DP_INTERROGATIONGUARD0.scr:175
...
script.labels["NextPrisoner"] = function(ctx)
    ...
    if ctx:condition("nNumA==1") then -- DP_INTERROGATIONGUARD0.scr:187
        ctx:set("nMarker", "nMarker + 1") -- DP_INTERROGATIONGUARD0.scr:188
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:189
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:190
        ctx:state().nMarker = 4 -- DP_INTERROGATIONGUARD0.scr:191
        ctx:state().hCellDoor = nil -- DP_INTERROGATIONGUARD0.scr:192
        ctx:state().hCellDoor = ctx:objectOrNil("sCellDoorB") -- DP_INTERROGATIONGUARD0.scr:193
        ctx:self():walkTo(ctx:object("hMarker"), 10, "Cell") -- DP_INTERROGATIONGUARD0.scr:194
    end -- DP_INTERROGATIONGUARD0.scr:195
    if ctx:condition("nNumA==2") then -- DP_INTERROGATIONGUARD0.scr:197
        ctx:set("nMarker", "nMarker + 1") -- DP_INTERROGATIONGUARD0.scr:198
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:199
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:200
        ctx:state().nMarker = 4 -- DP_INTERROGATIONGUARD0.scr:201
        ctx:state().hCellDoor = nil -- DP_INTERROGATIONGUARD0.scr:202
        ctx:state().hCellDoor = ctx:objectOrNil("sCellDoorC") -- DP_INTERROGATIONGUARD0.scr:203
        ctx:self():walkTo(ctx:object("hMarker"), 10, "Cell") -- DP_INTERROGATIONGUARD0.scr:204
    end -- DP_INTERROGATIONGUARD0.scr:205
    if ctx:condition("nNumA==3") then -- DP_INTERROGATIONGUARD0.scr:207
        ctx:set("nMarker", "nMarker - 2") -- DP_INTERROGATIONGUARD0.scr:208
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONGUARD0.scr:209
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONGUARD0.scr:210
        ctx:state().nMarker = 4 -- DP_INTERROGATIONGUARD0.scr:211
        ctx:state().hCellDoor = nil -- DP_INTERROGATIONGUARD0.scr:212
        ctx:state().hCellDoor = ctx:objectOrNil("sCellDoorA") -- DP_INTERROGATIONGUARD0.scr:213
        ctx:state().nNumA = 0 -- DP_INTERROGATIONGUARD0.scr:214
        ctx:self():walkTo(ctx:object("hMarker"), 10, "Cell") -- DP_INTERROGATIONGUARD0.scr:215
...
script.labels["Cell"] = function(ctx)
    ...
    ctx:self():stop() -- DP_INTERROGATIONGUARD0.scr:224
    ctx:trigger("hWarden", "OpenCell") -- DP_INTERROGATIONGUARD0.scr:225
    ctx:wait(1, 2, "DoNothing") -- DP_INTERROGATIONGUARD0.scr:226
    ctx:self():playAnimation("Fidget1", "DoNothing") -- DP_INTERROGATIONGUARD0.scr:227
    ctx:self():faceObject(ctx:object("hCellDoor"), 220, "DoNothing") -- DP_INTERROGATIONGUARD0.scr:228
...
script.labels["CheckPlayer"] = function(ctx)
    ...
    ctx:state().bIsPlayer = ctx:object("hParam"):isPlayer() -- DP_INTERROGATIONGUARD0.scr:236
    ...
    ctx:set("bHasHostileKey", "1 - bHasHostileKey") -- DP_INTERROGATIONGUARD0.scr:239
    ctx:set("bResult", "bHasFriendlyKey * bHasHostileKey * bIsPlayer") -- DP_INTERROGATIONGUARD0.scr:240
    if ctx:condition("bResult == FALSE") then -- DP_INTERROGATIONGUARD0.scr:241
        ...
        ctx:self():addFriend("Player") -- DP_INTERROGATIONGUARD0.scr:245
...
script.labels["AlertCall"] = function(ctx)
    ...
    if ctx:condition("sMyGuard==Interrogator0") then -- DP_INTERROGATIONGUARD0.scr:266
        ctx:playSound("sounds\\VO\\Charrrge.wav", "DoNothing", 100, 500, "FALSE", 90) -- DP_INTERROGATIONGUARD0.scr:267
    else -- DP_INTERROGATIONGUARD0.scr:268
        ctx:playSound("sounds\\VO\\TheyAreHere.wav", "DoNothing", 100, 500, "FALSE", 90) -- DP_INTERROGATIONGUARD0.scr:269
    end -- DP_INTERROGATIONGUARD0.scr:270
    ctx:self():runTo(ctx:object("hParam"), 25, "BaseInit") -- DP_INTERROGATIONGUARD0.scr:271
    do return ctx:exit(1) end -- DP_INTERROGATIONGUARD0.scr:272
end

script.labels["Main2"] = function(ctx)
    -- DP_INTERROGATIONGUARD0.scr:275
    ctx:state().hDoorMan = ctx:objectOrNil("InterrDoorman") -- DP_INTERROGATIONGUARD0.scr:277
    ctx:state().hWarden = ctx:objectOrNil("InterrWarden") -- DP_INTERROGATIONGUARD0.scr:278
    ctx:state().nVarPath = 0 -- DP_INTERROGATIONGUARD0.scr:279
    ctx:set("nNumMarkers", "nNumMarkers - 2") -- DP_INTERROGATIONGUARD0.scr:280
    ...
    ctx:onEvent("OnFoundTarget", "CheckPlayer") -- DP_INTERROGATIONGUARD0.scr:285
    ctx:onEvent("OnDamage", "SetKeyValue") -- DP_INTERROGATIONGUARD0.scr:286
    do return ctx:exit(1) end -- DP_INTERROGATIONGUARD0.scr:288
end

script.labels["Main"] = function(ctx)
    -- DP_INTERROGATIONGUARD0.scr:291
    ctx:self():addFriend("PrisonerHumanMaleA") -- DP_INTERROGATIONGUARD0.scr:293
    ...
    ctx:wait(0, .1, "main2") -- DP_INTERROGATIONGUARD0.scr:301
