...
script.labels["OnStop"] = function(ctx)
    -- NPC151.scr:19
    ctx:command("stop", "") -- NPC151.scr:21
...
script.labels["OnSpeak2"] = function(ctx)
    -- NPC151.scr:26
    ctx:setPropNumber("DoRude", "False") -- NPC151.scr:29
    ctx:command("loopanim", "conv1 0 DoNothing") -- NPC151.scr:30
    ctx:command("playsound", "voices\\cinema\\NewGame\\02.wav, DoNothing, 100, 768, FALSE, 100") -- NPC151.scr:31
    ctx:command("wait", "1 .5, Trigger3") -- NPC151.scr:32
...
script.labels["Trigger3"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "Scandlan g_hobject") -- NPC151.scr:41
    ctx:trigger("g_hobject", "Speak3") -- NPC151.scr:42
    do return ctx:exit("") end -- NPC151.scr:43
end

script.labels["OnSpeak4"] = function(ctx)
    -- NPC151.scr:47
    ctx:command("loopanim", "conv1 0 DoNothing") -- NPC151.scr:50
    ctx:command("playsound", "voices\\cinema\\NewGame\\04.wav, DoNothing, 100, 768, FALSE, 100") -- NPC151.scr:51
    ctx:command("wait", "1 .5, Trigger5") -- NPC151.scr:52
...
script.labels["Trigger5"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "Scandlan g_hobject") -- NPC151.scr:61
    ctx:trigger("g_hobject", "Speak5") -- NPC151.scr:62
    do return ctx:exit("") end -- NPC151.scr:63
end

script.labels["OnSpeak6"] = function(ctx)
    -- NPC151.scr:68
    ctx:command("loopanim", "conv1 0 DoNothing") -- NPC151.scr:71
    ctx:command("playsound", "voices\\cinema\\NewGame\\06.wav, DoNothing, 100, 768, FALSE, 100") -- NPC151.scr:72
    ctx:command("wait", "1 1, Trigger7") -- NPC151.scr:73
...
script.labels["Trigger7"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "Scandlan g_hobject") -- NPC151.scr:82
    ctx:trigger("g_hobject", "Speak7") -- NPC151.scr:83
    do return ctx:exit("") end -- NPC151.scr:84
end

script.labels["OnSpeak8"] = function(ctx)
    -- NPC151.scr:87
    ctx:command("loopanim", "conv1 0 DoNothing") -- NPC151.scr:90
    ctx:command("playsound", "voices\\cinema\\NewGame\\08.wav, DoNothing, 100, 768, FALSE, 100") -- NPC151.scr:91
    ctx:command("wait", "1 .5, Trigger9") -- NPC151.scr:92
...
script.labels["Trigger9"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "Scandlan g_hobject") -- NPC151.scr:101
    ctx:trigger("g_hobject", "Speak9") -- NPC151.scr:102
    do return ctx:exit("") end -- NPC151.scr:103
end

script.labels["OnSpeak10"] = function(ctx)
    -- NPC151.scr:106
    ctx:command("loopanim", "conv1 0 DoNothing") -- NPC151.scr:109
    ctx:command("playsound", "voices\\cinema\\NewGame\\10.wav, DoNothing, 100, 768, FALSE, 100") -- NPC151.scr:110
    ctx:command("wait", "1 1, Trigger11") -- NPC151.scr:111
...
script.labels["Trigger11"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "Scandlan g_hobject") -- NPC151.scr:120
    ctx:trigger("g_hobject", "Speak11") -- NPC151.scr:121
    do return ctx:exit("") end -- NPC151.scr:122
end

script.labels["OnWalkAway"] = function(ctx)
    -- NPC151.scr:125
    ctx:setPropNumber("DoRude", "TRUE") -- NPC151.scr:127
    ctx:command("target", "NULL") -- NPC151.scr:128
    ctx:command("getobjecthandle", "CommonerHalfOrcMaleA0 g_hobject") -- NPC151.scr:129
    ctx:command("walkto", "g_hobject 10 OnWander") -- NPC151.scr:130
...
script.labels["OnTarget"] = function(ctx)
    -- NPC151.scr:145
    ctx:setPropNumber("DoRude", "False") -- NPC151.scr:147
    ctx:getParam(0, "g_hTarget") -- NPC151.scr:148
    ctx:command("target", "g_htarget") -- NPC151.scr:149
