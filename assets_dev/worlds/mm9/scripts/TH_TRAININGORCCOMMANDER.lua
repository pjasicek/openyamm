...
script.labels["Start"] = function(ctx)
    ...
    ctx:command("bistraining", "= TRUE") -- TH_TRAININGORCCOMMANDER.scr:18
...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:command("wait", "1, 1, DoNothing") -- TH_TRAININGORCCOMMANDER.scr:24
    ctx:command("bistraining", "= FALSE") -- TH_TRAININGORCCOMMANDER.scr:25
...
script.labels["CommandTwo"] = function(ctx)
    ...
    ctx:command("playsound", "Sounds\\AnimSounds\\LizardOrcwince1.wav DoNothing 1000 1500 FALSE 100") -- TH_TRAININGORCCOMMANDER.scr:30
    ctx:command("playanim", "Taunt, StartTraining") -- TH_TRAININGORCCOMMANDER.scr:31
    do return ctx:exit("TRUE") end -- TH_TRAININGORCCOMMANDER.scr:32
end

script.labels["Relax"] = function(ctx)
    -- TH_TRAININGORCCOMMANDER.scr:34
    ctx:command("playanim", "Stand, CommandTwo") -- TH_TRAININGORCCOMMANDER.scr:36
...
script.labels["CommandOne"] = function(ctx)
    ...
    ctx:command("playsound", "Sounds\\AnimSounds\\LizardOrcfidget3.wav DoNothing 1000 1500 FALSE 100") -- TH_TRAININGORCCOMMANDER.scr:41
    ctx:command("playanim", "Fidget2, Relax") -- TH_TRAININGORCCOMMANDER.scr:42
...
script.labels["StartTraining"] = function(ctx)
    ...
    ctx:command("playanim", "Stand, CommandOne") -- TH_TRAININGORCCOMMANDER.scr:50
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("onpoststartworld", "Main2") -- TH_TRAININGORCCOMMANDER.scr:62
