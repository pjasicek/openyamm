...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("oncachefiles", "CacheFiles") -- ILSFIREBOOK.scr:23
    ctx:command("getmyhandle", "hMe") -- ILSFIREBOOK.scr:25
    do return ctx:exit("TRUE") end -- ILSFIREBOOK.scr:27
end

script.labels["CacheFiles"] = function(ctx)
    -- ILSFIREBOOK.scr:30
    ctx:command("cacheclientfx", "SPELL_SPARKLIES") -- ILSFIREBOOK.scr:32
...
script.labels["CastSpell"] = function(ctx)
    ...
    if ctx:condition("hShooter==0") then -- ILSFIREBOOK.scr:39
        ctx:command("getobjecthandle", "sShooterName, hShooter") -- ILSFIREBOOK.scr:40
    end -- ILSFIREBOOK.scr:41
    if ctx:condition("bOpen==FALSE") then -- ILSFIREBOOK.scr:43
        ctx:command("bopen", "= TRUE") -- ILSFIREBOOK.scr:44
        ctx:command("playanim", "OpenBook, TriggerShooter") -- ILSFIREBOOK.scr:45
...
script.labels["TriggerShooter"] = function(ctx)
    -- ILSFIREBOOK.scr:53
    ctx:command("doclientfx", "hMe, SPELL_SPARKLIES, FALSE, TRUE") -- ILSFIREBOOK.scr:55
