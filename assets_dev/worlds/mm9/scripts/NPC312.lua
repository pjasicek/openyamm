...
script.labels["OnRude"] = function(ctx)
    ...
    if ctx:condition("nTarget==TRUE") then -- NPC312.scr:15
        ctx:self():setTarget(ctx:object("g_htarget")) -- NPC312.scr:16
        ctx:onEvent("OnTargetWithinDist", 512, "RuntoMe") -- NPC312.scr:17
    ...
    if ctx:hasKey(467) then -- NPC312.scr:27-28
        ...
        ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC312.scr:31
...
script.labels["ONTarget"] = function(ctx)
    -- NPC312.scr:39
    ctx:state().nTarget = true -- NPC312.scr:41
    ctx:getParam(0, "g_htarget") -- NPC312.scr:42
    ctx:self():setTarget(ctx:object("g_htarget")) -- NPC312.scr:43
    ctx:onEvent("OnTargetWithinDist", 512, "RuntoMe") -- NPC312.scr:44
...
script.labels["RuntoMe"] = function(ctx)
    ...
    ctx:state().nTarget = false -- NPC312.scr:53
    do return ctx:exit("") end -- NPC312.scr:54
end

script.labels["OnUse"] = function(ctx)
    -- NPC312.scr:57
    ctx:onEvent("OnTargetWithinDist", 512, "DoNothing") -- NPC312.scr:60
    ctx:playSound("voices\\NPC\\NPC_312.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC312.scr:62
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnLostTarget", "OnLost") -- NPC312.scr:79
