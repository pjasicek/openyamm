...
script.labels["PromotePaladin"] = function(ctx)
    ...
    ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC282.scr:58
    if ctx:hasKey(421) then -- NPC282.scr:60-61
        ctx:givePromo("Paladin", "Char1") -- NPC282.scr:62
        ctx:takeKey(421) -- NPC282.scr:63
    end -- NPC282.scr:64
    if ctx:hasKey(422) then -- NPC282.scr:66-67
        ctx:givePromo("Paladin", "Char2") -- NPC282.scr:68
        ctx:takeKey(422) -- NPC282.scr:69
    end -- NPC282.scr:70
    if ctx:hasKey(423) then -- NPC282.scr:72-73
        ctx:givePromo("Paladin", "Char3") -- NPC282.scr:74
        ctx:takeKey(423) -- NPC282.scr:75
    end -- NPC282.scr:76
    if ctx:hasKey(424) then -- NPC282.scr:78-79
        ctx:givePromo("Paladin", "Char4") -- NPC282.scr:80
...
script.labels["paladins"] = function(ctx)
    ...
    if not ctx:hasKey(237) then -- NPC282.scr:89-90
        if ctx:hasKey(236) then -- NPC282.scr:91-92
            ...
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC282.scr:94
...
script.labels["OnUse"] = function(ctx)
    -- NPC282.scr:120
    ctx:self():stop() -- NPC282.scr:123
    mm9.gosub(script, ctx, "BaseWanderStop") -- NPC282.scr:124
    ctx:getParam(0, "g_hobject") -- NPC282.scr:125
    ctx:self():faceObject(ctx:object("g_hobject"), 240, "DoNothing") -- NPC282.scr:126
    ctx:doRude(282) -- NPC282.scr:127
    ctx:playSound("voices\\NPC\\NPC_282.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC282.scr:128
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "Init") -- NPC282.scr:149
    ctx:onEvent("OnPostMiniSaveLoad", "Init") -- NPC282.scr:150
    ctx:onEvent("OnPostSaveLoad", "Init") -- NPC282.scr:151
    ctx:wait(1, .1, "Init") -- NPC282.scr:152
