...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "InitKingKong") -- KINGKONG.scr:32
    do return ctx:exit("TRUE") end -- KINGKONG.scr:34
end

script.labels["InitKingKong"] = function(ctx)
    -- KINGKONG.scr:37
    ctx:state().hCage = ctx:objectOrNil("sCageName") -- KINGKONG.scr:39
    ...
    if ctx:condition("ANIM_NAME!=\"\"") then -- KINGKONG.scr:45
        ctx:self():loopAnimation("ANIM_NAME", 0) -- KINGKONG.scr:46
    end -- KINGKONG.scr:47
...
script.labels["RushCage"] = function(ctx)
    ...
    ctx:playSound("sounds\\animsounds\\dragonredrattack3.wav", "DoNothing", 1, 500, "FALSE", 100) -- KINGKONG.scr:55
...
script.labels["BreakCage"] = function(ctx)
    ...
    ctx:state().hCage = ctx:objectOrNil("sCageName") -- KINGKONG.scr:65
    if ctx:condition("hCage!=NULL") then -- KINGKONG.scr:66
        ctx:trigger("hCage", "destroy") -- KINGKONG.scr:67
    end -- KINGKONG.scr:68
    ctx:self():playAnimation("hattack1", "turnoff") -- KINGKONG.scr:70
...
script.labels["FallThrough"] = function(ctx)
    ...
    ctx:state().hCage = ctx:objectOrNil("sCageName") -- KINGKONG.scr:80
...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:removeTrigger("ForceBreak") -- KINGKONG.scr:93
    ctx:removeTrigger("ForceFall") -- KINGKONG.scr:94
    ctx:removeTrigger("ForceAttack") -- KINGKONG.scr:95
    mm9.gosub(script, ctx, "BaseInit") -- KINGKONG.scr:97
    ctx:state().g_hTarget = ctx:player() -- KINGKONG.scr:98
