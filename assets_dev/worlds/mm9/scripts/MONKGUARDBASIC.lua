...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "InitMonkGuardBasic") -- MONKGUARDBASIC.scr:43
    ctx:onEvent("OnPostMiniSaveLoad", "InitMonkGuardBasic") -- MONKGUARDBASIC.scr:44
...
script.labels["InitMonkGuardBasic"] = function(ctx)
    ...
    if ctx:condition("MONK_TYPE<0") then -- MONKGUARDBASIC.scr:56
        ...
        ctx:state().xMe, ctx:state().yMe, ctx:state().zMe = ctx:self():pos() -- MONKGUARDBASIC.scr:59
        ctx:state().hPlace = ctx:objectOrNil("MONK_PLACE") -- MONKGUARDBASIC.scr:60
        ...
        if ctx:condition("MONK_TYPE>0") then -- MONKGUARDBASIC.scr:70
            ...
            if ctx:condition("MONK_TYPE>2") then -- MONKGUARDBASIC.scr:72
                ctx:self():faceObject(ctx:object("hPlace"), 360, "StartWork") -- MONKGUARDBASIC.scr:73
...
script.labels["StartPrayer"] = function(ctx)
    ...
    if ctx:condition("hPlace!=0") then -- MONKGUARDBASIC.scr:85
        ctx:self():walkTo(ctx:object("hPlace"), 100, "Pray") -- MONKGUARDBASIC.scr:86
...
script.labels["AttachTool"] = function(ctx)
    ...
    if ctx:condition("MONK_TYPE==1") then -- MONKGUARDBASIC.scr:124
        ctx:self():attachProp("MonkHoe.ABC", "MonkHoe.DTX", "Hoe", ctx:object("hProp")) -- MONKGUARDBASIC.scr:125
        ctx:state().sAnimName = "hoe" -- MONKGUARDBASIC.scr:126
        ctx:state().sPauseName = "hoewait" -- MONKGUARDBASIC.scr:127
        ctx:state().Fidget_Name = "HoeFidget" -- MONKGUARDBASIC.scr:128
    else -- MONKGUARDBASIC.scr:129
        if ctx:condition("MONK_TYPE==2") then -- MONKGUARDBASIC.scr:130
            ctx:self():attachProp("MonkBroom.ABC", "MonkBroom.DTX", "Broom", ctx:object("hProp")) -- MONKGUARDBASIC.scr:131
            ctx:state().sAnimName = "sweep" -- MONKGUARDBASIC.scr:132
            ctx:state().sPauseName = "sweepwait" -- MONKGUARDBASIC.scr:133
            ctx:state().Fidget_Name = "SweepFidget" -- MONKGUARDBASIC.scr:134
        else -- MONKGUARDBASIC.scr:135
            if ctx:condition("MONK_TYPE==3") then -- MONKGUARDBASIC.scr:136
                ctx:self():attachProp("MonkHammer.ABC", "MonkHammer.DTX", "Hammer", ctx:object("hProp")) -- MONKGUARDBASIC.scr:137
                ctx:state().sAnimName = "hammer" -- MONKGUARDBASIC.scr:138
                ctx:state().sPauseName = "hammerwait" -- MONKGUARDBASIC.scr:139
                ctx:state().Fidget_Name = "HammerFidget" -- MONKGUARDBASIC.scr:140
            else -- MONKGUARDBASIC.scr:141
                if ctx:condition("MONK_TYPE==4") then -- MONKGUARDBASIC.scr:142
                    ctx:self():attachProp("MonkCloth.ABC", "MonkCloth.DTX", "Cloth", ctx:object("hProp")) -- MONKGUARDBASIC.scr:143
                    ctx:state().sAnimName = "wash" -- MONKGUARDBASIC.scr:144
                    ctx:state().sPauseName = "washwait" -- MONKGUARDBASIC.scr:145
                    ctx:state().Fidget_Name = "WashFidget" -- MONKGUARDBASIC.scr:146
...
script.labels["OnRudeEnter"] = function(ctx)
    ...
    if ctx:condition("MONK_TYPE<0") then -- MONKGUARDBASIC.scr:159
        ctx:self():faceObject(ctx:object("hSpeaker"), 360, "DoNothing") -- MONKGUARDBASIC.scr:160
    else -- MONKGUARDBASIC.scr:161
        if ctx:condition("MONK_TYPE==0") then -- MONKGUARDBASIC.scr:162
            ctx:self():faceObject(ctx:object("hSpeaker"), 360, "BaseWanderStop") -- MONKGUARDBASIC.scr:163
        else -- MONKGUARDBASIC.scr:164
            -- TL    loopAnim stand, 0
            ctx:self():playAnimation("Fidget_Name", "FidgetStand") -- MONKGUARDBASIC.scr:166
            -- TL
            ctx:self():faceObject(ctx:object("hSpeaker"), 360, "DoNothing") -- MONKGUARDBASIC.scr:168
        end -- MONKGUARDBASIC.scr:169
    end -- MONKGUARDBASIC.scr:170
    ctx:self():pauseWait(-1) -- MONKGUARDBASIC.scr:172
...
script.labels["FidgetStand"] = function(ctx)
    ...
    ctx:self():loopAnimation("sPauseName", 0, "Donothing") -- MONKGUARDBASIC.scr:184
    do return ctx:exit("TRUE") end -- MONKGUARDBASIC.scr:186
end

script.labels["OnRudeExit"] = function(ctx)
    -- MONKGUARDBASIC.scr:190
    ctx:self():resumeWait(-1) -- MONKGUARDBASIC.scr:193
    if ctx:condition("MONK_TYPE<0") then -- MONKGUARDBASIC.scr:195
        ...
        if ctx:condition("MONK_TYPE<3") then -- MONKGUARDBASIC.scr:197
            ...
            if ctx:condition("hPlace!=0") then -- MONKGUARDBASIC.scr:200
                ctx:self():faceObject(ctx:object("hPlace"), 360, "StartWork") -- MONKGUARDBASIC.scr:201
...
script.labels["BaseWanderStopTick"] = function(ctx)
    ...
    if ctx:condition("MONK_TYPE==1") then -- MONKGUARDBASIC.scr:212
        ctx:self():loopAnimation("sAnimName", 0, "DoNothing") -- MONKGUARDBASIC.scr:213
        -- <--------TL
        ...
        if ctx:condition("MONK_TYPE==2") then -- MONKGUARDBASIC.scr:216
            ctx:self():loopAnimation("sAnimName", 0, "DoNothing") -- MONKGUARDBASIC.scr:217
            -- <--------TL
...
script.labels["BaseWanderStart"] = function(ctx)
    ...
    ctx:self():loopAnimation("sPauseName", 0, "Donothing") -- MONKGUARDBASIC.scr:235
...
script.labels["BaseWanderObstacle"] = function(ctx)
    ...
    ctx:randomInt(0, 100, "g_nRandom") -- MONKGUARDBASIC.scr:248
    ctx:getParam(0, "g_hObject") -- MONKGUARDBASIC.scr:250
    ctx:state().g_bTemp = ctx:object("g_hObject"):isClass("Actor") -- MONKGUARDBASIC.scr:251
    ...
    ctx:self():stop() -- MONKGUARDBASIC.scr:268
    ctx:self():loopAnimation("sAnimName", 0, "Donothing") -- MONKGUARDBASIC.scr:269
    ctx:wait("WANDER_LEASH_WAIT", 0, "DoNothing") -- MONKGUARDBASIC.scr:270
    ctx:state().bObstacle = true -- MONKGUARDBASIC.scr:271
    mm9.gosub(script, ctx, "BaseWanderResume") -- MONKGUARDBASIC.scr:272
    ctx:getParam(0, "g_hObject") -- MONKGUARDBASIC.scr:274
    ctx:state().g_bTemp = ctx:object("g_hObject"):isClass("Actor") -- MONKGUARDBASIC.scr:275
    if ctx:condition("g_bTemp==FALSE") then -- MONKGUARDBASIC.scr:276
        ctx:self():faceDir("normalX", 0, "normalZ", 360) -- MONKGUARDBASIC.scr:277
...
script.labels["SafeDetach"] = function(ctx)
    ...
    if ctx:condition("hProp!=0") then -- MONKGUARDBASIC.scr:296
        ctx:self():detachProp(ctx:object("hProp"), "FALSE") -- MONKGUARDBASIC.scr:297
        ctx:object("hProp"):remove() -- MONKGUARDBASIC.scr:298
        ctx:state().hProp = nil -- MONKGUARDBASIC.scr:299
