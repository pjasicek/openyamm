...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "InitStonesSquare") -- STONESSQUARE.scr:24
    ctx:onEvent("OnPostMiniSaveLoad", "InitStonesSquare") -- STONESSQUARE.scr:25
    do return ctx:exit(1) end -- STONESSQUARE.scr:27
end

script.labels["InitStonesSquare"] = function(ctx)
    -- STONESSQUARE.scr:30
    ctx:state().hPiece = ctx:objectOrNil("sPieceName") -- STONESSQUARE.scr:32
    ctx:getConsoleStrVar("STONES_GAME", "sMgrName") -- STONESSQUARE.scr:34
    ctx:state().hMgr = ctx:objectOrNil("sMgrName") -- STONESSQUARE.scr:35
...
script.labels["TurnPieceWhite"] = function(ctx)
    ...
    if ctx:condition("hPiece!=0") then -- STONESSQUARE.scr:57
        ctx:object("hPiece"):setFlag("FLAG_VISIBLE", true) -- STONESSQUARE.scr:58
...
script.labels["TurnPieceBlack"] = function(ctx)
    ...
    if ctx:condition("hPiece!=0") then -- STONESSQUARE.scr:67
        ctx:object("hPiece"):setFlag("FLAG_VISIBLE", true) -- STONESSQUARE.scr:68
...
script.labels["TurnPieceClear"] = function(ctx)
    ...
    if ctx:condition("hPiece!=0") then -- STONESSQUARE.scr:77
        ctx:object("hPiece"):setFlag("FLAG_VISIBLE", false) -- STONESSQUARE.scr:78
