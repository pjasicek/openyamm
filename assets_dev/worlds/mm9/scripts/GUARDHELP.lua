...
script.labels["OnGiveHelp"] = function(ctx)
    ...
    ctx:self():runTo(ctx:object("g_hobject"), 32, "DoNothing") -- GUARDHELP.scr:26
...
script.labels["OnTarget"] = function(ctx)
    ...
    ctx:state().bIsPlayer = ctx:object("hParam"):isPlayer() -- GUARDHELP.scr:36
    ctx:hasKey("nKeyValue", "bHasKey") -- GUARDHELP.scr:37
    ctx:set("bResult", "bIsPlayer * bHasKey") -- GUARDHELP.scr:38
    if ctx:condition("bResult != TRUE") then -- GUARDHELP.scr:39
        ctx:self():runTo(ctx:object("hParam"), 25, "BaseInit") -- GUARDHELP.scr:40
...
script.labels["Help"] = function(ctx)
    -- GUARDHELP.scr:64
    ctx:object("Help1"):trigger("help") -- GUARDHELP.scr:68-69
    ctx:object("Help2"):trigger("help") -- GUARDHELP.scr:71-72
    ctx:object("Help3"):trigger("help") -- GUARDHELP.scr:74-75
...
script.labels["Main"] = function(ctx)
    -- GUARDHELP.scr:86
    -- Traceon
    ctx:self():addFriend("CommonerHuman2MaleA") -- GUARDHELP.scr:90
    ctx:addTrigger("help", "OnGiveHelp") -- GUARDHELP.scr:91
    ctx:onEvent("OnFoundTarget", "OnTarget") -- GUARDHELP.scr:92
    ctx:onEvent("OnDamage", "OnDamage") -- GUARDHELP.scr:93
