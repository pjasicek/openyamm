...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("onpoststartworld", "InitRacingBoat") -- RACINGBOAT.scr:39
    ctx:command("onpostminisaveload", "InitRacingBoat") -- RACINGBOAT.scr:40
...
script.labels["InitRacingBoat"] = function(ctx)
    ...
    ctx:command("getmyhandle", "hMe") -- RACINGBOAT.scr:53
    ctx:command("getpos", "hMe, xMe,yMe,zMe") -- RACINGBOAT.scr:54
    ctx:command("getobjecthandle", "sDestName, hDest") -- RACINGBOAT.scr:55
    if ctx:condition("hDest==0") then -- RACINGBOAT.scr:56
        do return ctx:exit("TRUE") end -- RACINGBOAT.scr:57
    end -- RACINGBOAT.scr:58
    ctx:command("faceobject", "hDest, 0, DoNothing") -- RACINGBOAT.scr:60
    ctx:getConsoleStrVar("BOAT_JUDGE", "sJudgeName") -- RACINGBOAT.scr:61
    ctx:command("getobjecthandle", "sJudgeName, hJudge") -- RACINGBOAT.scr:62
    if ctx:condition("hJudge!=0") then -- RACINGBOAT.scr:63
        ctx:command("createobjectlink", "hJudge") -- RACINGBOAT.scr:64
        ctx:command("onobjectlinkbroken", "OnObjectLinkBroken") -- RACINGBOAT.scr:65
...
script.labels["OnObjectLinkBroken"] = function(ctx)
    -- RACINGBOAT.scr:71
    ctx:command("hjudge", "= NULL") -- RACINGBOAT.scr:73
...
script.labels["TurnOn"] = function(ctx)
    ...
    ctx:command("getdistance", "hMe, hDest, nDist") -- RACINGBOAT.scr:81
    ctx:command("ndist", "= nDist / 10") -- RACINGBOAT.scr:82
    -- if ai turned us on, start moving
    -- if player, wait till they shoot us
    if ctx:condition("bIsAI==TRUE") then -- RACINGBOAT.scr:86
        ctx:command("ntemp", "= nDist / 2") -- RACINGBOAT.scr:87
...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:command("stop", "") -- RACINGBOAT.scr:99
    -- go back, ready for another race
    ctx:command("setpos", "hMe, xMe,yMe,zMe") -- RACINGBOAT.scr:101
    ctx:command("ondamage", "DoNothing") -- RACINGBOAT.scr:103
...
script.labels["MoveForward"] = function(ctx)
    ...
    ctx:command("getdistance", "hMe, hDest, nRemainder") -- RACINGBOAT.scr:111
    ...
    ctx:command("ondamage", "DoNothing") -- RACINGBOAT.scr:119
    ctx:command("movedir", "dx,0,dz, nDist, nDist, Ready") -- RACINGBOAT.scr:120
...
script.labels["StartMoveLoop"] = function(ctx)
    -- RACINGBOAT.scr:125
    -- move in forward direction
    ctx:command("getdistance", "hMe, hDest, nRemainder") -- RACINGBOAT.scr:128
    if ctx:condition("nRemainder<nDist") then -- RACINGBOAT.scr:129
        ...
        ctx:command("getfacedir", "hMe, dx,dy,dz") -- RACINGBOAT.scr:133
    end -- RACINGBOAT.scr:134
    ctx:command("getrandomint", "nTemp, nDist, nSpeed") -- RACINGBOAT.scr:136
    ctx:command("nspeed", "= nSpeed / 2") -- RACINGBOAT.scr:137
    ctx:command("movedir", "dx,0,dz, nDist, nSpeed, StartMoveLoop") -- RACINGBOAT.scr:138
...
script.labels["Ready"] = function(ctx)
    -- RACINGBOAT.scr:143
    -- re-setup race
    ctx:command("getfacedir", "hMe, dx,dy,dz") -- RACINGBOAT.scr:146
    ctx:command("ondamage", "MoveForward") -- RACINGBOAT.scr:147
...
script.labels["Submerge"] = function(ctx)
    -- RACINGBOAT.scr:165
    ctx:command("stop", "") -- RACINGBOAT.scr:167
    ctx:command("ondamage", "DoNothing") -- RACINGBOAT.scr:168
    ctx:command("movedir", "0,-1,0, 64, 64, ReturnToStart") -- RACINGBOAT.scr:169
    do return ctx:exit("TRUE") end -- RACINGBOAT.scr:171
end

script.labels["ReturnToStart"] = function(ctx)
    -- RACINGBOAT.scr:174
    ctx:command("ntemp", "= yMe - 64") -- RACINGBOAT.scr:176
    ctx:command("setpos", "hMe, xMe,nTemp,zMe") -- RACINGBOAT.scr:177
...
script.labels["Surface"] = function(ctx)
    -- RACINGBOAT.scr:183
    ctx:command("movedir", "0,1,0, 64, 64, TurnOff") -- RACINGBOAT.scr:185
