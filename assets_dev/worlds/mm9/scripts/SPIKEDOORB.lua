...
script.labels["OnUse"] = function(ctx)
    -- SPIKEDOORB.scr:17
    ctx:state().hMyDoor = ctx:self() -- SPIKEDOORB.scr:19
...
script.labels["OnePulled"] = function(ctx)
    -- SPIKEDOORB.scr:26
    ctx:set("count", "count + 1") -- SPIKEDOORB.scr:28
...
script.labels["Main2"] = function(ctx)
    -- SPIKEDOORB.scr:35
    ctx:state().hMyDoor = ctx:objectOrNil("sDoor") -- SPIKEDOORB.scr:37
...
script.labels["main"] = function(ctx)
    ...
    ctx:wait(0, 0.4, "Main2") -- SPIKEDOORB.scr:44
