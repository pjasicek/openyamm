...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("wait", "0, 3, Init") -- EVILEYEACTOR.scr:17
    do return ctx:exit("TRUE") end -- EVILEYEACTOR.scr:19
end

script.labels["Init"] = function(ctx)
    -- EVILEYEACTOR.scr:22
    ctx:command("setstat", "hMe, Gravity, 0") -- EVILEYEACTOR.scr:24
    mm9.gosub(script, ctx, "InitLichLabScenes") -- EVILEYEACTOR.scr:25
    mm9.gosub(script, ctx, "InitTheThing") -- EVILEYEACTOR.scr:26
    ctx:command("getobjecthandle", "PowerLich0, hLich") -- EVILEYEACTOR.scr:27
    ctx:command("getmyhandle", "hMe") -- EVILEYEACTOR.scr:28
    ctx:command("faceobject", "hLich, 360, DoNothing") -- EVILEYEACTOR.scr:29
    do return ctx:exit("TRUE") end -- EVILEYEACTOR.scr:31
end

script.labels["OnScene2"] = function(ctx)
    -- EVILEYEACTOR.scr:34
    ctx:command("cprint", "OnScene2") -- EVILEYEACTOR.scr:36
    ctx:command("onobstacle", "OnScene2") -- EVILEYEACTOR.scr:37
    -- GetRandomInt
...
script.labels["OnScene3"] = function(ctx)
    -- EVILEYEACTOR.scr:43
    ctx:command("cprint", "OnScene3") -- EVILEYEACTOR.scr:45
    ctx:command("stop", "") -- EVILEYEACTOR.scr:46
    ctx:command("onobstacle", "DoNothing") -- EVILEYEACTOR.scr:47
    ctx:command("setflag", "hMe, FLAG_GOTHRUWORLD") -- EVILEYEACTOR.scr:48
    ctx:command("playanim", "rattack1, EndScene") -- EVILEYEACTOR.scr:49
    do return ctx:exit("TRUE") end -- EVILEYEACTOR.scr:51
end

script.labels["OnScene4"] = function(ctx)
    -- EVILEYEACTOR.scr:54
    ctx:command("getobjecthandle", "sDoorName, hDoor") -- EVILEYEACTOR.scr:56
    ctx:command("playanim", "hattack1, DoNothing") -- EVILEYEACTOR.scr:57
    ctx:trigger("hDoor", "destroy") -- EVILEYEACTOR.scr:58
    ctx:command("runto", "hLich, 25, Finish") -- EVILEYEACTOR.scr:59
    do return ctx:exit("TRUE") end -- EVILEYEACTOR.scr:61
end

script.labels["Finish"] = function(ctx)
    -- EVILEYEACTOR.scr:64
    ctx:command("stop", "") -- EVILEYEACTOR.scr:66
    ctx:command("playanim", "hattack1, DoNothing") -- EVILEYEACTOR.scr:67
    ctx:trigger("hLich", "finish") -- EVILEYEACTOR.scr:68
    ctx:command("wait", "0, 3, EndScene") -- EVILEYEACTOR.scr:69
    do return ctx:exit("TRUE") end -- EVILEYEACTOR.scr:71
end

script.labels["OnScene5"] = function(ctx)
    -- EVILEYEACTOR.scr:74
    ctx:command("getobjecthandle", "MarkerTarget1, hLich") -- EVILEYEACTOR.scr:76
    ctx:command("runto", "hLich, 100, EndCinema") -- EVILEYEACTOR.scr:77
    do return ctx:exit("TRUE") end -- EVILEYEACTOR.scr:79
end

script.labels["EndCinema"] = function(ctx)
    -- EVILEYEACTOR.scr:82
    ctx:command("stop", "") -- EVILEYEACTOR.scr:84
