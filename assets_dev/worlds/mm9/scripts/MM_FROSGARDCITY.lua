...
script.labels["CreateMarker"] = function(ctx)
    ...
    if ctx:condition("goto_location == Work") then -- MM_FROSGARDCITY.scr:98
        ctx:set("goto_marker", "marker_work + npc_id") -- MM_FROSGARDCITY.scr:99
    end -- MM_FROSGARDCITY.scr:100
    if ctx:condition("goto_location == Home") then -- MM_FROSGARDCITY.scr:102
        ctx:set("goto_marker", "marker_home + npc_id") -- MM_FROSGARDCITY.scr:103
    end -- MM_FROSGARDCITY.scr:104
    if ctx:condition("goto_location == Misc") then -- MM_FROSGARDCITY.scr:106
        ctx:set("goto_marker", "marker_misc + npc_id") -- MM_FROSGARDCITY.scr:107
...
script.labels["GoToLocation"] = function(ctx)
    ...
    ctx:object("npc_object"):setStat("PARAM", "goto_marker") -- MM_FROSGARDCITY.scr:118
...
script.labels["LaunchGroup"] = function(ctx)
    ...
    while ctx:condition("index < 10") do -- MM_FROSGARDCITY.scr:136
        ...
        ctx:set("index", "index + 1") -- MM_FROSGARDCITY.scr:161
...
script.labels["Group1_GoWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group1") -- MM_FROSGARDCITY.scr:175
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:176
...
script.labels["Group1_WarpWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group1") -- MM_FROSGARDCITY.scr:186
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:187
...
script.labels["Group1_GoHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group1") -- MM_FROSGARDCITY.scr:197
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:198
...
script.labels["Group1_WarpHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group1") -- MM_FROSGARDCITY.scr:208
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:209
...
script.labels["Group1_GoMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group1") -- MM_FROSGARDCITY.scr:219
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:220
...
script.labels["Group1_WarpMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group1") -- MM_FROSGARDCITY.scr:230
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:231
...
script.labels["Group2_GoWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group2") -- MM_FROSGARDCITY.scr:242
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:243
...
script.labels["Group2_WarpWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group2") -- MM_FROSGARDCITY.scr:253
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:254
...
script.labels["Group2_GoHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group2") -- MM_FROSGARDCITY.scr:264
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:265
...
script.labels["Group2_WarpHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group2") -- MM_FROSGARDCITY.scr:275
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:276
...
script.labels["Group2_GoMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group2") -- MM_FROSGARDCITY.scr:286
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:287
...
script.labels["Group2_WarpMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group2") -- MM_FROSGARDCITY.scr:297
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:298
...
script.labels["Group3_GoWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group3") -- MM_FROSGARDCITY.scr:308
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:309
...
script.labels["Group3_WarpWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group3") -- MM_FROSGARDCITY.scr:319
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:320
...
script.labels["Group3_GoHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group3") -- MM_FROSGARDCITY.scr:330
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:331
...
script.labels["Group3_WarpHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group3") -- MM_FROSGARDCITY.scr:341
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:342
...
script.labels["Group3_GoMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group3") -- MM_FROSGARDCITY.scr:352
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:353
...
script.labels["Group3_WarpMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group3") -- MM_FROSGARDCITY.scr:363
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:364
...
script.labels["Group4_GoWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group4") -- MM_FROSGARDCITY.scr:374
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:375
...
script.labels["Group4_WarpWork"] = function(ctx)
    ...
    ctx:set("current_group", "Group4") -- MM_FROSGARDCITY.scr:385
    ctx:set("goto_location", "Work") -- MM_FROSGARDCITY.scr:386
...
script.labels["Group4_GoHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group4") -- MM_FROSGARDCITY.scr:397
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:398
...
script.labels["Group4_WarpHome"] = function(ctx)
    ...
    ctx:set("current_group", "Group4") -- MM_FROSGARDCITY.scr:408
    ctx:set("goto_location", "Home") -- MM_FROSGARDCITY.scr:409
...
script.labels["Group4_GoMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group4") -- MM_FROSGARDCITY.scr:419
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:420
...
script.labels["Group4_WarpMisc"] = function(ctx)
    ...
    ctx:set("current_group", "Group4") -- MM_FROSGARDCITY.scr:430
    ctx:set("goto_location", "Misc") -- MM_FROSGARDCITY.scr:431
...
script.labels["InitWorkSchedule"] = function(ctx)
    ...
    ctx:atTime(6, 15, "Group1_GoWork", "Group1_WarpWork") -- MM_FROSGARDCITY.scr:445
    ctx:atTime(6, 30, "Group2_GoWork", "Group2_WarpWork") -- MM_FROSGARDCITY.scr:446
    ctx:atTime(6, 45, "Group3_GoWork", "Group3_WarpWork") -- MM_FROSGARDCITY.scr:447
    ctx:atTime(7, 0, "Group4_GoWork", "Group4_WarpWork") -- MM_FROSGARDCITY.scr:448
    do return ctx:exit("") end -- MM_FROSGARDCITY.scr:450
end

script.labels["InitHomeSchedule"] = function(ctx)
    -- MM_FROSGARDCITY.scr:454
    ctx:atTime(18, 0, "Group1_GoHome", "Group1_WarpHome") -- MM_FROSGARDCITY.scr:457
    ctx:atTime(18, 15, "Group2_GoHome", "Group2_WarpHome") -- MM_FROSGARDCITY.scr:458
    ctx:atTime(18, 30, "Group3_GoHome", "Group3_WarpHome") -- MM_FROSGARDCITY.scr:459
    ctx:atTime(18, 45, "Group4_GoHome", "Group4_WarpHome") -- MM_FROSGARDCITY.scr:460
...
script.labels["InitMiscSchedule"] = function(ctx)
    ...
    ctx:atTime(13, 0, "Group1_GoMisc", "Group1_WarpMisc") -- MM_FROSGARDCITY.scr:469
    ctx:atTime(13, 15, "Group2_GoMisc", "Group2_WarpMisc") -- MM_FROSGARDCITY.scr:470
    ctx:atTime(13, 30, "Group3_GoMisc", "Group3_WarpMisc") -- MM_FROSGARDCITY.scr:471
    ctx:atTime(13, 45, "Group4_GoMisc", "Group4_WarpMisc") -- MM_FROSGARDCITY.scr:472
    -- Go Back to work
    ctx:atTime(15, 0, "Group1_GoWork", "Group1_WarpWork") -- MM_FROSGARDCITY.scr:475
    ctx:atTime(15, 15, "Group2_GoWork", "Group2_WarpWork") -- MM_FROSGARDCITY.scr:476
    ctx:atTime(15, 30, "Group3_GoWork", "Group3_WarpWork") -- MM_FROSGARDCITY.scr:477
    ctx:atTime(15, 45, "Group4_GoWork", "Group4_WarpWork") -- MM_FROSGARDCITY.scr:478
    do return ctx:exit("") end -- MM_FROSGARDCITY.scr:480
end

script.labels["InitArrays"] = function(ctx)
    -- MM_FROSGARDCITY.scr:488
    ctx:state().index = 0 -- MM_FROSGARDCITY.scr:491
    while ctx:condition("index < 10") do -- MM_FROSGARDCITY.scr:492
        ctx:arrayPut("aGroup1", "index", 0) -- MM_FROSGARDCITY.scr:493
        ctx:arrayPut("aGroup2", "index", 0) -- MM_FROSGARDCITY.scr:494
        ctx:arrayPut("aGroup3", "index", 0) -- MM_FROSGARDCITY.scr:495
        ctx:arrayPut("aGroup4", "index", 0) -- MM_FROSGARDCITY.scr:496
        ctx:set("index", "index + 1") -- MM_FROSGARDCITY.scr:497
...
script.labels["LoadGroup1"] = function(ctx)
    ...
    -- Flosi Stickpoker	( 217 )
    ctx:arrayPut("aGroup1", 0, 217) -- MM_FROSGARDCITY.scr:508
    -- Heikkinen Bloodhands	( 222 )
    ctx:arrayPut("aGroup1", 1, 222) -- MM_FROSGARDCITY.scr:511
    -- Brand Borssen			( 225 )
    ctx:arrayPut("aGroup1", 2, 225) -- MM_FROSGARDCITY.scr:514
    -- Eyjolf Knutssen			( 229 )
    ctx:arrayPut("aGroup1", 3, 229) -- MM_FROSGARDCITY.scr:517
    -- Hanta Fenku				( 232 )
    ctx:arrayPut("aGroup1", 4, 232) -- MM_FROSGARDCITY.scr:520
    -- Fogartach A'Velsi		( 234 )
    ctx:arrayPut("aGroup1", 5, 234) -- MM_FROSGARDCITY.scr:523
    -- Frode Herjolfssen		( 399 )
    ctx:arrayPut("aGroup1", 6, 399) -- MM_FROSGARDCITY.scr:526
...
script.labels["LoadGroup2"] = function(ctx)
    ...
    -- Pules Haji			( 218 )
    ctx:arrayPut("aGroup2", 0, 218) -- MM_FROSGARDCITY.scr:535
    -- Heikkinen Bloodhands	( 222 )
    ctx:arrayPut("aGroup2", 1, 222) -- MM_FROSGARDCITY.scr:538
    -- Eitri Haukssen			( 226 )
    ctx:arrayPut("aGroup2", 2, 226) -- MM_FROSGARDCITY.scr:541
    -- Hroald Etzelssen		( 230 )
    ctx:arrayPut("aGroup2", 3, 230) -- MM_FROSGARDCITY.scr:544
    -- Fionnaghal A'Lanth		( 236 )
    ctx:arrayPut("aGroup2", 4, 236) -- MM_FROSGARDCITY.scr:547
    -- Derbforgaill A'Norta a'meich	( 235 )
    ctx:arrayPut("aGroup2", 5, 235) -- MM_FROSGARDCITY.scr:550
    -- Hagen Hrrappssen		( 401 )
    ctx:arrayPut("aGroup2", 6, 401) -- MM_FROSGARDCITY.scr:553
...
script.labels["LoadGroup3"] = function(ctx)
    ...
    -- Tjorvi Duartrssen	( 219 )
    ctx:arrayPut("aGroup3", 0, 219) -- MM_FROSGARDCITY.scr:563
    -- Thorkel Cortssen		( 223 )
    ctx:arrayPut("aGroup3", 1, 223) -- MM_FROSGARDCITY.scr:566
    -- Asdis Brunidotir		( 227 )
    ctx:arrayPut("aGroup3", 2, 227) -- MM_FROSGARDCITY.scr:569
    -- Lansa Akin				( 233 )
    ctx:arrayPut("aGroup3", 3, 233) -- MM_FROSGARDCITY.scr:572
    -- Erin A'Feslo			( 403 )
    ctx:arrayPut("aGroup3", 4, 403) -- MM_FROSGARDCITY.scr:575
...
script.labels["LoadGroup4"] = function(ctx)
    ...
    -- Halfdan Hagenessen	( 220 )
    ctx:arrayPut("aGroup4", 0, 220) -- MM_FROSGARDCITY.scr:585
    -- Canute Gardrarssen		( 224 )
    ctx:arrayPut("aGroup4", 1, 224) -- MM_FROSGARDCITY.scr:588
    -- Sigrid Tryygvadotir		( 228 )
    ctx:arrayPut("aGroup4", 2, 228) -- MM_FROSGARDCITY.scr:591
    -- Tadita Akin				( 231 )
    ctx:arrayPut("aGroup4", 3, 231) -- MM_FROSGARDCITY.scr:594
    -- Eachann A'Mor			( 237 )
    ctx:arrayPut("aGroup4", 4, 237) -- MM_FROSGARDCITY.scr:597
    -- Hervor Etzeldotir		( 398 )
    ctx:arrayPut("aGroup4", 5, 398) -- MM_FROSGARDCITY.scr:600
    -- Dymphna A'Klindor		( 402 )
    ctx:arrayPut("aGroup4", 6, 402) -- MM_FROSGARDCITY.scr:603
