...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("traverseradius", "= 25") -- IMPTRICKSTER.scr:43
    ctx:command("onpoststartworld", "InitImpTrickster") -- IMPTRICKSTER.scr:45
    ctx:command("wait", "0, 5, InitImpTrickster") -- IMPTRICKSTER.scr:46
...
script.labels["InitImpTrickster"] = function(ctx)
    ...
    ctx:command("onstuck", "TraverseResume") -- IMPTRICKSTER.scr:55
    ctx:command("ondamage", "PreemtScene") -- IMPTRICKSTER.scr:56
    ctx:command("ondeath", "DisableScene") -- IMPTRICKSTER.scr:57
    ctx:addTrigger("reappear", "Reappear") -- IMPTRICKSTER.scr:59
    ctx:addTrigger("disappear", "Disappear") -- IMPTRICKSTER.scr:60
    ctx:command("getmyhandle", "hMe") -- IMPTRICKSTER.scr:62
    ctx:command("getobjecthandle", "TriggerFrontImp, hTrigger") -- IMPTRICKSTER.scr:63
    ctx:command("getobjecthandle", "sColloidal1Name, hHenchman1") -- IMPTRICKSTER.scr:64
    ctx:command("getobjecthandle", "sColloidal2Name, hHenchman2") -- IMPTRICKSTER.scr:65
...
script.labels["PreemtScene"] = function(ctx)
    -- IMPTRICKSTER.scr:73
    ctx:command("ondamage", "DoNothing") -- IMPTRICKSTER.scr:75
...
script.labels["DisableScene"] = function(ctx)
    -- IMPTRICKSTER.scr:81
    ctx:command("ondeath", "DoNothing") -- IMPTRICKSTER.scr:83
...
script.labels["OnTraverseDone"] = function(ctx)
    ...
    if ctx:condition("LISTINDEX==0") then -- IMPTRICKSTER.scr:91
        ctx:command("htrigger", "= LISTOBJECT") -- IMPTRICKSTER.scr:92
        mm9.gosub(script, ctx, "TraversePause") -- IMPTRICKSTER.scr:93
        ctx:command("setcallback", "0, EndOpeningRoom") -- IMPTRICKSTER.scr:94
    ...
    if ctx:condition("LISTINDEX==5") then -- IMPTRICKSTER.scr:98
        ...
        ctx:command("killcallback", "0") -- IMPTRICKSTER.scr:100
        ctx:command("setcallback", "0, TraverseResume") -- IMPTRICKSTER.scr:101
    ...
    ctx:command("playsound", "sounds\\AnimSounds\\DragonflyHattackair1.wav, DoNothing, 1, 5000, FALSE, 100") -- IMPTRICKSTER.scr:109
...
script.labels["OpeningRoom"] = function(ctx)
    ...
    ctx:command("playanim", "HAttack1, DoNothing") -- IMPTRICKSTER.scr:116
    ctx:command("playsound", "sounds\\AnimSounds\\DragonflyHattackair1.wav, DoNothing, 1, 5000, FALSE, 100") -- IMPTRICKSTER.scr:117
    ctx:command("getplayerhandle", "g_hTarget") -- IMPTRICKSTER.scr:118
    ctx:command("faceobject", "g_hTarget, 360, TraverseBegin") -- IMPTRICKSTER.scr:119
    do return ctx:exit("TRUE") end -- IMPTRICKSTER.scr:120
end

script.labels["EndOpeningRoom"] = function(ctx)
    -- IMPTRICKSTER.scr:123
    ctx:command("doclientfx", "hTrigger, SPELL_ELEMBLAST, 0, 1") -- IMPTRICKSTER.scr:125
    ctx:command("getpos", "LISTOBJECT, x,y,z") -- IMPTRICKSTER.scr:126
    ctx:command("playsound", "sounds\\magic\\protectionfrommagic.wav, DoNothing, 1, 5000, FALSE, 100") -- IMPTRICKSTER.scr:127
    ctx:command("setpos", "hMe, x,y,z") -- IMPTRICKSTER.scr:128
    -- gosub Disappear
...
script.labels["FloodRoom"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "sColloidal3Name, hHenchman1") -- IMPTRICKSTER.scr:135
    ctx:command("getobjecthandle", "sColloidal4Name, hHenchman2") -- IMPTRICKSTER.scr:136
...
script.labels["EscapeEnd"] = function(ctx)
    ...
    ctx:command("stop", "") -- IMPTRICKSTER.scr:143
...
script.labels["AlertHenchman1"] = function(ctx)
    ...
    ctx:command("faceobject", "hHenchman1, 360, DoTaunt") -- IMPTRICKSTER.scr:153
    ctx:command("playsound", "\"sounds\\AnimSounds\\DragonflyHattackair1.wav\", DoNothing, 1, 5000, FALSE, 100") -- IMPTRICKSTER.scr:154
    ctx:trigger("hHenchman1", "Help") -- IMPTRICKSTER.scr:155
    ctx:command("wait", "0, 1, AlertHenchman2") -- IMPTRICKSTER.scr:156
    do return ctx:exit("TRUE") end -- IMPTRICKSTER.scr:157
end

script.labels["AlertHenchman2"] = function(ctx)
    -- IMPTRICKSTER.scr:160
    ctx:command("faceobject", "hHenchman2, 360, DoTaunt") -- IMPTRICKSTER.scr:162
    ctx:command("playsound", "\"sounds\\AnimSounds\\DragonflyHattackair1.wav\", DoNothing, 1, 5000, FALSE, 100") -- IMPTRICKSTER.scr:163
    ctx:trigger("hHenchman2", "Help") -- IMPTRICKSTER.scr:164
    ctx:command("wait", "0, 2, EndPhase") -- IMPTRICKSTER.scr:165
    do return ctx:exit("TRUE") end -- IMPTRICKSTER.scr:166
end

script.labels["DoTaunt"] = function(ctx)
    -- IMPTRICKSTER.scr:169
    ctx:command("playsound", "sounds\\AnimSounds\\DragonflyHattackair1.wav, DoNothing, 1, 5000, FALSE, 100") -- IMPTRICKSTER.scr:171
    ctx:command("playanim", "HAttack1") -- IMPTRICKSTER.scr:172
    do return ctx:exit("TRUE") end -- IMPTRICKSTER.scr:173
end

script.labels["EndPhase"] = function(ctx)
    -- IMPTRICKSTER.scr:176
    ctx:command("docallback", "0") -- IMPTRICKSTER.scr:178
    do return ctx:exit("TRUE") end -- IMPTRICKSTER.scr:179
end

script.labels["Disappear"] = function(ctx)
    -- IMPTRICKSTER.scr:182
    ctx:command("clearflag", "hMe, FLAG_SOLID") -- IMPTRICKSTER.scr:184
    ctx:command("clearflag", "hMe, FLAG_VISIBLE") -- IMPTRICKSTER.scr:185
    ctx:setPropNumber("CanDamage", "FALSE") -- IMPTRICKSTER.scr:186
    do return ctx:exit("TRUE") end -- IMPTRICKSTER.scr:188
end

script.labels["Reappear"] = function(ctx)
    -- IMPTRICKSTER.scr:191
    ctx:command("setflag", "hMe, FLAG_SOLID") -- IMPTRICKSTER.scr:193
    ctx:command("setflag", "hMe, FLAG_VISIBLE") -- IMPTRICKSTER.scr:194
    ctx:setPropNumber("CanDamage", "TRUE") -- IMPTRICKSTER.scr:195
