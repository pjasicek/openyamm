...
script.labels["Main"] = function(ctx)
    -- ARG_TRYYGVA.scr:73
    -- TraceOn ;delete me!!
    ctx:onEvent("OnPostStartWorld", "Init") -- ARG_TRYYGVA.scr:77
    ctx:onEvent("OnPostMiniSaveLoad", "Init") -- ARG_TRYYGVA.scr:78
    ctx:onEvent("OnPostSaveLoad", "Init") -- ARG_TRYYGVA.scr:79
    ctx:wait(1, .1, "Init") -- ARG_TRYYGVA.scr:80
    ctx:addTrigger("Clap", "ONApplause") -- ARG_TRYYGVA.scr:81
    ctx:addModelKey("Clap", "OnClap") -- ARG_TRYYGVA.scr:82
