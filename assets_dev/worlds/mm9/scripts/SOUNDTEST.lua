...
script.labels["SoundDone"] = function(ctx)
    -- SOUNDTEST.scr:4
    ctx:command("cprint", "sounddone") -- SOUNDTEST.scr:6
    do return ctx:exit("") end -- SOUNDTEST.scr:7
end

script.labels["go"] = function(ctx)
    -- SOUNDTEST.scr:9
    ctx:command("cprint", "playing sound...") -- SOUNDTEST.scr:10
    ctx:command("playsound", "filename,SoundDone,2000") -- SOUNDTEST.scr:11
