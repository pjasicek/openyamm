...
script.labels["CreateMarker"] = function(ctx)
    ...
    if ctx:condition("goto_location == Work") then -- MM_GUBERLANDCITY.scr:98
        ctx:command("goto_marker", "= marker_work + npc_id") -- MM_GUBERLANDCITY.scr:99
    end -- MM_GUBERLANDCITY.scr:100
    if ctx:condition("goto_location == Home") then -- MM_GUBERLANDCITY.scr:102
        ctx:command("goto_marker", "= marker_home + npc_id") -- MM_GUBERLANDCITY.scr:103
    end -- MM_GUBERLANDCITY.scr:104
    if ctx:condition("goto_location == Misc") then -- MM_GUBERLANDCITY.scr:106
        ctx:command("goto_marker", "= marker_misc + npc_id") -- MM_GUBERLANDCITY.scr:107
...
script.labels["GoToLocation"] = function(ctx)
    ...
    ctx:command("setstat", "npc_object, PARAM, goto_marker") -- MM_GUBERLANDCITY.scr:118
...
script.labels["LaunchGroup"] = function(ctx)
    ...
    while ctx:condition("index < 10") do -- MM_GUBERLANDCITY.scr:136
        ...
        ctx:command("index", "= index + 1") -- MM_GUBERLANDCITY.scr:161
...
script.labels["Group1_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_GUBERLANDCITY.scr:175
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:176
...
script.labels["Group1_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_GUBERLANDCITY.scr:186
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:187
...
script.labels["Group1_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_GUBERLANDCITY.scr:197
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:198
...
script.labels["Group1_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_GUBERLANDCITY.scr:208
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:209
...
script.labels["Group1_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_GUBERLANDCITY.scr:219
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:220
...
script.labels["Group1_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_GUBERLANDCITY.scr:230
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:231
...
script.labels["Group2_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_GUBERLANDCITY.scr:242
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:243
...
script.labels["Group2_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_GUBERLANDCITY.scr:253
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:254
...
script.labels["Group2_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_GUBERLANDCITY.scr:264
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:265
...
script.labels["Group2_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_GUBERLANDCITY.scr:275
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:276
...
script.labels["Group2_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_GUBERLANDCITY.scr:286
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:287
...
script.labels["Group2_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_GUBERLANDCITY.scr:297
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:298
...
script.labels["Group3_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_GUBERLANDCITY.scr:308
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:309
...
script.labels["Group3_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_GUBERLANDCITY.scr:319
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:320
...
script.labels["Group3_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_GUBERLANDCITY.scr:330
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:331
...
script.labels["Group3_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_GUBERLANDCITY.scr:341
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:342
...
script.labels["Group3_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_GUBERLANDCITY.scr:352
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:353
...
script.labels["Group3_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_GUBERLANDCITY.scr:363
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:364
...
script.labels["Group4_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_GUBERLANDCITY.scr:374
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:375
...
script.labels["Group4_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_GUBERLANDCITY.scr:385
    ctx:command("goto_location", "= Work") -- MM_GUBERLANDCITY.scr:386
...
script.labels["Group4_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_GUBERLANDCITY.scr:397
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:398
...
script.labels["Group4_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_GUBERLANDCITY.scr:408
    ctx:command("goto_location", "= Home") -- MM_GUBERLANDCITY.scr:409
...
script.labels["Group4_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_GUBERLANDCITY.scr:419
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:420
...
script.labels["Group4_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_GUBERLANDCITY.scr:430
    ctx:command("goto_location", "= Misc") -- MM_GUBERLANDCITY.scr:431
...
script.labels["InitWorkSchedule"] = function(ctx)
    ...
    ctx:command("@m", "6 : 15 Group1_GoWork Group1_WarpWork") -- MM_GUBERLANDCITY.scr:445
    ctx:command("@m", "6 : 30 Group2_GoWork Group2_WarpWork") -- MM_GUBERLANDCITY.scr:446
    ctx:command("@m", "6 : 45 Group3_GoWork Group3_WarpWork") -- MM_GUBERLANDCITY.scr:447
    ctx:command("@m", "7 : 00 Group4_GoWork Group4_WarpWork") -- MM_GUBERLANDCITY.scr:448
    do return ctx:exit("") end -- MM_GUBERLANDCITY.scr:450
end

script.labels["InitHomeSchedule"] = function(ctx)
    -- MM_GUBERLANDCITY.scr:454
    ctx:command("@m", "18 : 00 Group1_GoHome Group1_WarpHome") -- MM_GUBERLANDCITY.scr:457
    ctx:command("@m", "18 : 15 Group2_GoHome Group2_WarpHome") -- MM_GUBERLANDCITY.scr:458
    ctx:command("@m", "18 : 30 Group3_GoHome Group3_WarpHome") -- MM_GUBERLANDCITY.scr:459
    ctx:command("@m", "18 : 45 Group4_GoHome Group4_WarpHome") -- MM_GUBERLANDCITY.scr:460
...
script.labels["InitMiscSchedule"] = function(ctx)
    ...
    ctx:command("@m", "13 : 00 Group1_GoMisc Group1_WarpMisc") -- MM_GUBERLANDCITY.scr:469
    ctx:command("@m", "13 : 15 Group2_GoMisc Group2_WarpMisc") -- MM_GUBERLANDCITY.scr:470
    ctx:command("@m", "13 : 30 Group3_GoMisc Group3_WarpMisc") -- MM_GUBERLANDCITY.scr:471
    ctx:command("@m", "13 : 45 Group4_GoMisc Group4_WarpMisc") -- MM_GUBERLANDCITY.scr:472
    -- Go Back to work
    ctx:command("@m", "15 : 00 Group1_GoWork Group1_WarpWork") -- MM_GUBERLANDCITY.scr:475
    ctx:command("@m", "15 : 15 Group2_GoWork Group2_WarpWork") -- MM_GUBERLANDCITY.scr:476
    ctx:command("@m", "15 : 30 Group3_GoWork Group3_WarpWork") -- MM_GUBERLANDCITY.scr:477
    ctx:command("@m", "15 : 45 Group4_GoWork Group4_WarpWork") -- MM_GUBERLANDCITY.scr:478
    do return ctx:exit("") end -- MM_GUBERLANDCITY.scr:480
end

script.labels["InitArrays"] = function(ctx)
    -- MM_GUBERLANDCITY.scr:488
    ctx:command("index", "= 0") -- MM_GUBERLANDCITY.scr:491
    while ctx:condition("index < 10") do -- MM_GUBERLANDCITY.scr:492
        ctx:command("arrayput", "aGroup1, index , 0") -- MM_GUBERLANDCITY.scr:493
        ctx:command("arrayput", "aGroup2, index , 0") -- MM_GUBERLANDCITY.scr:494
        ctx:command("arrayput", "aGroup3, index , 0") -- MM_GUBERLANDCITY.scr:495
        ctx:command("arrayput", "aGroup4, index , 0") -- MM_GUBERLANDCITY.scr:496
        ctx:command("index", "= index + 1") -- MM_GUBERLANDCITY.scr:497
...
script.labels["LoadGroup1"] = function(ctx)
    ...
    -- Mata Abyomi					( 148 )
    ctx:command("arrayput", "aGroup1,0,148") -- MM_GUBERLANDCITY.scr:508
    -- Mirek Mazatle				( 152 )
    ctx:command("arrayput", "aGroup1,1,152") -- MM_GUBERLANDCITY.scr:511
    -- Davin the Ample				( 165 )
    ctx:command("arrayput", "aGroup1,2,165") -- MM_GUBERLANDCITY.scr:514
    -- Gregusk Mazo				( 168 )
    ctx:command("arrayput", "aGroup1,3,168") -- MM_GUBERLANDCITY.scr:517
    -- Rya Fremi					( 173 )
    ctx:command("arrayput", "aGroup1,4,173") -- MM_GUBERLANDCITY.scr:520
    -- Eyjolf Bjolfssen			( 156 ) <<< REMOVED >>>
...
script.labels["LoadGroup2"] = function(ctx)
    ...
    -- Bragi the Toothloose		( 149 )
    ctx:command("arrayput", "aGroup2,0,149") -- MM_GUBERLANDCITY.scr:535
    -- Gudny the Nose				( 153 )
    ctx:command("arrayput", "aGroup2,1,153") -- MM_GUBERLANDCITY.scr:538
    -- Fyrie the Forgettable		( 162 )
    ctx:command("arrayput", "aGroup2,2,162") -- MM_GUBERLANDCITY.scr:541
    -- Denby Badbreath				( 166 )
    ctx:command("arrayput", "aGroup2,3,166") -- MM_GUBERLANDCITY.scr:544
    -- Peterk Olin					( 170 )
    ctx:command("arrayput", "aGroup2,4,170") -- MM_GUBERLANDCITY.scr:547
    -- Hrapp Tjorvissen			( 174 )
    ctx:command("arrayput", "aGroup2,5,174") -- MM_GUBERLANDCITY.scr:550
    -- Aki the King				( 157 ) <<< REMOVED >>>
...
script.labels["LoadGroup3"] = function(ctx)
    ...
    -- Aso Stinkshirt				( 154 )
    ctx:command("arrayput", "aGroup3,0,154") -- MM_GUBERLANDCITY.scr:563
    -- Gabriel Dullard				( 163 )
    ctx:command("arrayput", "aGroup3,1,163") -- MM_GUBERLANDCITY.scr:567
    -- Treshi Yatol				( 171 )
    ctx:command("arrayput", "aGroup3,2,171") -- MM_GUBERLANDCITY.scr:570
    -- Scandian the Long-tongued	( 150 ) <<< REMOVED >>>
...
script.labels["LoadGroup4"] = function(ctx)
    ...
    -- Ryan the Simpleton			( 164 )
    ctx:command("arrayput", "aGroup4,0, 164") -- MM_GUBERLANDCITY.scr:586
    -- Lina Friggdotir				( 167 )
    ctx:command("arrayput", "aGroup4,1, 167") -- MM_GUBERLANDCITY.scr:589
    -- Bohus Kinar					( 172 )
    ctx:command("arrayput", "aGroup4,2, 172") -- MM_GUBERLANDCITY.scr:592
    -- Broccan A'Norta a'bre		( 151 ) <<< REMOVED >>>
