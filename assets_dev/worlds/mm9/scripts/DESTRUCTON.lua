...
script.labels["DestroyMe"] = function(ctx)
    -- DESTRUCTON.scr:16
    ctx:command("getmyhandle", "g_hmyobject") -- DESTRUCTON.scr:19
...
script.labels["OnDamageOn"] = function(ctx)
    -- DESTRUCTON.scr:25
    ctx:setPropNumber("CanDamage", "TRUE") -- DESTRUCTON.scr:28
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("ondamage", "DestroyMe") -- DESTRUCTON.scr:38
