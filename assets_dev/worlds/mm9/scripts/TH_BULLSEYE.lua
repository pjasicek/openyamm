...
script.labels["Done"] = function(ctx)
    -- TH_BULLSEYE.scr:34
    ctx:onEvent("OnDamage", "DoNothing") -- TH_BULLSEYE.scr:37
    ctx:removeTrigger("Done") -- TH_BULLSEYE.scr:38
    do return ctx:exit("True") end -- TH_BULLSEYE.scr:40
end

script.labels["TurnOn"] = function(ctx)
    -- TH_BULLSEYE.scr:43
    ctx:state().hDummy = ctx:self() -- TH_BULLSEYE.scr:46
    ctx:self():setFlag("FLAG_SOLID", true) -- TH_BULLSEYE.scr:47
    do return ctx:exit("True") end -- TH_BULLSEYE.scr:49
end

script.labels["TurnOff"] = function(ctx)
    -- TH_BULLSEYE.scr:51
    ctx:state().hDummy = ctx:self() -- TH_BULLSEYE.scr:54
    ctx:self():setFlag("FLAG_SOLID", false) -- TH_BULLSEYE.scr:55
    do return ctx:exit("True") end -- TH_BULLSEYE.scr:57
end

script.labels["StopHere"] = function(ctx)
    -- TH_BULLSEYE.scr:59
    ctx:cprint("StopHere") -- TH_BULLSEYE.scr:61
...
script.labels["CloseMe"] = function(ctx)
    ...
    ctx:state().hDummy = ctx:objectOrNil("sTargetObject") -- TH_BULLSEYE.scr:135
    ctx:state().hTrigger = ctx:objectOrNil("sTrigger") -- TH_BULLSEYE.scr:136
...
script.labels["TargetInit"] = function(ctx)
    -- TH_BULLSEYE.scr:147
    ctx:state().hDummy = ctx:self() -- TH_BULLSEYE.scr:149
    ctx:self():setFlag("FLAG_SOLID", true) -- TH_BULLSEYE.scr:150
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnDamage", "CloseMe") -- TH_BULLSEYE.scr:162
    ...
    ctx:wait(0, 2, "TargetInit") -- TH_BULLSEYE.scr:166
