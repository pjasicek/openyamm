...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:condition("B_Enable==true") then -- DRAGONPHARAOH2FLAME.scr:16
        ctx:state().g_hObject = ctx:objectOrNil("FlameBoss") -- DRAGONPHARAOH2FLAME.scr:20
        if ctx:condition("g_hObject==NULL") then -- DRAGONPHARAOH2FLAME.scr:22
            ctx:debugOut("Error!", "No", "FlameBoss????") -- DRAGONPHARAOH2FLAME.scr:23
            do return ctx:exit("") end -- DRAGONPHARAOH2FLAME.scr:24
        end -- DRAGONPHARAOH2FLAME.scr:25
        -- set g_ntemp, FlameId
        -- Set g_stemp,g_ntemp
        ctx:set("g_stemp", "FlameId") -- DRAGONPHARAOH2FLAME.scr:29
        ctx:set("g_sout", "FlameOn") -- DRAGONPHARAOH2FLAME.scr:30
        ctx:add("g_sout", "g_stemp") -- DRAGONPHARAOH2FLAME.scr:31
        ctx:trigger("g_hMyObject", "On") -- DRAGONPHARAOH2FLAME.scr:33
        ctx:trigger("g_hObject", "g_sout") -- DRAGONPHARAOH2FLAME.scr:34
        ctx:debugOut("g_sout") -- DRAGONPHARAOH2FLAME.scr:35
