...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("wait", "0, 3, InitPigRacer") -- PIGRACER.scr:36
...
script.labels["InitPigRacer"] = function(ctx)
    ...
    ctx:command("getmyhandle", "hMe") -- PIGRACER.scr:47
    ctx:command("getplayerhandle", "hPlayer") -- PIGRACER.scr:48
    ctx:command("getobjecthandle", "sCameraName, hCamera") -- PIGRACER.scr:49
    ctx:command("getstat", "hMe, RunVel, nTemp") -- PIGRACER.scr:51
    ctx:command("ntemp", "= nTemp * 8") -- PIGRACER.scr:52
    ctx:command("setstat", "hMe, RunVel, nTemp") -- PIGRACER.scr:53
    do return ctx:exit("TRUE") end -- PIGRACER.scr:55
end

script.labels["StartRacing"] = function(ctx)
    -- PIGRACER.scr:58
    ctx:command("bquit", "= FALSE") -- PIGRACER.scr:60
    ctx:trigger("hCamera", "start") -- PIGRACER.scr:61
    ctx:command("removetrigger", "Use") -- PIGRACER.scr:62
    mm9.gosub(script, ctx, "RaceLoop") -- PIGRACER.scr:63
    mm9.gosub(script, ctx, "SoundLoop") -- PIGRACER.scr:64
    ctx:command("wait", "0, 300, EndRace") -- PIGRACER.scr:65
...
script.labels["RaceLoop"] = function(ctx)
    ...
    ctx:command("getfacedir", "hPlayer, dx,dy,dz") -- PIGRACER.scr:76
    ctx:command("vecnorm", "dx,dy,dz") -- PIGRACER.scr:77
    ctx:command("facedir", "dx,dy,dz, 360") -- PIGRACER.scr:78
    ctx:command("run", "") -- PIGRACER.scr:79
    ctx:command("wait", "0, .05, RaceLoop") -- PIGRACER.scr:81
...
script.labels["SoundLoop"] = function(ctx)
    ...
    ctx:command("wait", "1, 2, SoundLoop") -- PIGRACER.scr:90
    do return ctx:exit("TRUE") end -- PIGRACER.scr:92
end

script.labels["EndRace"] = function(ctx)
    -- PIGRACER.scr:95
    ctx:command("bquit", "= TRUE") -- PIGRACER.scr:97
