...
script.labels["HandlePlayer"] = function(ctx)
    ...
    ctx:state().g_hObject = ctx:objectOrNil("PlayerExit") -- YANMIR_ENDOFWORLD.scr:20
...
script.labels["HandleYanmir"] = function(ctx)
    ...
    ctx:object("g_hObject"):remove() -- YANMIR_ENDOFWORLD.scr:33
    do return ctx:exit("") end -- YANMIR_ENDOFWORLD.scr:36
end

script.labels["HandleOther"] = function(ctx)
    -- YANMIR_ENDOFWORLD.scr:39
    ctx:state().g_bTemp = ctx:object("g_hObject"):isClass("Actor") -- YANMIR_ENDOFWORLD.scr:42
    if ctx:condition("g_bTemp==TRUE") then -- YANMIR_ENDOFWORLD.scr:44
        ctx:object("g_hObject"):remove() -- YANMIR_ENDOFWORLD.scr:45
...
script.labels["OnOutOfWorld"] = function(ctx)
    ...
    ctx:state().g_bTemp = ctx:object("g_hObject"):isPlayer() -- YANMIR_ENDOFWORLD.scr:56
    ...
    ctx:state().g_sTemp = ctx:object("g_hObject"):name() -- YANMIR_ENDOFWORLD.scr:62
