...
script.labels["WalkToChamber"] = function(ctx)
    -- LICHSORCERER.scr:36
    ctx:state().hDestination = ctx:objectOrNil("sDestinationName") -- LICHSORCERER.scr:38
    if ctx:condition("hDestination!=0") then -- LICHSORCERER.scr:39
        ctx:self():walkTo(ctx:object("hDestination"), 0, "OnReachedDestination") -- LICHSORCERER.scr:40
...
script.labels["OnReachedDestination"] = function(ctx)
    -- LICHSORCERER.scr:46
    ctx:self():stop() -- LICHSORCERER.scr:48
    ctx:state().hDoor = ctx:objectOrNil("sDoorName") -- LICHSORCERER.scr:49
    if ctx:condition("hDoor!=0") then -- LICHSORCERER.scr:50
        ctx:self():rotate(0, 1, 0, 180, 180, "DoNothing") -- LICHSORCERER.scr:51
        ctx:trigger("hDoor", "open") -- LICHSORCERER.scr:52
        ctx:state().nTemp = ctx:object("hDoor"):getStat("DoorOpenTime") -- LICHSORCERER.scr:53
        ctx:set("nTemp", "nTemp + 3") -- LICHSORCERER.scr:54
        ctx:wait(0, "nTemp", "EndScene") -- LICHSORCERER.scr:55
...
script.labels["StartTransform"] = function(ctx)
    -- LICHSORCERER.scr:61
    ctx:self():doClientFx("SPELL_SPARKLIES", "FALSE", "TRUE") -- LICHSORCERER.scr:63
    ctx:self():playAnimation("taunt", "ChangeToLich") -- LICHSORCERER.scr:65
    do return ctx:exit("TRUE") end -- LICHSORCERER.scr:67
end

script.labels["ChangeToLich"] = function(ctx)
    -- LICHSORCERER.scr:70
    ctx:self():playAnimation("die2", "EndScene") -- LICHSORCERER.scr:72
    ctx:self():doClientFx("SPELL_BLACKSMOKE", "TRUE", "TRUE") -- LICHSORCERER.scr:74
    do return ctx:exit("TRUE") end -- LICHSORCERER.scr:76
end

script.labels["FinishTransform"] = function(ctx)
    -- LICHSORCERER.scr:79
    ctx:state().xMe, ctx:state().yMe, ctx:state().zMe = ctx:self():pos() -- LICHSORCERER.scr:81
    ctx:state().hDummy = ctx:objectOrNil("LichSorcererNew") -- LICHSORCERER.scr:82
    ctx:object("hDummy"):setPos("xMe", "yMe", "zMe") -- LICHSORCERER.scr:83
    ctx:wait(0, 1, "RemoveMe") -- LICHSORCERER.scr:84
    do return ctx:exit("TRUE") end -- LICHSORCERER.scr:86
end

script.labels["RemoveMe"] = function(ctx)
    -- LICHSORCERER.scr:89
    ctx:self():remove() -- LICHSORCERER.scr:91
