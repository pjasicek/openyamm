...
script.labels["ClearAttackTimer"] = function(ctx)
    -- DRAGONRED.scr:124
    ctx:wait("ATTACK_WAIT_NBR", 0, "DoNothing") -- DRAGONRED.scr:126
...
script.labels["OnLostTarget"] = function(ctx)
    ...
    ctx:state().g_hTarget = nil -- DRAGONRED.scr:136
    ctx:self():setTarget(nil) -- DRAGONRED.scr:137
...
script.labels["AttackDone"] = function(ctx)
    -- DRAGONRED.scr:144
    ctx:state().bAttacking = false -- DRAGONRED.scr:147
    ctx:self():setTarget(ctx:object("g_hTarget")) -- DRAGONRED.scr:149
    ...
    if ctx:condition("g_hTarget!=NULL") then -- DRAGONRED.scr:153
        ...
        ctx:self():setIdle() -- DRAGONRED.scr:156
...
script.labels["AttackFaceTargetDone"] = function(ctx)
    ...
    if ctx:condition("bAttacking==TRUE") then -- DRAGONRED.scr:165
        ctx:self():setTarget(ctx:object("g_hTarget")) -- DRAGONRED.scr:166
...
script.labels["GetTargetHeight"] = function(ctx)
    ...
    ctx:state().targetHeight = 0 -- DRAGONRED.scr:177
    if ctx:condition("g_hTarget==NULL") then -- DRAGONRED.scr:179
        do return ctx:exit("") end -- DRAGONRED.scr:180
    end -- DRAGONRED.scr:181
    ctx:state().g_posX, ctx:state().g_posY, ctx:state().g_posZ = ctx:self():pos() -- DRAGONRED.scr:183
    ctx:sub("g_posY", "dimsY") -- DRAGONRED.scr:184
    ctx:state().g_posX, ctx:state().targetHeight, ctx:state().g_posZ = ctx:object("g_hTarget"):pos() -- DRAGONRED.scr:186
    ctx:sub("targetHeight", "g_posY") -- DRAGONRED.scr:187
...
script.labels["DoBreathAttack"] = function(ctx)
    ...
    if ctx:condition("g_hTarget!=NULL") then -- DRAGONRED.scr:200
        ...
        if ctx:condition("targetHeight > dimsZ") then -- DRAGONRED.scr:204
            ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:205
            if ctx:condition("g_nRandom > 60") then -- DRAGONRED.scr:206
                ctx:self():playAnimation("rAttack3", "AttackDone") -- DRAGONRED.scr:207
            else -- DRAGONRED.scr:208
                ctx:self():playAnimation("rAttack1", "AttackDone") -- DRAGONRED.scr:209
            end -- DRAGONRED.scr:210
        else -- DRAGONRED.scr:211
            ctx:self():playAnimation("rAttack2", "AttackDone") -- DRAGONRED.scr:212
        end -- DRAGONRED.scr:213
    else -- DRAGONRED.scr:214
        ctx:self():playAnimation("rAttack2", "AttackDone") -- DRAGONRED.scr:215
...
script.labels["DoWingAttack"] = function(ctx)
    -- DRAGONRED.scr:220
    ctx:self():playAnimation("WingAttack", "WingAttackDone") -- DRAGONRED.scr:223
    do return ctx:exit("") end -- DRAGONRED.scr:225
end

script.labels["DoFireBoltAttack"] = function(ctx)
    -- DRAGONRED.scr:228
    ctx:self():playAnimation("rAttack1", "AttackDone") -- DRAGONRED.scr:231
...
script.labels["DoAttack"] = function(ctx)
    ...
    if ctx:condition("g_hTarget==NULL") then -- DRAGONRED.scr:239
        ctx:self():setIdle() -- DRAGONRED.scr:240
        do return ctx:exit("") end -- DRAGONRED.scr:241
    end -- DRAGONRED.scr:242
    ctx:state().g_nTemp = ctx:self():aiDistanceTo(ctx:object("g_hTarget")) -- DRAGONRED.scr:244
    ctx:self():faceObject(ctx:object("g_hTarget"), 180, "AttackFaceTargetDone") -- DRAGONRED.scr:246
    ctx:state().bAttacking = true -- DRAGONRED.scr:248
    if ctx:condition("g_nTemp < WING_ATTACK_DIST") then -- DRAGONRED.scr:250
        ...
        if ctx:condition("g_nTemp < BREATH_ATTACK_DIST") then -- DRAGONRED.scr:253
            ...
            if ctx:condition("g_nTemp < MAX_ATTACK_DIST") then -- DRAGONRED.scr:256
                ...
                ctx:self():setIdle() -- DRAGONRED.scr:260
                ctx:state().bAttacking = false -- DRAGONRED.scr:261
...
script.labels["WingAttackDone"] = function(ctx)
    -- DRAGONRED.scr:270
    ctx:self():setTarget(ctx:object("g_hTarget")) -- DRAGONRED.scr:273
...
script.labels["DoHandAttack"] = function(ctx)
    -- DRAGONRED.scr:280
    ctx:self():playAnimation("hAttack1", "AttackDone") -- DRAGONRED.scr:283
...
script.labels["DoCloseAttack"] = function(ctx)
    ...
    ctx:state().g_nTemp = 0 -- DRAGONRED.scr:298
    ctx:state().currTargetDist = ctx:self():aiDistanceTo(ctx:object("g_hTarget")) -- DRAGONRED.scr:300
    -- DebugOut currTargetDist
    if ctx:condition("currTargetDist < MAX_HAND_ATTACK_DIST") then -- DRAGONRED.scr:302
        ctx:add("g_nTemp", "HAND_ATTACK_CHANCE") -- DRAGONRED.scr:303
    ...
    if ctx:condition("targetHeight > 100") then -- DRAGONRED.scr:307
        ctx:state().g_nTemp = 0 -- DRAGONRED.scr:308
    end -- DRAGONRED.scr:309
    ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:311
    ...
    ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:318
    ctx:state().g_nTemp = 20 -- DRAGONRED.scr:320
    if ctx:condition("currTargetDist < 100") then -- DRAGONRED.scr:322
        ctx:state().g_nTemp = 5 -- DRAGONRED.scr:323
...
script.labels["TargetDead"] = function(ctx)
    -- DRAGONRED.scr:336
    ctx:self():setTarget(nil) -- DRAGONRED.scr:338
    ctx:state().g_hTarget = nil -- DRAGONRED.scr:339
    ...
    ctx:set("g_hTarget", "hFoundTarget") -- DRAGONRED.scr:347
...
script.labels["SetupAttack"] = function(ctx)
    -- DRAGONRED.scr:356
    ctx:randomFloat("MIN_ATTACK_WAIT", "MAX_ATTACK_WAIT", "random") -- DRAGONRED.scr:359
    ctx:onEvent("OnTargetDead", "TargetDead") -- DRAGONRED.scr:361
    ctx:wait("ATTACK_WAIT_NBR", "random", "DoAttack") -- DRAGONRED.scr:363
...
script.labels["SetupWingAttack"] = function(ctx)
    -- DRAGONRED.scr:373
    ctx:randomFloat("MIN_WING_ATTACK_WAIT", "MAX_WING_ATTACK_WAIT", "random") -- DRAGONRED.scr:376
    ctx:onEvent("OnTargetDead", "TargetDead") -- DRAGONRED.scr:377
    ctx:wait("ATTACK_WAIT_NBR", "random", "DoCloseAttack") -- DRAGONRED.scr:378
    do return ctx:exit("") end -- DRAGONRED.scr:380
end

script.labels["SetupPostWingAttack"] = function(ctx)
    -- DRAGONRED.scr:383
    ctx:onEvent("OnTargetDead", "TargetDead") -- DRAGONRED.scr:386
...
script.labels["WakingUpDamage"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=hObject") then -- DRAGONRED.scr:405
        ctx:self():unlink(ctx:object("hWakeUpTarget")) -- DRAGONRED.scr:406
        ctx:self():link(ctx:object("hObject")) -- DRAGONRED.scr:407
...
script.labels["OnDamage"] = function(ctx)
    ...
    if ctx:condition("hLastAttacker!=hObject") then -- DRAGONRED.scr:422
        ctx:set("hLastAttacker", "hObject") -- DRAGONRED.scr:423
        ctx:self():link(ctx:object("hLastAttacker")) -- DRAGONRED.scr:424
    end -- DRAGONRED.scr:425
    -- See if we want to switch targets..
    -- For now, always switch target...
    if ctx:condition("g_hTarget==NULL") then -- DRAGONRED.scr:430
        ctx:set("g_hTarget", "hObject") -- DRAGONRED.scr:431
        ...
        if ctx:condition("hObject!=g_hTarget") then -- DRAGONRED.scr:435
            ...
            ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:437
            if ctx:condition("g_nRandom > 80") then -- DRAGONRED.scr:438
                ctx:add("switchHurryTime", 0.5) -- DRAGONRED.scr:439
...
script.labels["ArrayFind"] = function(ctx)
    ...
    ctx:state().g_nCounter = 0 -- DRAGONRED.scr:478
    ctx:state().nArrayFindIndex = -1 -- DRAGONRED.scr:479
    while ctx:condition("g_nCounter < nTargetsFound") do -- DRAGONRED.scr:481
        ctx:arrayGet("hTargetArray", "g_nCounter", "g_hObject") -- DRAGONRED.scr:482
        if ctx:condition("g_hObject==hArrayFind") then -- DRAGONRED.scr:484
            ctx:set("nArrayFindIndex", "g_nCounter") -- DRAGONRED.scr:485
            do return ctx:exit("") end -- DRAGONRED.scr:486
        end -- DRAGONRED.scr:487
        ctx:state().g_nCounter = (tonumber(ctx:state().g_nCounter) or 0) + 1 -- DRAGONRED.scr:489
...
script.labels["CheckClearShot"] = function(ctx)
    ...
    -- input:	hFoundTarget
    -- output: bClearShot
    ctx:state().bClearShot = false -- DRAGONRED.scr:506
    ctx:state().bClearShot = ctx:self():isClearShot(ctx:object("hFoundTarget")) -- DRAGONRED.scr:508
    if ctx:condition("bClearShot==FALSE") then -- DRAGONRED.scr:510
        -- Randomly decide if we should target them
        -- anyway...
        ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:513
        if ctx:condition("g_nRandom < NO_CLEAR_SHOT_IGNORE_CHANCE") then -- DRAGONRED.scr:514
            ctx:state().bClearShot = false -- DRAGONRED.scr:515
...
script.labels["FindTarget"] = function(ctx)
    ...
    -- DebugOut XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    ctx:state().hFoundTarget = nil -- DRAGONRED.scr:538
    ...
    -- most damage...
    ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:549
    ctx:state().nTargetsFound = 0 -- DRAGONRED.scr:550
    ctx:state().g_nTemp = 50 -- DRAGONRED.scr:552
    if ctx:condition("g_hTarget!=hLastAttacker") then -- DRAGONRED.scr:554
        ...
        ctx:state().g_nTemp = 20 -- DRAGONRED.scr:557
    end -- DRAGONRED.scr:558
    if ctx:condition("g_nRandom < 50") then -- DRAGONRED.scr:560
        ctx:self():findTargets("hTargetArray", "MAX_TARGETS", "nTargetsFound", "WING_ATTACK_DIST", 0) -- DRAGONRED.scr:561
    end -- DRAGONRED.scr:562
    if ctx:condition("nTargetsFound==0") then -- DRAGONRED.scr:564
        ctx:self():findTargets("hTargetArray", "MAX_TARGETS", "nTargetsFound", 0, 0) -- DRAGONRED.scr:565
    ...
    -- priority....
    ctx:set("hArrayFind", "hLastAttacker") -- DRAGONRED.scr:581
    ...
    if ctx:condition("nArrayFindIndex!=-1") then -- DRAGONRED.scr:584
        ...
        ctx:set("g_nTemp", "nArrayFindIndex") -- DRAGONRED.scr:586
        ctx:div("g_nTemp", "nTargetsFound") -- DRAGONRED.scr:587
        ctx:state().g_nTemp = (tonumber(ctx:state().g_nTemp) or 0) * 100 -- DRAGONRED.scr:588
        ctx:state().g_nTemp = (tonumber(ctx:state().g_nTemp) or 0) + 15 -- DRAGONRED.scr:590
        ctx:randomInt(0, 100, "g_nRandom") -- DRAGONRED.scr:592
        if ctx:condition("g_nRandom > g_nTemp") then -- DRAGONRED.scr:594
            -- Use last attacker...
            ctx:set("hFoundTarget", "hLastAttacker") -- DRAGONRED.scr:596
            ctx:state().g_nTemp = ctx:self():aiDistanceTo(ctx:object("hFoundTarget")) -- DRAGONRED.scr:598
            if ctx:condition("g_nTemp >= BREATH_ATTACK_DIST") then -- DRAGONRED.scr:600
                ...
                if ctx:condition("bClearShot==FALSE") then -- DRAGONRED.scr:602
                    ctx:state().hFoundTarget = nil -- DRAGONRED.scr:603
    ...
    while ctx:condition("g_nCounter < nTargetsFound") do -- DRAGONRED.scr:627
        ...
        ctx:state().g_nTemp = ctx:self():aiDistanceTo(ctx:object("hFoundTarget")) -- DRAGONRED.scr:644
...
script.labels["FindTargetNext"] = function(ctx)
    -- DRAGONRED.scr:669
    ctx:state().g_nCounter = (tonumber(ctx:state().g_nCounter) or 0) + 1 -- DRAGONRED.scr:671
...
script.labels["MaybeSwitchTarget"] = function(ctx)
    ...
    -- or not..
    ctx:getTime("g_nTemp") -- DRAGONRED.scr:691
    -- See if it's too soon to switch targets....
    ctx:sub("g_nTemp", "MIN_SAME_TARGET_TIME") -- DRAGONRED.scr:694
    ctx:add("g_nTemp", "switchHurryTime") -- DRAGONRED.scr:695
    ...
    ctx:state().switchChance = 20 -- DRAGONRED.scr:714
    ctx:state().currTargetDist = ctx:self():aiDistanceTo(ctx:object("g_hTarget")) -- DRAGONRED.scr:716
    ctx:state().foundTargetDist = ctx:self():aiDistanceTo(ctx:object("hFoundTarget")) -- DRAGONRED.scr:717
    if ctx:condition("currTargetDist > foundTargetDist") then -- DRAGONRED.scr:719
        ctx:state().switchChance = 80 -- DRAGONRED.scr:720
    end -- DRAGONRED.scr:721
    if ctx:condition("hFoundTarget==hLastAttacker") then -- DRAGONRED.scr:723
        ctx:state().switchChance = (tonumber(ctx:state().switchChance) or 0) + 45 -- DRAGONRED.scr:724
    end -- DRAGONRED.scr:725
    ctx:getTime("g_nTemp") -- DRAGONRED.scr:727
    ctx:sub("g_nTemp", "MAX_SAME_TARGET_TIME") -- DRAGONRED.scr:729
    ctx:add("g_nTemp", "switchHurryTime") -- DRAGONRED.scr:730
    ...
    ctx:randomInt(0, 100, "random") -- DRAGONRED.scr:736
...
script.labels["NewTarget"] = function(ctx)
    -- DRAGONRED.scr:743
    ctx:set("g_hTarget", "hFoundTarget") -- DRAGONRED.scr:746
...
script.labels["SetupNewTarget"] = function(ctx)
    -- DRAGONRED.scr:753
    ctx:getTime("lastTargetSwitch") -- DRAGONRED.scr:756
    ctx:state().switchHurryTime = 0 -- DRAGONRED.scr:757
    ctx:self():setTarget(ctx:object("g_hTarget")) -- DRAGONRED.scr:758
...
script.labels["DragonAwake"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=NULL") then -- DRAGONRED.scr:768
        ctx:set("g_hTarget", "hWakeUpTarget") -- DRAGONRED.scr:769
    end -- DRAGONRED.scr:770
    ctx:onEvent("OnDamage", "OnDamage") -- DRAGONRED.scr:772
    ctx:onEvent("OnLostTarget", "OnLostTarget") -- DRAGONRED.scr:773
    ctx:onEvent("OnFoundTarget", "OnFoundTarget") -- DRAGONRED.scr:774
    -- jsl--> I think we just want to find a target normal, ie: doesn't HAVE to
    -- be the guy that just shot us...
    ctx:state().g_hTarget = nil -- DRAGONRED.scr:780
    if ctx:condition("g_hTarget==NULL") then -- DRAGONRED.scr:782
        ...
        if ctx:condition("hFoundTarget==NULL") then -- DRAGONRED.scr:786
            ctx:self():setIdle() -- DRAGONRED.scr:787
            do return ctx:exit("") end -- DRAGONRED.scr:788
        end -- DRAGONRED.scr:789
        ctx:set("g_hTarget", "hFoundTarget") -- DRAGONRED.scr:791
...
script.labels["DamageWakeUp"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=0") then -- DRAGONRED.scr:804
        ctx:self():link(ctx:object("hWakeUpTarget")) -- DRAGONRED.scr:805
...
script.labels["WakeUpTrigger"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=0") then -- DRAGONRED.scr:817
        ctx:self():link(ctx:object("hWakeUpTarget")) -- DRAGONRED.scr:818
...
script.labels["WakeUp"] = function(ctx)
    ...
    ctx:onEvent("OnFoundPlayer") -- DRAGONRED.scr:832
    ctx:onEvent("OnAttackReady") -- DRAGONRED.scr:833
    ctx:onEvent("OnDamage", "WakingUpDamage") -- DRAGONRED.scr:834
    ctx:self():playAnimation("WakeUp", "DragonAwake") -- DRAGONRED.scr:836
...
script.labels["SetupSleeping"] = function(ctx)
    ...
    ctx:self():loopAnimation("Sleep", 0) -- DRAGONRED.scr:848
    -- When we find the player, we'll need to wake up...
    ctx:onEvent("OnDamage", "DamageWakeUp") -- DRAGONRED.scr:851
...
script.labels["OnObjectLinkBroken"] = function(ctx)
    ...
    if ctx:condition("hObject==hWakeUpTarget") then -- DRAGONRED.scr:870
        ctx:state().hWakeUpTarget = nil -- DRAGONRED.scr:871
    end -- DRAGONRED.scr:872
    if ctx:condition("hObject==hLastAttacker") then -- DRAGONRED.scr:874
        ctx:state().hLastAttacker = nil -- DRAGONRED.scr:875
    end -- DRAGONRED.scr:876
    if ctx:condition("hObject==g_hTarget") then -- DRAGONRED.scr:878
        ctx:self():setTarget(nil) -- DRAGONRED.scr:879
        ctx:state().g_hTarget = nil -- DRAGONRED.scr:880
...
script.labels["OnTest"] = function(ctx)
    -- DRAGONRED.scr:886
    ctx:self():playAnimation("rAttack2", "AttackDone") -- DRAGONRED.scr:889
    do return ctx:exit("") end -- DRAGONRED.scr:892
end

script.labels["TargetTooFar"] = function(ctx)
    -- DRAGONRED.scr:895
    ctx:self():setTarget(nil) -- DRAGONRED.scr:898
    ctx:state().g_hTarget = nil -- DRAGONRED.scr:899
    mm9.gosub(script, ctx, "ClearAttackTimer") -- DRAGONRED.scr:900
    ctx:self():setIdle() -- DRAGONRED.scr:901
    ctx:onEvent("OnTargetBeyondDist", "MAX_ATTACK_DIST", "TargetTooFar") -- DRAGONRED.scr:902
...
script.labels["Main"] = function(ctx)
    ...
    ctx:state().g_nTemp = true -- DRAGONRED.scr:932
    ...
    ctx:state().g_nTemp = ctx:self():getStat("VisibleRange") -- DRAGONRED.scr:939
    if ctx:condition("g_nTemp > MAX_ATTACK_DIST") then -- DRAGONRED.scr:941
        -- Don't go less than our default...
        ctx:set("MAX_ATTACK_DIST", "g_nTemp") -- DRAGONRED.scr:943
    end -- DRAGONRED.scr:944
    ctx:onEvent("OnCongestion", "OnCongestion") -- DRAGONRED.scr:946
    ctx:onEvent("OnObjectLinkBroken", "OnObjectLinkBroken") -- DRAGONRED.scr:947
    ctx:onEvent("OnTargetWithinDist", "WING_ATTACK_DIST", "SetupWingAttack") -- DRAGONRED.scr:948
    ctx:onEvent("OnTargetBeyondDist", "MAX_ATTACK_DIST", "TargetTooFar") -- DRAGONRED.scr:949
    ...
    ctx:state().dimsX, ctx:state().dimsY, ctx:state().dimsZ = ctx:self():dims() -- DRAGONRED.scr:957
