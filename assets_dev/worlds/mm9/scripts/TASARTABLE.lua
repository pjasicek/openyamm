...
script.labels["OnUse"] = function(ctx)
    ...
    ctx:command("set", "Counter 0") -- TASARTABLE.scr:39
    while ctx:condition("Counter<4") do -- TASARTABLE.scr:40
        ctx:hasItem("Item_ID", "g_ntemp") -- TASARTABLE.scr:42
        ctx:command("debugout", "Item_ID") -- TASARTABLE.scr:43
        if ctx:condition("G_ntemp==1") then -- TASARTABLE.scr:44
            ctx:command("getobjecthandle", "Item_name g_hobject") -- TASARTABLE.scr:46
        ...
        ctx:command("add", "Item_Id 1") -- TASARTABLE.scr:54
        ctx:command("item_name", "= Location + Item_ID") -- TASARTABLE.scr:55
        ctx:command("add", "Counter 1") -- TASARTABLE.scr:56
    end -- TASARTABLE.scr:57
    ctx:command("set", "Item_Id 435") -- TASARTABLE.scr:59
...
script.labels["CompleteCheck"] = function(ctx)
    ...
    if ctx:hasKey(9501) then -- TASARTABLE.scr:70-71
        ctx:command("arrayput", "KeyArray 0, 1") -- TASARTABLE.scr:72
    end -- TASARTABLE.scr:73
    if ctx:hasKey(9502) then -- TASARTABLE.scr:75-76
        ctx:command("arrayput", "KeyArray 1, 1") -- TASARTABLE.scr:77
    end -- TASARTABLE.scr:78
    if ctx:hasKey(9503) then -- TASARTABLE.scr:80-81
        ctx:command("arrayput", "KeyArray 2, 1") -- TASARTABLE.scr:82
    end -- TASARTABLE.scr:83
    if ctx:hasKey(9504) then -- TASARTABLE.scr:85-86
        ctx:command("arrayput", "KeyArray 3, 1") -- TASARTABLE.scr:87
...
script.labels["CheckAllKeys"] = function(ctx)
    ...
    ctx:command("set", "Counter, 0") -- TASARTABLE.scr:98
    while ctx:condition("counter!=4") do -- TASARTABLE.scr:100
        ctx:command("arrayget", "KeyArray, Counter, g_ntemp") -- TASARTABLE.scr:101
        if ctx:condition("g_ntemp==0") then -- TASARTABLE.scr:102
            do return ctx:exit("") end -- TASARTABLE.scr:103
        end -- TASARTABLE.scr:104
        ctx:command("add", "Counter 1") -- TASARTABLE.scr:106
    end -- TASARTABLE.scr:108
    -- ........success.........
    ctx:giveKey(9516) -- TASARTABLE.scr:112
    ctx:command("getobjecthandle", "LibraryDoor g_hobject") -- TASARTABLE.scr:113
    ctx:trigger("g_hobject", "unlock") -- TASARTABLE.scr:114
    ctx:trigger("g_hobject", "use") -- TASARTABLE.scr:115
    ctx:trigger("g_hobject", "lock") -- TASARTABLE.scr:116
...
script.labels["ItemInit"] = function(ctx)
    ...
    ctx:command("item_name", "= Location + Item_ID") -- TASARTABLE.scr:124
    if ctx:condition("Location==Offense") then -- TASARTABLE.scr:126
        ctx:command("set", "Book_Key 9501") -- TASARTABLE.scr:127
        ctx:command("set", "Book 435") -- TASARTABLE.scr:128
        ctx:command("nplacedkey", "= 9517") -- TASARTABLE.scr:129
    ...
    if ctx:condition("Location==Strategy") then -- TASARTABLE.scr:133
        ctx:command("set", "Book_Key 9502") -- TASARTABLE.scr:134
        ctx:command("set", "Book 436") -- TASARTABLE.scr:135
        ctx:command("nplacedkey", "= 9518") -- TASARTABLE.scr:136
        do return ctx:exit("") end -- TASARTABLE.scr:137
    end -- TASARTABLE.scr:138
    if ctx:condition("Location==Defense") then -- TASARTABLE.scr:140
        ctx:command("set", "Book_Key 9503") -- TASARTABLE.scr:141
        ctx:command("set", "Book 437") -- TASARTABLE.scr:142
        ctx:command("nplacedkey", "= 9519") -- TASARTABLE.scr:143
    ...
    if ctx:condition("Location==Intelligence") then -- TASARTABLE.scr:147
        ctx:command("set", "Book_Key 9504") -- TASARTABLE.scr:148
        ctx:command("set", "Book 438") -- TASARTABLE.scr:149
        ctx:command("nplacedkey", "= 9520") -- TASARTABLE.scr:150
