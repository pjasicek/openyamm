...
script.labels["OnRun"] = function(ctx)
    ...
    ctx:state().g_posX, ctx:state().g_posY, ctx:state().g_posZ = ctx:object("hAttacker"):rotation() -- PRIEST.scr:31
    ctx:self():faceDir("g_PosX", "g_PosY", "g_PosZ") -- PRIEST.scr:32
    -- This will cause a more erratic running behavior
    ctx:state().g_IdleCheckMin = 1 -- PRIEST.scr:35
    ctx:state().g_IdleCheckMax = 1 -- PRIEST.scr:36
    -- Set turn degree min max for more erratic movement
    ctx:state().g_TurnDegreeMin = 60 -- PRIEST.scr:39
    ctx:state().g_TurnDegreeMax = 90 -- PRIEST.scr:40
    ctx:self():run() -- PRIEST.scr:42
    ctx:state().g_IsRunning = true -- PRIEST.scr:44
...
script.labels["OnRunning"] = function(ctx)
    ...
    ctx:self():sendAlert(ctx:object("hAttacker")) -- PRIEST.scr:52
...
script.labels["OnStopRunning"] = function(ctx)
    ...
    ctx:state().g_IdleCheckMin = 2 -- PRIEST.scr:60
    ctx:state().g_IdleCheckMax = 6 -- PRIEST.scr:61
    ctx:state().g_TurnDegreeMin = 15 -- PRIEST.scr:63
    ctx:state().g_TurnDegreeMax = 90 -- PRIEST.scr:64
    ctx:state().g_IsRunning = false -- PRIEST.scr:66
...
script.labels["PriestOnDamage"] = function(ctx)
    ...
    -- Alert nearby AI
    ctx:self():sendAlert(ctx:object("hAttacker")) -- PRIEST.scr:81
    ctx:getTime("g_StopRunTime") -- PRIEST.scr:83
    ctx:state().g_StopRunTime = (tonumber(ctx:state().g_StopRunTime) or 0) + 15 -- PRIEST.scr:84
...
script.labels["InitPriest"] = function(ctx)
    ...
    if ctx:condition("g_nDistance != 0") then -- PRIEST.scr:105
        ctx:set("MAX_DIST_FROM_STARTPOINT", "g_nDistance") -- PRIEST.scr:106
    else -- PRIEST.scr:107
        ctx:state().MAX_DIST_FROM_STARTPOINT = 350 -- PRIEST.scr:108
    end -- PRIEST.scr:109
    -- Set how often the NPC is idle 1 equals 10% valid numbers are 1 to 10
    ctx:state().g_IdleFrequency = 8 -- PRIEST.scr:112
    -- Set max time in seconds before idle check
    ctx:state().g_IdleCheckMin = 5 -- PRIEST.scr:115
    ctx:state().g_IdleCheckMax = 10 -- PRIEST.scr:116
    -- Set how often special anim is played valid numbers are 1 to 10
    ctx:state().g_SpecialAnimFrequency = 0 -- PRIEST.scr:119
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnDamage", "PriestOnDamage") -- PRIEST.scr:135
    ctx:onEvent("OnDamageDone", "PriestOnDamageDone") -- PRIEST.scr:136
