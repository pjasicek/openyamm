...
script.labels["Main"] = function(ctx)
    -- TESTER.scr:1
    -- traceon
    ctx:self():addFriend("Player") -- TESTER.scr:3
    -- OnFoundPlayer output
    ctx:onEvent("OnDamage", "ondamage") -- TESTER.scr:5
    ctx:addTrigger("use", "givestuff") -- TESTER.scr:6
    -- giveattribute 3, -25, 1, 0
    -- givepromo 100
    ctx:self():setIdle() -- TESTER.scr:9
    do return ctx:exit(1) end -- TESTER.scr:10
end

script.labels["givestuff"] = function(ctx)
    -- TESTER.scr:13
    ctx:playSound("sounds\\default.wav") -- TESTER.scr:14
    ctx:giveAttribute(4, "v", 1, 0) -- TESTER.scr:15
    ctx:cprint("v") -- TESTER.scr:16
    do return ctx:exit(1) end -- TESTER.scr:17
end

script.labels["output"] = function(ctx)
    -- TESTER.scr:19
    ctx:cprint("FoundPlayer!!!") -- TESTER.scr:20
    do return ctx:exit(1) end -- TESTER.scr:21
end

script.labels["reverse"] = function(ctx)
    -- TESTER.scr:23
    ctx:playSound("sounds\\default.wav", "callback") -- TESTER.scr:24
    -- AddEnemy Player
...
script.labels["callback"] = function(ctx)
    -- TESTER.scr:28
    ctx:cprint("PlaySoundCallback") -- TESTER.scr:29
...
script.labels["dospell"] = function(ctx)
    -- TESTER.scr:34
    -- getmyhandle h
    ctx:object("h"):createFx("spell", 1) -- TESTER.scr:36
    do return ctx:exit(1) end -- TESTER.scr:37
end

script.labels["ondamage"] = function(ctx)
    -- TESTER.scr:41
    ctx:set("v", "v - 1") -- TESTER.scr:42
    ctx:set("counter", "counter + 1") -- TESTER.scr:43
    ctx:cprint("Hits:") -- TESTER.scr:44
    ctx:cprint("counter") -- TESTER.scr:45
    ctx:cprint("**********") -- TESTER.scr:46
