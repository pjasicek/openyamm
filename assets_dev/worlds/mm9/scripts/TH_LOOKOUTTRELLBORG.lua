...
script.labels["Start"] = function(ctx)
    ...
    ctx:state().bIsJousting = true -- TH_LOOKOUTTRELLBORG.scr:27
...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:wait(1, 1, "DoNothing") -- TH_LOOKOUTTRELLBORG.scr:33
    ctx:state().bIsJousting = false -- TH_LOOKOUTTRELLBORG.scr:34
    do return ctx:exit("TRUE") end -- TH_LOOKOUTTRELLBORG.scr:35
end

script.labels["LookAround"] = function(ctx)
    -- TH_LOOKOUTTRELLBORG.scr:38
    ctx:self():stop() -- TH_LOOKOUTTRELLBORG.scr:39
    ctx:self():playAnimation("Stand", "AnimationA") -- TH_LOOKOUTTRELLBORG.scr:40
    do return ctx:exit("TRUE") end -- TH_LOOKOUTTRELLBORG.scr:41
end

script.labels["AnimationA"] = function(ctx)
    -- TH_LOOKOUTTRELLBORG.scr:42
    ctx:self():playAnimation("Fidget1", "AnimationB") -- TH_LOOKOUTTRELLBORG.scr:43
    do return ctx:exit("TRUE") end -- TH_LOOKOUTTRELLBORG.scr:44
end

script.labels["AnimationB"] = function(ctx)
    -- TH_LOOKOUTTRELLBORG.scr:45
    ctx:self():playAnimation("Stand", "WalkToMarker") -- TH_LOOKOUTTRELLBORG.scr:46
    do return ctx:exit("TRUE") end -- TH_LOOKOUTTRELLBORG.scr:47
end

script.labels["WatchVictim"] = function(ctx)
    -- TH_LOOKOUTTRELLBORG.scr:52
    ctx:self():stop() -- TH_LOOKOUTTRELLBORG.scr:54
    ctx:state().hTarget = ctx:objectOrNil("sTargetB") -- TH_LOOKOUTTRELLBORG.scr:55
    ctx:self():faceObject(ctx:object("hTarget"), 180) -- TH_LOOKOUTTRELLBORG.scr:56
    ctx:wait(0, 2, "LookAround") -- TH_LOOKOUTTRELLBORG.scr:57
    do return ctx:exit("TRUE") end -- TH_LOOKOUTTRELLBORG.scr:58
end

script.labels["WatchBully"] = function(ctx)
    -- TH_LOOKOUTTRELLBORG.scr:60
    ctx:self():stop() -- TH_LOOKOUTTRELLBORG.scr:62
    ctx:state().hTarget = ctx:objectOrNil("sTargetA") -- TH_LOOKOUTTRELLBORG.scr:63
    ctx:self():faceObject(ctx:object("hTarget"), 180) -- TH_LOOKOUTTRELLBORG.scr:64
    ctx:wait(0, 2, "LookAround") -- TH_LOOKOUTTRELLBORG.scr:65
...
script.labels["WalkToMarker"] = function(ctx)
    ...
    if ctx:condition("bDirection==0") then -- TH_LOOKOUTTRELLBORG.scr:74
        ctx:state().bDirection = 1 -- TH_LOOKOUTTRELLBORG.scr:75
        ctx:state().hMarker = ctx:objectOrNil("sMarkerA") -- TH_LOOKOUTTRELLBORG.scr:76
        ctx:self():walkTo(ctx:object("hMarker"), 5, "WatchVictim") -- TH_LOOKOUTTRELLBORG.scr:77
    else -- TH_LOOKOUTTRELLBORG.scr:78
        ctx:state().bDirection = 0 -- TH_LOOKOUTTRELLBORG.scr:79
        ctx:state().hMarker = ctx:objectOrNil("sMarkerB") -- TH_LOOKOUTTRELLBORG.scr:80
        ctx:self():walkTo(ctx:object("hMarker"), 5, "WatchBully") -- TH_LOOKOUTTRELLBORG.scr:81
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "Main2") -- TH_LOOKOUTTRELLBORG.scr:99
