...
script.labels["Init"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "ShooterVolumeBrush, g_hobject") -- SHOOTERVOLUME.scr:52
    ctx:command("getobjectminmax", "g_hobject, VolumeMinX, VolumeMinY, VolumeMinZ, VolumeMaxX, VolumeMaxY, VolumeMaxZ") -- SHOOTERVOLUME.scr:53
    ctx:command("getpos", "g_hobject VolumeX, VolumeY, VolumeZ") -- SHOOTERVOLUME.scr:54
...
script.labels["CheckPlayerLoop"] = function(ctx)
    ...
    ctx:command("getplayerswithindist", "VolumeX, VolumeY, VolumeZ, 512, PlayerIds, 8, Playercount") -- SHOOTERVOLUME.scr:62
    ...
    ctx:command("set", "loopcounter, 0") -- SHOOTERVOLUME.scr:69
end

script.labels["CheckPlayerLoop2"] = function(ctx)
    -- SHOOTERVOLUME.scr:72
    ctx:command("arrayget", "PlayerIds, loopCounter, g_hobject") -- SHOOTERVOLUME.scr:75
    mm9.gosub(script, ctx, "CheckPlayer") -- SHOOTERVOLUME.scr:76
    ctx:command("add", "loopcounter, 1") -- SHOOTERVOLUME.scr:77
...
script.labels["CheckPlayer"] = function(ctx)
    ...
    ctx:command("wait", "1, CheckPlayerLoop") -- SHOOTERVOLUME.scr:115
...
script.labels["TurnOn"] = function(ctx)
    ...
    -- turn shooter on
    ctx:command("getobjecthandle", "Shooter, g_hobject") -- SHOOTERVOLUME.scr:133
    ctx:trigger("g_hobject", "on") -- SHOOTERVOLUME.scr:134
    -- turn touchnotify off
    ctx:command("ontouchnotify", "") -- SHOOTERVOLUME.scr:137
    ctx:command("wait", "1, CheckplayerLoop") -- SHOOTERVOLUME.scr:139
    do return ctx:exit("") end -- SHOOTERVOLUME.scr:141
end

script.labels["ShutOff"] = function(ctx)
    -- SHOOTERVOLUME.scr:144
    ctx:command("getobjecthandle", "Shooter, g_hobject") -- SHOOTERVOLUME.scr:147
    ctx:trigger("g_hobject", "off") -- SHOOTERVOLUME.scr:148
    ctx:command("ontouchnotify", "HandleTouchNotify .5") -- SHOOTERVOLUME.scr:149
    do return ctx:exit("") end -- SHOOTERVOLUME.scr:151
end

script.labels["Main"] = function(ctx)
    -- SHOOTERVOLUME.scr:154
    ctx:command("wait", "0.1, init") -- SHOOTERVOLUME.scr:157
    -- Get parameters
    ctx:getParam(0, "Shooter") -- SHOOTERVOLUME.scr:160
    ctx:getParam(1, "ShooterVolumeBrush") -- SHOOTERVOLUME.scr:161
    ctx:command("ontouchnotify", "HandleTouchNotify .5") -- SHOOTERVOLUME.scr:163
