...
script.labels["Init"] = function(ctx)
    ...
    if ctx:hasKey(40) then -- NPC239.scr:36-37
        ctx:state().bVanish = true -- NPC239.scr:38
        mm9.gosub(script, ctx, "vanish") -- NPC239.scr:39
        ctx:state().g_hobject = ctx:objectOrNil("MarkeProp0") -- NPC239.scr:40
        ctx:object("g_hobject"):remove() -- NPC239.scr:41
    end -- NPC239.scr:42
    if ctx:hasKey(108) then -- NPC239.scr:44-45
        ctx:state().bVanish = false -- NPC239.scr:46
...
script.labels["Vanish"] = function(ctx)
    -- NPC239.scr:54
    ctx:state().g_hobject = ctx:self() -- NPC239.scr:57
    if ctx:condition("bVanish==TRUE") then -- NPC239.scr:59
        ctx:self():setFlag("visible", false) -- NPC239.scr:60
        ctx:self():setFlag("solid", false) -- NPC239.scr:61
        ctx:self():setFlag("gravity", false) -- NPC239.scr:62
        do return ctx:exit("") end -- NPC239.scr:63
    else -- NPC239.scr:64
        ctx:self():setFlag("visible", true) -- NPC239.scr:65
        ctx:self():setFlag("solid", true) -- NPC239.scr:66
        ctx:self():setFlag("gravity", true) -- NPC239.scr:67
...
script.labels["treaty"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC239.scr:94
        ...
        if ctx:condition("keycheck==1") then -- NPC239.scr:96
            ...
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC239.scr:99
...
script.labels["loveletter"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC239.scr:118
        ...
        if ctx:condition("keycheck==1") then -- NPC239.scr:120
            ...
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC239.scr:124
...
script.labels["honkys"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC239.scr:144
        ...
        if ctx:condition("keycheck==1") then -- NPC239.scr:146
            ...
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC239.scr:150
...
script.labels["MountainPass"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC239.scr:169
        ...
        if ctx:condition("keycheck==1") then -- NPC239.scr:171
            ...
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- NPC239.scr:175
...
script.labels["OnUse"] = function(ctx)
    -- NPC239.scr:188
    -- loopanim Sit 0 DoNothing
    ctx:playSound("voices\\NPC\\NPC_239.wav", "Onexit", 100, 240, "FALSE", 100) -- NPC239.scr:192
...
script.labels["OnKillMarkel"] = function(ctx)
    -- NPC239.scr:218
    ctx:object("Prop16"):trigger("play") -- NPC239.scr:221-222
    ctx:state().g_hobject = ctx:objectOrNil("MarkeProp") -- NPC239.scr:223
    ctx:object("g_hobject"):remove() -- NPC239.scr:224
    ctx:object("MarkeProp0"):setFlag("visible", true) -- NPC239.scr:225-226
...
script.labels["Main"] = function(ctx)
    ...
    ctx:atTime(6, 0, "Givekey", "Givekey") -- NPC239.scr:236
    ...
    ctx:set("Jarl", "Kira") -- NPC239.scr:241
    mm9.gosub(script, ctx, "UnitedInit") -- NPC239.scr:242
    ctx:onEvent("OnPostStartWorld", "Init") -- NPC239.scr:243
    ctx:onEvent("OnPostMiniSaveLoad", "Init") -- NPC239.scr:244
    ctx:onEvent("OnPostSaveLoad", "Init") -- NPC239.scr:245
    ctx:wait(1, .1, "Init") -- NPC239.scr:246
