...
script.labels["OnUse"] = function(ctx)
    ...
    ctx:command("getmyhandle", "g_hmyobject") -- SKILLBOOK.scr:25
    ctx:command("removeobject", "g_hmyobject") -- SKILLBOOK.scr:26
...
script.labels["SkillInit"] = function(ctx)
    ...
    if ctx:condition("Skill_Name==Meditation") then -- SKILLBOOK.scr:180
        ctx:command("set", "Item_Id 306") -- SKILLBOOK.scr:181
