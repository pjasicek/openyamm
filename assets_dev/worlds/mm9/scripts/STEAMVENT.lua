...
script.labels["TurnItOff"] = function(ctx)
    ...
    ctx:command("wait", "0 nOffWait TurnItOn") -- STEAMVENT.scr:31
...
script.labels["TurnItOn"] = function(ctx)
    ...
    ctx:command("wait", "0 nOnWait TurnItOff") -- STEAMVENT.scr:42
    do return ctx:exit(1) end -- STEAMVENT.scr:44
end

script.labels["main2"] = function(ctx)
    -- STEAMVENT.scr:48
    ctx:command("getmyhandle", "hMyHandle") -- STEAMVENT.scr:51
    ctx:command("getobjecthandle", "sDamageBrush hDamageBrush") -- STEAMVENT.scr:52
...
script.labels["main"] = function(ctx)
    ...
    ctx:command("wait", "0 .1 main2") -- STEAMVENT.scr:66
