...
script.labels["Directions"] = function(ctx)
    ...
    ctx:command("ncount", "= nCount + 1") -- DP_INTERROGATIONGUARD1.scr:50
                ...
                if ctx:condition("nCount==4") then -- DP_INTERROGATIONGUARD1.scr:61
                    ...
                    if ctx:condition("nCount==5") then -- DP_INTERROGATIONGUARD1.scr:64
                        ...
                        if ctx:condition("nCount==6") then -- DP_INTERROGATIONGUARD1.scr:67
                            ctx:command("ncount", "= 0") -- DP_INTERROGATIONGUARD1.scr:68
...
script.labels["WalkToLastMarker"] = function(ctx)
    ...
    if ctx:condition("nNumA==1") then -- DP_INTERROGATIONGUARD1.scr:80
        ctx:command("nmarker", "= nMarker + 1") -- DP_INTERROGATIONGUARD1.scr:81
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:82
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:83
        ctx:command("hcelldoor", "= NULL") -- DP_INTERROGATIONGUARD1.scr:84
        ctx:command("getobjecthandle", "sCellDoorA, hCellDoor") -- DP_INTERROGATIONGUARD1.scr:85
        ctx:command("walkto", "hMarker 10 Cell") -- DP_INTERROGATIONGUARD1.scr:86
    end -- DP_INTERROGATIONGUARD1.scr:87
    if ctx:condition("nNumA==2") then -- DP_INTERROGATIONGUARD1.scr:88
        ctx:command("nmarker", "= nMarker + 2") -- DP_INTERROGATIONGUARD1.scr:89
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:90
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:91
        ctx:command("hcelldoor", "= NULL") -- DP_INTERROGATIONGUARD1.scr:92
        ctx:command("getobjecthandle", "sCellDoorB, hCellDoor") -- DP_INTERROGATIONGUARD1.scr:93
        ctx:command("walkto", "hMarker 10 Cell") -- DP_INTERROGATIONGUARD1.scr:94
    end -- DP_INTERROGATIONGUARD1.scr:95
    if ctx:condition("nNumA==3") then -- DP_INTERROGATIONGUARD1.scr:96
        ctx:command("nmarker", "= nMarker + 3") -- DP_INTERROGATIONGUARD1.scr:97
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:98
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:99
        ctx:command("hcelldoor", "= NULL") -- DP_INTERROGATIONGUARD1.scr:100
        ctx:command("getobjecthandle", "sCellDoorC, hCellDoor") -- DP_INTERROGATIONGUARD1.scr:101
        ctx:command("walkto", "hMarker 10 Cell") -- DP_INTERROGATIONGUARD1.scr:102
...
script.labels["DoTheWalk"] = function(ctx)
    ...
    ctx:command("nreset", "= nReset + 1") -- DP_INTERROGATIONGUARD1.scr:111
    if ctx:condition("nVarPath==0") then -- DP_INTERROGATIONGUARD1.scr:112
        ctx:command("nvarpath", "= 1") -- DP_INTERROGATIONGUARD1.scr:113
        ctx:command("nnuma", "= nNumA + 1") -- DP_INTERROGATIONGUARD1.scr:114
        mm9.gosub(script, ctx, "ToTheWarden") -- DP_INTERROGATIONGUARD1.scr:115
    else -- DP_INTERROGATIONGUARD1.scr:116
        ctx:command("nvarpath", "= 0") -- DP_INTERROGATIONGUARD1.scr:117
...
script.labels["ToTheWarden"] = function(ctx)
    ...
    if ctx:condition("nMarker < nNumMarkers") then -- DP_INTERROGATIONGUARD1.scr:129
        ctx:command("nmarker", "= nMarker + 1") -- DP_INTERROGATIONGUARD1.scr:130
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:131
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:132
        ctx:command("walkto", "hMarker 10 ToTheWarden") -- DP_INTERROGATIONGUARD1.scr:133
...
script.labels["ToTheInterrogation"] = function(ctx)
    ...
    if ctx:condition("nMarker != 0") then -- DP_INTERROGATIONGUARD1.scr:142
        ctx:command("nmarker", "= nMarker - 1") -- DP_INTERROGATIONGUARD1.scr:143
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:144
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:145
        ...
        ctx:command("walkto", "hMarker 10 ToTheInterrogation") -- DP_INTERROGATIONGUARD1.scr:151
...
script.labels["InterrogationRoom"] = function(ctx)
    ...
    if ctx:condition("nReset==6") then -- DP_INTERROGATIONGUARD1.scr:161
        ctx:command("nreset", "= 0") -- DP_INTERROGATIONGUARD1.scr:162
        ctx:command("stop", "") -- DP_INTERROGATIONGUARD1.scr:163
    else -- DP_INTERROGATIONGUARD1.scr:164
        ctx:command("nmarker", "= 0") -- DP_INTERROGATIONGUARD1.scr:165
        ctx:command("stop", "") -- DP_INTERROGATIONGUARD1.scr:166
        ctx:command("playanim", "Aware, DoNothing") -- DP_INTERROGATIONGUARD1.scr:167
        ctx:command("wait", "1, 15, DoTheWalk") -- DP_INTERROGATIONGUARD1.scr:168
...
script.labels["NextPrisoner"] = function(ctx)
    ...
    if ctx:condition("nNumA==1") then -- DP_INTERROGATIONGUARD1.scr:178
        ctx:command("nmarker", "= nMarker + 1") -- DP_INTERROGATIONGUARD1.scr:179
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:180
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:181
        ctx:command("nmarker", "= 4") -- DP_INTERROGATIONGUARD1.scr:182
        ctx:command("hcelldoor", "= NULL") -- DP_INTERROGATIONGUARD1.scr:183
        ctx:command("getobjecthandle", "sCellDoorB, hCellDoor") -- DP_INTERROGATIONGUARD1.scr:184
        ctx:command("walkto", "hMarker 10 Cell") -- DP_INTERROGATIONGUARD1.scr:185
    end -- DP_INTERROGATIONGUARD1.scr:186
    if ctx:condition("nNumA==2") then -- DP_INTERROGATIONGUARD1.scr:188
        ctx:command("nmarker", "= nMarker + 1") -- DP_INTERROGATIONGUARD1.scr:189
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:190
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:191
        ctx:command("nmarker", "= 4") -- DP_INTERROGATIONGUARD1.scr:192
        ctx:command("hcelldoor", "= NULL") -- DP_INTERROGATIONGUARD1.scr:193
        ctx:command("getobjecthandle", "sCellDoorC, hCellDoor") -- DP_INTERROGATIONGUARD1.scr:194
        ctx:command("walkto", "hMarker 10 Cell") -- DP_INTERROGATIONGUARD1.scr:195
    end -- DP_INTERROGATIONGUARD1.scr:196
    if ctx:condition("nNumA==3") then -- DP_INTERROGATIONGUARD1.scr:198
        ctx:command("nmarker", "= nMarker - 2") -- DP_INTERROGATIONGUARD1.scr:199
        ctx:command("smarker", "= sWayPoint + nMarker") -- DP_INTERROGATIONGUARD1.scr:200
        ctx:command("getobjecthandle", "sMarker hMarker") -- DP_INTERROGATIONGUARD1.scr:201
        ctx:command("nmarker", "= 4") -- DP_INTERROGATIONGUARD1.scr:202
        ctx:command("hcelldoor", "= NULL") -- DP_INTERROGATIONGUARD1.scr:203
        ctx:command("getobjecthandle", "sCellDoorA, hCellDoor") -- DP_INTERROGATIONGUARD1.scr:204
        ctx:command("nnuma", "= 0") -- DP_INTERROGATIONGUARD1.scr:205
        ctx:command("walkto", "hMarker 10 Cell") -- DP_INTERROGATIONGUARD1.scr:206
...
script.labels["Cell"] = function(ctx)
    ...
    ctx:command("stop", "") -- DP_INTERROGATIONGUARD1.scr:214
    ctx:command("wait", "1, 2, DoNothing") -- DP_INTERROGATIONGUARD1.scr:215
    ctx:command("playanim", "Fidget1, DoNothing") -- DP_INTERROGATIONGUARD1.scr:216
    ctx:command("faceobject", "hCellDoor, 220, DoNothing") -- DP_INTERROGATIONGUARD1.scr:217
...
script.labels["CheckPlayer"] = function(ctx)
    ...
    ctx:command("isplayer", "hParam, bIsPlayer") -- DP_INTERROGATIONGUARD1.scr:224
    ...
    ctx:command("bhashostilekey", "= 1 - bHasHostileKey") -- DP_INTERROGATIONGUARD1.scr:227
    ctx:command("bresult", "= bHasFriendlyKey * bHasHostileKey * bIsPlayer") -- DP_INTERROGATIONGUARD1.scr:228
    if ctx:condition("bResult == FALSE") then -- DP_INTERROGATIONGUARD1.scr:229
        ...
        ctx:command("addfriend", "Player") -- DP_INTERROGATIONGUARD1.scr:233
...
script.labels["AlertCall"] = function(ctx)
    ...
    if ctx:condition("sMyGuard==Interrogator0") then -- DP_INTERROGATIONGUARD1.scr:254
        ctx:command("playsound", "sounds\\VO\\Charrrge.wav, DoNothing, 100, 500, FALSE, 90") -- DP_INTERROGATIONGUARD1.scr:255
    else -- DP_INTERROGATIONGUARD1.scr:256
        ctx:command("playsound", "sounds\\VO\\TheyAreHere.wav, DoNothing, 100, 500, FALSE, 90") -- DP_INTERROGATIONGUARD1.scr:257
    end -- DP_INTERROGATIONGUARD1.scr:258
    ctx:command("runto", "hParam, 25, BaseInit") -- DP_INTERROGATIONGUARD1.scr:260
    do return ctx:exit(1) end -- DP_INTERROGATIONGUARD1.scr:262
end

script.labels["Main2"] = function(ctx)
    -- DP_INTERROGATIONGUARD1.scr:265
    ctx:command("getobjecthandle", "InterrDoorman, hDoorMan") -- DP_INTERROGATIONGUARD1.scr:267
    ctx:command("nvarpath", "= 0") -- DP_INTERROGATIONGUARD1.scr:268
    ctx:command("nnummarkers", "= nNumMarkers - 2") -- DP_INTERROGATIONGUARD1.scr:269
    ...
    ctx:command("onfoundtarget", "CheckPlayer") -- DP_INTERROGATIONGUARD1.scr:274
    ctx:command("ondamage", "SetKeyValue") -- DP_INTERROGATIONGUARD1.scr:275
    do return ctx:exit(1) end -- DP_INTERROGATIONGUARD1.scr:278
end

script.labels["Main"] = function(ctx)
    -- DP_INTERROGATIONGUARD1.scr:281
    ctx:command("addfriend", "PrisonerHumanMaleA") -- DP_INTERROGATIONGUARD1.scr:283
    ...
    ctx:command("wait", "0 .5 main2") -- DP_INTERROGATIONGUARD1.scr:291
