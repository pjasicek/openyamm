...
script.labels["SpawnDone"] = function(ctx)
    -- GREATERDEMON.scr:21
    ctx:command("aware", "AwareDone") -- GREATERDEMON.scr:23
    do return ctx:exit("") end -- GREATERDEMON.scr:25
end

script.labels["DoSpawnAnim"] = function(ctx)
    -- GREATERDEMON.scr:28
    ctx:command("getplayerhandle", "g_hObject") -- GREATERDEMON.scr:31
    ctx:command("faceobject", "g_hObject") -- GREATERDEMON.scr:32
    ctx:command("playanim", "Spawn, SpawnDone") -- GREATERDEMON.scr:34
    ctx:command("setflag", "g_hMyObject,FLAG_VISIBLE") -- GREATERDEMON.scr:35
...
script.labels["SpawnIn"] = function(ctx)
    ...
    ctx:command("doclientfx", "g_hMyObject,GreaterDemon") -- GREATERDEMON.scr:46
    ctx:command("wait", "29, 1, DoSpawnAnim") -- GREATERDEMON.scr:48
...
script.labels["Main"] = function(ctx)
    ...
    if ctx:condition("g_bTemp==TRUE") then -- GREATERDEMON.scr:68
        ctx:command("getmyhandle", "g_hMyObject") -- GREATERDEMON.scr:69
        ctx:command("clearflag", "g_hMyObject,FLAG_VISIBLE") -- GREATERDEMON.scr:70
        ctx:command("wait", "0, 0.1, SpawnIn") -- GREATERDEMON.scr:71
