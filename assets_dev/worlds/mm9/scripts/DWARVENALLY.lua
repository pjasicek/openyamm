...
script.labels["Main"] = function(ctx)
    ...
    if ctx:condition("sTunnelName==\"0\"") then -- DWARVENALLY.scr:25
        ctx:command("onfoundtarget", "SetupMelee") -- DWARVENALLY.scr:26
        ...
        ctx:command("ntemp", "= LISTFIRST + 1") -- DWARVENALLY.scr:31
        mm9.gosub(script, ctx, "SetTraverseOnce") -- DWARVENALLY.scr:32
        mm9.gosub(script, ctx, "SetTraverseRun") -- DWARVENALLY.scr:33
        ctx:command("onfoundplayer", "TraverseBegin") -- DWARVENALLY.scr:34
        ctx:command("ondeath", "UnlockBin") -- DWARVENALLY.scr:35
    end -- DWARVENALLY.scr:36
    -- OnPostStartWorld InitDwarvenAlly
    ctx:command("wait", "0, 5, InitDwarvenAlly") -- DWARVENALLY.scr:39
    do return ctx:exit("TRUE") end -- DWARVENALLY.scr:41
end

script.labels["InitDwarvenAlly"] = function(ctx)
    -- DWARVENALLY.scr:44
    ctx:command("addenemy", "AIBase") -- DWARVENALLY.scr:46
    -- add the whole family
    ctx:command("addfriend", "DwarvenSoldier") -- DWARVENALLY.scr:49
    ctx:command("addfriend", "DwarvenGuard") -- DWARVENALLY.scr:50
    ctx:command("addfriend", "DwarvenCommander") -- DWARVENALLY.scr:51
    ctx:command("addfriend", "Player") -- DWARVENALLY.scr:52
    ctx:command("onstuck", "TraverseResume") -- DWARVENALLY.scr:54
...
script.labels["OnTraverseDone"] = function(ctx)
    -- DWARVENALLY.scr:75
    ctx:command("onfoundplayer", "DoNothing") -- DWARVENALLY.scr:77
    if ctx:condition("LISTINDEX==LISTFIRST") then -- DWARVENALLY.scr:79
        ctx:command("rollovertext", "100, SCREEN_TYPE, 3000, 3000, SCREEN_X, SCREEN_Y") -- DWARVENALLY.scr:80
        -- play sound "follow me!"
        -- play animation
    end -- DWARVENALLY.scr:83
    if ctx:condition("LISTINDEX = nTemp") then -- DWARVENALLY.scr:85
        ctx:command("rollovertext", "103, SCREEN_TYPE, 3000, 3000, SCREEN_X, SCREEN_Y") -- DWARVENALLY.scr:86
    ...
    if ctx:condition("LISTINDEX==LISTLAST") then -- DWARVENALLY.scr:89
        ...
        ctx:command("rollovertext", "101, SCREEN_TYPE, 3000, 3000, SCREEN_X, SCREEN_Y") -- DWARVENALLY.scr:91
        ctx:command("getobjecthandle", "sTunnelName, hTunnel") -- DWARVENALLY.scr:92
        ...
        ctx:command("ondeath", "DoNothing") -- DWARVENALLY.scr:97
        ctx:command("wait", "0, 6, InformPlayer") -- DWARVENALLY.scr:98
...
script.labels["InformPlayer"] = function(ctx)
    -- DWARVENALLY.scr:104
    ctx:command("rollovertext", "102, SCREEN_TYPE, 5000, 4000, SCREEN_X, SCREEN_Y") -- DWARVENALLY.scr:106
    ctx:command("onfoundtarget", "SetupMelee") -- DWARVENALLY.scr:108
...
script.labels["UnlockBin"] = function(ctx)
    ...
    if ctx:condition("hTunnel==0") then -- DWARVENALLY.scr:117
        ctx:command("getobjecthandle", "sTunnelName, hTunnel") -- DWARVENALLY.scr:118
