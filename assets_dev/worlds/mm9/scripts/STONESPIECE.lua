...
script.labels["TurnWhite"] = function(ctx)
    -- STONESPIECE.scr:17
    ctx:self():setModelFilenames("models\\gibs\\stone.abc", "skins\\gibs\\yellow.dtx") -- STONESPIECE.scr:19
    do return ctx:exit(1) end -- STONESPIECE.scr:21
end

script.labels["TurnBlack"] = function(ctx)
    -- STONESPIECE.scr:24
    ctx:self():setModelFilenames("models\\gibs\\stone.abc", "skins\\gibs\\blue.dtx") -- STONESPIECE.scr:26
