...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, 1, "InitMachinePanel") -- LL_MACHINEPANEL.scr:17
...
script.labels["Malfunction"] = function(ctx)
    ...
    if ctx:condition("hTrigger==0") then -- LL_MACHINEPANEL.scr:31
        ctx:state().hTrigger = ctx:objectOrNil("sTriggerName") -- LL_MACHINEPANEL.scr:32
    ...
    ctx:playSound("sounds\\default.wav", "BlowUp", 1, 500, 0, 100) -- LL_MACHINEPANEL.scr:39
...
script.labels["BlowUp"] = function(ctx)
    ...
    ctx:state().hTrigger = ctx:self() -- LL_MACHINEPANEL.scr:48
