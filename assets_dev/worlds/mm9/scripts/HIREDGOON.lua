...
script.labels["Main"] = function(ctx)
    -- HIREDGOON.scr:19
    ctx:command("wait", "0, 1, InitHiredGoon") -- HIREDGOON.scr:21
    do return ctx:exit("TRUE") end -- HIREDGOON.scr:23
end

script.labels["InitHiredGoon"] = function(ctx)
    -- HIREDGOON.scr:26
    ctx:command("addenemy", "AIBase") -- HIREDGOON.scr:28
    ctx:command("addfriend", "Player") -- HIREDGOON.scr:29
    ...
    ctx:command("getmyhandle", "hMe") -- HIREDGOON.scr:35
    mm9.gosub(script, ctx, "BaseInit") -- HIREDGOON.scr:37
    mm9.gosub(script, ctx, "FollowInit") -- HIREDGOON.scr:38
    ctx:command("onfoundtarget", "OnFoundTarget") -- HIREDGOON.scr:40
    ctx:command("ondamage", "OnDamage") -- HIREDGOON.scr:41
    ctx:command("ontargetdead", "BecomeFriendly") -- HIREDGOON.scr:42
...
script.labels["BecomeFriendly"] = function(ctx)
    -- HIREDGOON.scr:49
    ctx:command("target", "NULL") -- HIREDGOON.scr:51
    ctx:command("henemy", "= NULL") -- HIREDGOON.scr:52
    ctx:command("g_htarget", "= NULL") -- HIREDGOON.scr:53
...
script.labels["BecomeHostile"] = function(ctx)
    ...
    ctx:command("addfriend", "AIBase") -- HIREDGOON.scr:64
    ctx:command("addenemy", "Player") -- HIREDGOON.scr:65
    ctx:command("playsound", "sounds\\animsounds\\dragon\\fidget2.wav, DoNothing, 1, 1000, FALSE, 100") -- HIREDGOON.scr:67
...
script.labels["Destroy"] = function(ctx)
    ...
    ctx:command("die", "") -- HIREDGOON.scr:75
...
script.labels["OnDamage"] = function(ctx)
    ...
    ctx:command("isplayer", "hDummy, bIsPlayer") -- HIREDGOON.scr:114
    if ctx:condition("bIsPlayer==TRUE") then -- HIREDGOON.scr:116
        ctx:command("ncounter", "= nCounter + 1") -- HIREDGOON.scr:117
