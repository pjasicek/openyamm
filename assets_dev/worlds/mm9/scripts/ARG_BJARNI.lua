...
script.labels["OnAgree"] = function(ctx)
    -- ARG_BJARNI.scr:16
    ctx:playSound("sAgree", "DoNothing", 100, 24000, "FALSE", 100) -- ARG_BJARNI.scr:20
    ctx:self():playAnimation("Agree", "OnIdle") -- ARG_BJARNI.scr:21
    do return ctx:exit("") end -- ARG_BJARNI.scr:22
end

script.labels["OnSign"] = function(ctx)
    -- ARG_BJARNI.scr:25
    ctx:playSound("sSign", "DoNothing", 100, 24000, "FALSE", 100) -- ARG_BJARNI.scr:28
    do return ctx:exit("") end -- ARG_BJARNI.scr:29
end

script.labels["OnShake"] = function(ctx)
    -- ARG_BJARNI.scr:32
    ctx:self():playAnimation("Sc2_Bjarni1c", "OnIdle") -- ARG_BJARNI.scr:35
    do return ctx:exit("") end -- ARG_BJARNI.scr:36
end

script.labels["Init"] = function(ctx)
    -- ARG_BJARNI.scr:40
    ctx:self():loopAnimation("Sit", 0, "DoNothing") -- ARG_BJARNI.scr:43
    do return ctx:exit("") end -- ARG_BJARNI.scr:44
end

script.labels["OnIdle"] = function(ctx)
    -- ARG_BJARNI.scr:47
    ctx:self():loopAnimation("Sit", 0, "DoNothing") -- ARG_BJARNI.scr:50
    do return ctx:exit("") end -- ARG_BJARNI.scr:51
end

script.labels["On1A"] = function(ctx)
    -- ARG_BJARNI.scr:54
    ctx:self():playAnimation("Sc2_Bjarni1a", "Init") -- ARG_BJARNI.scr:57
...
script.labels["Cam3"] = function(ctx)
    ...
    ctx:object("Argueman"):trigger("Done") -- ARG_BJARNI.scr:65-66
...
script.labels["OnDone"] = function(ctx)
    -- ARG_BJARNI.scr:70
    -- loopanim Sc2_Bjarni2 0 DoNothing
    ctx:object("Argueman"):trigger("Done") -- ARG_BJARNI.scr:74-75
    do return ctx:exit("") end -- ARG_BJARNI.scr:76
end

script.labels["OnSpeak2"] = function(ctx)
    -- ARG_BJARNI.scr:79
    ctx:self():playAnimation("Sc2_Bjarni2", "OnIdle") -- ARG_BJARNI.scr:82
    do return ctx:exit("") end -- ARG_BJARNI.scr:84
end

script.labels["OnVoice2"] = function(ctx)
    -- ARG_BJARNI.scr:87
    ctx:playSound("\\voices\\cinema\\TheArgument\\02.wav", "DoNothing", 100, 24000, "FALSE", 100) -- ARG_BJARNI.scr:91
    do return ctx:exit("") end -- ARG_BJARNI.scr:92
end

script.labels["OnSpeak9"] = function(ctx)
    -- ARG_BJARNI.scr:95
    ctx:self():playAnimation("Sc2_Bjarni9", "OnIdle") -- ARG_BJARNI.scr:98
    do return ctx:exit("") end -- ARG_BJARNI.scr:100
end

script.labels["OnVoice9"] = function(ctx)
    -- ARG_BJARNI.scr:103
    ctx:playSound("\\voices\\cinema\\TheArgument\\09.wav", "DoNothing", 100, 24000, "FALSE", 100) -- ARG_BJARNI.scr:107
    do return ctx:exit("") end -- ARG_BJARNI.scr:108
end

script.labels["OnSpeak16"] = function(ctx)
    -- ARG_BJARNI.scr:111
    ctx:self():playAnimation("Sc2_bjarni15", "OnIdle") -- ARG_BJARNI.scr:114
    ctx:object("Markel"):trigger("Move") -- ARG_BJARNI.scr:116-117
    -- gosub OnVoice16
    -- wait 1 2 OnDone
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "Init") -- ARG_BJARNI.scr:186
    ctx:onEvent("OnPostMiniSaveLoad", "Init") -- ARG_BJARNI.scr:187
    ctx:onEvent("OnPostSaveLoad", "Init") -- ARG_BJARNI.scr:188
    ctx:wait(1, .1, "Init") -- ARG_BJARNI.scr:189
    ctx:addTrigger("Speak2", "OnSpeak2") -- ARG_BJARNI.scr:190
    ctx:addModelKey("Cam3", "Cam3") -- ARG_BJARNI.scr:191
    ctx:addModelKey("Voice2", "OnVoice2") -- ARG_BJARNI.scr:192
    ctx:addTrigger("Speak9", "OnSpeak9") -- ARG_BJARNI.scr:193
    ctx:addModelKey("Voice9", "OnVoice9") -- ARG_BJARNI.scr:194
    ctx:addTrigger("Speak16", "OnSpeak16") -- ARG_BJARNI.scr:195
    ctx:addModelKey("Voice16", "OnVoice16") -- ARG_BJARNI.scr:196
    ctx:addModelKey("Done", "OnDone") -- ARG_BJARNI.scr:197
    ctx:addTrigger("Shake", "OnShake") -- ARG_BJARNI.scr:198
    ctx:addTrigger("Clap", "OnApplause") -- ARG_BJARNI.scr:199
    ctx:addModelKey("Clap", "OnClap") -- ARG_BJARNI.scr:200
    ctx:addTrigger("Agree", "OnAgree") -- ARG_BJARNI.scr:201
    ctx:addModelKey("Sign", "OnSign") -- ARG_BJARNI.scr:202
