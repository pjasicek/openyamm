...
script.labels["Main"] = function(ctx)
    ...
    -- register game name
    ctx:command("getmyhandle", "hPiece") -- TRONGAME.scr:46
    ctx:command("getobjectname", "hPiece, sPieceName") -- TRONGAME.scr:47
    ctx:setConsoleStrVar("TRON_NAME", "sPieceName") -- TRONGAME.scr:48
    ctx:command("listfirst", "= 0") -- TRONGAME.scr:50
    ctx:command("listlast", "= BOARDSIZE * BOARDSIZE - 1") -- TRONGAME.scr:51
    ctx:command("onpoststartworld", "InitTronGame") -- TRONGAME.scr:53
...
script.labels["InitTronGame"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "sBotName, hBot") -- TRONGAME.scr:61
    if ctx:condition("hBot!=0") then -- TRONGAME.scr:62
        ctx:command("createobjectlink", "hBot") -- TRONGAME.scr:63
        ctx:command("onobjectlinkbroken", "OnObjectLinkBroken") -- TRONGAME.scr:64
    end -- TRONGAME.scr:65
...
script.labels["OnObjectLinkBroken"] = function(ctx)
    -- TRONGAME.scr:74
    ctx:command("hbot", "= NULL") -- TRONGAME.scr:76
...
script.labels["GameOver"] = function(ctx)
    ...
    if ctx:condition("nMoveCount==TRON_WHITE") then -- TRONGAME.scr:83
        ctx:command("rollovertext", "230, 1, 3000, 2000") -- TRONGAME.scr:84
        ...
        if ctx:condition("nMoveCount==TRON_BLACK") then -- TRONGAME.scr:87
            ctx:command("rollovertext", "231, 1, 3000, 2000") -- TRONGAME.scr:88
        end -- TRONGAME.scr:89
    end -- TRONGAME.scr:90
...
script.labels["CheckMove"] = function(ctx)
    ...
    if ctx:condition("bHasTicket==FALSE") then -- TRONGAME.scr:105
        ...
        if ctx:condition("THJORGARD_RESULT==0") then -- TRONGAME.scr:107
            ...
            ctx:command("bhasticket", "= TRUE") -- TRONGAME.scr:111
        end -- TRONGAME.scr:112
    end -- TRONGAME.scr:113
    ctx:command("removetrigger", "move") -- TRONGAME.scr:115
    -- get the current square
    ctx:getConsoleNumVar("TRON_INDEX", "nCurSquare") -- TRONGAME.scr:118
    ctx:command("arrayget", "npSquares, nCurSquare, nTemp") -- TRONGAME.scr:119
    ...
    if ctx:condition("nTemp==TRON_EMPTY") then -- TRONGAME.scr:121
        ...
        ctx:command("bspaceok", "= FALSE") -- TRONGAME.scr:126
...
script.labels["BogusMove"] = function(ctx)
    ...
    if ctx:condition("nMoveCount==TRON_WHITE") then -- TRONGAME.scr:144
        ctx:command("cprint", "Try again, Bot") -- TRONGAME.scr:145
        ...
        if ctx:condition("nMoveCount==TRON_BLACK") then -- TRONGAME.scr:151
            ctx:command("cprint", "Try again Player") -- TRONGAME.scr:152
...
script.labels["Move"] = function(ctx)
    ...
    ctx:command("nmovecount", "= nMoveCount + 1") -- TRONGAME.scr:163
    ctx:command("mod", "nMoveCount, 2") -- TRONGAME.scr:164
    ctx:command("cprint", "nCurSquare") -- TRONGAME.scr:165
    -- since Mod nMoveCount = 0 or 1 = black or white
    if ctx:condition("nMoveCount==TRON_WHITE") then -- TRONGAME.scr:167
        ctx:command("cprint", "Black's turn") -- TRONGAME.scr:168
        ctx:trigger("hPiece", "White") -- TRONGAME.scr:169
    else -- TRONGAME.scr:170
        ctx:command("cprint", "White's turn") -- TRONGAME.scr:171
        ctx:trigger("hPiece", "Black") -- TRONGAME.scr:172
    end -- TRONGAME.scr:173
    ctx:command("setflag", "hPiece, FLAG_VISIBLE") -- TRONGAME.scr:175
    ctx:command("arrayput", "npSquares, nCurSquare, nMoveCount") -- TRONGAME.scr:177
...
script.labels["CheckVictory"] = function(ctx)
    ...
    -- start off FALSE
    ctx:command("bcanmove", "= FALSE") -- TRONGAME.scr:191
    ctx:command("ncursquare", "= 0") -- TRONGAME.scr:193
    while ctx:condition("nCurSquare<LISTLAST") do -- TRONGAME.scr:194
        ctx:command("arrayget", "npSquares, nCurSquare, nTemp") -- TRONGAME.scr:195
        ...
        if ctx:condition("nTemp==TRON_EMPTY") then -- TRONGAME.scr:197
            ...
            if ctx:condition("bSpaceOk==TRUE") then -- TRONGAME.scr:200
                ...
                if ctx:condition("nMoveCount==TRON_WHITE") then -- TRONGAME.scr:203
                    ctx:command("cprint", "Bot's turn") -- TRONGAME.scr:204
        ...
        ctx:command("ncursquare", "= nCurSquare + 1") -- TRONGAME.scr:214
...
script.labels["CheckSurrounding"] = function(ctx)
    -- TRONGAME.scr:223
    ctx:command("bspaceok", "= FALSE") -- TRONGAME.scr:225
    ctx:command("ncounter", "= 0") -- TRONGAME.scr:227
    while ctx:condition("nCounter<8") do -- TRONGAME.scr:228
        ctx:command("arrayget", "npCheck, nCounter, nCheck") -- TRONGAME.scr:229
        ctx:command("ncheck", "= nCurSquare + nCheck") -- TRONGAME.scr:230
        ctx:command("bedge", "= FALSE") -- TRONGAME.scr:232
        ctx:command("ntemp", "= nCurSquare + 1") -- TRONGAME.scr:234
        ctx:command("mod", "nTemp, BOARDSIZE") -- TRONGAME.scr:235
        ...
        if ctx:condition("nTemp==0") then -- TRONGAME.scr:237
            if ctx:condition("nCounter<3") then -- TRONGAME.scr:238
                ctx:command("bedge", "= TRUE") -- TRONGAME.scr:239
            end -- TRONGAME.scr:240
        end -- TRONGAME.scr:241
        ctx:command("ntemp", "= nCurSquare") -- TRONGAME.scr:243
        ctx:command("mod", "nTemp, BOARDSIZE") -- TRONGAME.scr:244
...
script.labels["ResetBoard"] = function(ctx)
    ...
    ctx:command("bhasticket", "= FALSE") -- TRONGAME.scr:282
    ctx:command("nmovecount", "= 0") -- TRONGAME.scr:283
    mm9.gosub(script, ctx, "GetFirstObject") -- TRONGAME.scr:284
    while ctx:condition("LISTINDEX!=LISTLAST") do -- TRONGAME.scr:285
        ctx:command("clearflag", "LISTOBJECT, FLAG_VISIBLE") -- TRONGAME.scr:286
        ctx:command("arrayput", "npSquares, LISTINDEX, TRON_EMPTY") -- TRONGAME.scr:287
        mm9.gosub(script, ctx, "GetNextObject") -- TRONGAME.scr:288
    end -- TRONGAME.scr:289
    ctx:command("clearflag", "LISTOBJECT, FLAG_VISIBLE") -- TRONGAME.scr:291
    ctx:command("arrayput", "npSquares, LISTINDEX, TRON_EMPTY") -- TRONGAME.scr:292
    -- turn one of each color on at start
    ctx:command("getrandomint", "LISTFIRST, LISTLAST, LISTINDEX") -- TRONGAME.scr:295
    mm9.gosub(script, ctx, "GetCurrentObject") -- TRONGAME.scr:297
    ctx:command("setflag", "LISTOBJECT, FLAG_VISIBLE") -- TRONGAME.scr:298
    ctx:trigger("LISTOBJECT", "White") -- TRONGAME.scr:299
    ctx:command("arrayput", "npSquares, LISTINDEX, TRON_WHITE") -- TRONGAME.scr:300
    ctx:command("listindex", "= LISTLAST - LISTINDEX") -- TRONGAME.scr:301
    mm9.gosub(script, ctx, "GetCurrentObject") -- TRONGAME.scr:303
    ctx:command("setflag", "LISTOBJECT, FLAG_VISIBLE") -- TRONGAME.scr:304
    ctx:trigger("LISTOBJECT", "Black") -- TRONGAME.scr:305
    ctx:command("arrayput", "npSquares, LISTINDEX, TRON_BLACK") -- TRONGAME.scr:306
...
script.labels["SetupCheck"] = function(ctx)
    -- TRONGAME.scr:311
    -- positive side
    ctx:command("ntemp", "= 0 - BOARDSIZE + 1") -- TRONGAME.scr:314
    ctx:command("arrayput", "npCheck, 0, nTemp") -- TRONGAME.scr:315
    ctx:command("ntemp", "= 1") -- TRONGAME.scr:316
    ctx:command("arrayput", "npCheck, 1, nTemp") -- TRONGAME.scr:317
    ctx:command("ntemp", "= BOARDSIZE + 1") -- TRONGAME.scr:318
    ctx:command("arrayput", "npCheck, 2, nTemp") -- TRONGAME.scr:319
    -- up-down
    ctx:command("ntemp", "= 0 - BOARDSIZE") -- TRONGAME.scr:322
    ctx:command("arrayput", "npCheck, 3, nTemp") -- TRONGAME.scr:323
    ctx:command("ntemp", "= BOARDSIZE") -- TRONGAME.scr:324
    ctx:command("arrayput", "npCheck, 4, nTemp") -- TRONGAME.scr:325
    -- negative side
    ctx:command("ntemp", "= 0 - BOARDSIZE - 1") -- TRONGAME.scr:328
    ctx:command("arrayput", "npCheck, 5, nTemp") -- TRONGAME.scr:329
    ctx:command("ntemp", "= -1") -- TRONGAME.scr:330
    ctx:command("arrayput", "npCheck, 6, nTemp") -- TRONGAME.scr:331
    ctx:command("ntemp", "= BOARDSIZE - 1") -- TRONGAME.scr:332
    ctx:command("arrayput", "npCheck, 7, nTemp") -- TRONGAME.scr:333
