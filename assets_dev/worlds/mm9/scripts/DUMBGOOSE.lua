...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, 5, "InitDumbGoose") -- DUMBGOOSE.scr:13
    do return ctx:exit(1) end -- DUMBGOOSE.scr:15
end

script.labels["InitDumbGoose"] = function(ctx)
    -- DUMBGOOSE.scr:18
    ctx:state().g_nTemp = ctx:self():getStat("RunVel") -- DUMBGOOSE.scr:21
    ctx:self():setStat("RunVel", "g_nTemp") -- DUMBGOOSE.scr:22
    ctx:self():setStat("WalkVel", "g_nTemp") -- DUMBGOOSE.scr:23
...
script.labels["RunLoop"] = function(ctx)
    -- DUMBGOOSE.scr:34
    ctx:randomInt(-5000, 5000, "g_nTemp") -- DUMBGOOSE.scr:36
    ctx:self():runToPos("g_nTemp", "g_nTemp", "g_nTemp") -- DUMBGOOSE.scr:38
    ctx:wait(0, 2, "RunLoop") -- DUMBGOOSE.scr:41
