...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:self():setTarget(nil) -- 1000T_LIGHTNINGSHOOTER.scr:24
...
script.labels["StartShooting"] = function(ctx)
    ...
    ctx:self():setTarget(ctx:object("hMarker")) -- 1000T_LIGHTNINGSHOOTER.scr:32
...
script.labels["Main2"] = function(ctx)
    ...
    ctx:state().hMarker = ctx:objectOrNil("sMarker") -- 1000T_LIGHTNINGSHOOTER.scr:41
...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, 0.5, "Main2") -- 1000T_LIGHTNINGSHOOTER.scr:48
