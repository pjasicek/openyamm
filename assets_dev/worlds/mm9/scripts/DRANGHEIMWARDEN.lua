...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("arrayput", "spCellNames, 0, sCellName") -- DRANGHEIMWARDEN.scr:25
    ctx:getParam(1, "sCellName") -- DRANGHEIMWARDEN.scr:26
    ctx:command("arrayput", "spCellNames, 1, sCellName") -- DRANGHEIMWARDEN.scr:27
    ctx:getParam(2, "sCellName") -- DRANGHEIMWARDEN.scr:28
    ctx:command("arrayput", "spCellNames, 2, sCellName") -- DRANGHEIMWARDEN.scr:29
...
script.labels["CloseCell"] = function(ctx)
    ...
    ctx:command("playanim", "aware, DoNothing") -- DRANGHEIMWARDEN.scr:54
...
script.labels["ChangeCell"] = function(ctx)
    ...
    ctx:command("arrayget", "spCellNames, nCounter, sCellName") -- DRANGHEIMWARDEN.scr:64
    ctx:command("getobjecthandle", "sCellName, hCell") -- DRANGHEIMWARDEN.scr:65
    ctx:command("ncounter", "= nCounter + 1") -- DRANGHEIMWARDEN.scr:66
    ctx:command("mod", "nCounter, 3") -- DRANGHEIMWARDEN.scr:67
