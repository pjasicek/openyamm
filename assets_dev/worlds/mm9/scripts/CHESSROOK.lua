...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("onpoststartworld", "InitChessBase") -- CHESSROOK.scr:17
...
script.labels["CheckPath"] = function(ctx)
    ...
    -- check vertical
    ctx:command("listindex", "= xMe") -- CHESSROOK.scr:28
    while ctx:condition("LISTINDEX<=LISTLAST") do -- CHESSROOK.scr:29
        ...
        ctx:command("listindex", "= LISTINDEX + BOARDSIZE") -- CHESSROOK.scr:36
    end -- CHESSROOK.scr:37
    -- check horizontal
    ctx:command("listindex", "= nLocation - xMe") -- CHESSROOK.scr:40
    ctx:command("ntemp", "= LISTINDEX + BOARDSIZE") -- CHESSROOK.scr:41
    while ctx:condition("LISTINDEX<nTemp") do -- CHESSROOK.scr:42
        ...
        ctx:command("listindex", "= LISTINDEX + 1") -- CHESSROOK.scr:49
