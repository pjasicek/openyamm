...
script.labels["PlayAnim"] = function(ctx)
    -- PROPANIM.scr:25
    ctx:self():loopAnimation("Params", 0, "DoNothing") -- PROPANIM.scr:29
    -- exitScript
...
script.labels["Init"] = function(ctx)
    ...
    if ctx:condition("bLoop=NULL") then -- PROPANIM.scr:37
        ctx:state().bLoop = false -- PROPANIM.scr:38
    end -- PROPANIM.scr:39
...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:condition("g_nCounter==0") then -- PROPANIM.scr:54
        ctx:self():playAnimation("sParameter2", "DoNothing") -- PROPANIM.scr:55
        if ctx:condition("bLoop=FALSE") then -- PROPANIM.scr:56
            ctx:state().g_nCounter = 1 -- PROPANIM.scr:57
        end -- PROPANIM.scr:58
    end -- PROPANIM.scr:59
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "Init") -- PROPANIM.scr:74
