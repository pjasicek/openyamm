...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "InitHonkFollowGoose") -- HONKFOLLOWGOOSE2.scr:26
...
script.labels["TurnHostilityOn"] = function(ctx)
    ...
    ctx:state().g_ntemp = 10 -- HONKFOLLOWGOOSE2.scr:42
    ctx:self():setStat("HitPoints", "g_ntemp") -- HONKFOLLOWGOOSE2.scr:43
    ctx:state().g_ntemp = 1 -- HONKFOLLOWGOOSE2.scr:44
    ctx:state().g_ntemp = ctx:self():getStat("AC") -- HONKFOLLOWGOOSE2.scr:45
...
script.labels["InitHonkFollowGoose"] = function(ctx)
    ...
    ctx:cacheSound("sounds\\ambient\\crowd01.wav") -- HONKFOLLOWGOOSE2.scr:63
    ctx:onEvent("OnTargetDead", "OnTargetDead") -- HONKFOLLOWGOOSE2.scr:64
    ctx:state().hGoose = ctx:objectOrNil("sGooseName") -- HONKFOLLOWGOOSE2.scr:66
    if ctx:condition("hGoose==0") then -- HONKFOLLOWGOOSE2.scr:68
        ctx:wait(0, 1, "InitHonkFollowGoose") -- HONKFOLLOWGOOSE2.scr:69
    else -- HONKFOLLOWGOOSE2.scr:70
        ctx:self():setTarget(ctx:object("hGoose")) -- HONKFOLLOWGOOSE2.scr:71
...
script.labels["FollowLoop"] = function(ctx)
    ...
    if ctx:condition("hGoose!=0") then -- HONKFOLLOWGOOSE2.scr:82
        ctx:self():runTo(ctx:object("hGoose"), 64, "CrazyRun") -- HONKFOLLOWGOOSE2.scr:83
...
script.labels["CrazyRun"] = function(ctx)
    ...
    ctx:playSound("sounds\\animsounds\\goose\\wince1.wav", "DoNothing", 1, 100, "FALSE", 100) -- HONKFOLLOWGOOSE2.scr:91
    ctx:randomInt(-5000, 5000, "diff") -- HONKFOLLOWGOOSE2.scr:92
    ctx:self():runToPos("diff", "diff", "diff", 0, "DoNothing") -- HONKFOLLOWGOOSE2.scr:93
    ctx:wait(1, 2, "FollowLoop") -- HONKFOLLOWGOOSE2.scr:94
...
script.labels["OnTargetDead"] = function(ctx)
    ...
    ctx:self():stop() -- HONKFOLLOWGOOSE2.scr:102
    ctx:state().hGoose = nil -- HONKFOLLOWGOOSE2.scr:103
    ctx:self():addEnemy("Player") -- HONKFOLLOWGOOSE2.scr:105
