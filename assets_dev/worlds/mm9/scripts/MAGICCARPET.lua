...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("onpoststartworld", "InitMagicCarpet") -- MAGICCARPET.scr:29
    ctx:command("onpostminisaveload", "InitMagicCarpet") -- MAGICCARPET.scr:30
...
script.labels["StartRising"] = function(ctx)
    -- MAGICCARPET.scr:50
    ctx:command("removetrigger", "Use") -- MAGICCARPET.scr:52
    ctx:command("nvel", "= 800") -- MAGICCARPET.scr:53
    ctx:command("nvely", "= 500") -- MAGICCARPET.scr:54
...
script.labels["CheckPOS"] = function(ctx)
    -- MAGICCARPET.scr:82
    ctx:command("getpos", "hMe, xNow, yNow, zNow") -- MAGICCARPET.scr:84
    ...
    ctx:command("calcdist", "xNow,yNow,zNow, xPrev,yPrev,zPrev, dist") -- MAGICCARPET.scr:90
    ...
    -- make prev = now
    ctx:command("vecscale", "xPrev,yPrev,zPrev, 0") -- MAGICCARPET.scr:96
    ctx:command("vecadd", "xPrev,yPrev,zPrev, xNow,yNow,zNow") -- MAGICCARPET.scr:97
    do return ctx:exit("TRUE") end -- MAGICCARPET.scr:99
end

script.labels["ResetLift"] = function(ctx)
    -- MAGICCARPET.scr:102
    ctx:command("playsound", "sounds\\default.wav, DoNothing, 1, 500, FALSE, 100") -- MAGICCARPET.scr:104
    ctx:command("nvely", "= -4096") -- MAGICCARPET.scr:105
    ctx:command("nvel", "= 0") -- MAGICCARPET.scr:106
