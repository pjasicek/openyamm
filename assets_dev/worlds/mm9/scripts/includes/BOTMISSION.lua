...
script.labels["BotMissPause"] = function(ctx)
    ...
    -- an enemy...)
    ctx:wait("MISSION_WAIT", 0, "DoNothing") -- BOTMISSION.inc:42
...
script.labels["BotMissResume"] = function(ctx)
    ...
    ctx:wait("MISSION_WAIT", 0.5, "BotMissTick") -- BOTMISSION.inc:53
...
script.labels["RescuePrincess"] = function(ctx)
    ...
    ctx:state().g_hPrincess = ctx:objectOrNil("Princess0") -- BOTMISSION.inc:64
    ctx:state().g_hRescueZone = ctx:objectOrNil("RescueZone0") -- BOTMISSION.inc:65
    if ctx:condition("g_hPrincess==NULL") then -- BOTMISSION.inc:67
        ctx:debugOut("No", "princess", "to", "rescue!!") -- BOTMISSION.inc:68
        do return ctx:exit("") end -- BOTMISSION.inc:69
    end -- BOTMISSION.inc:70
    if ctx:condition("g_hRescueZone==NULL") then -- BOTMISSION.inc:72
        ctx:debugOut("No", "rescue", "zone", "for", "princess!!") -- BOTMISSION.inc:73
        do return ctx:exit("") end -- BOTMISSION.inc:74
    end -- BOTMISSION.inc:75
    ctx:set("g_mission", "GT_RESCUE_PRINCESS") -- BOTMISSION.inc:77
...
script.labels["ReallyAtRescueZone"] = function(ctx)
    ...
    ctx:self():stop() -- BOTMISSION.inc:105
    ctx:self():walk() -- BOTMISSION.inc:106
    ctx:wait("MISSION_WAIT", 0.5, "ReallyAtRescueZone2") -- BOTMISSION.inc:107
...
script.labels["AtRescueZone"] = function(ctx)
    ...
    -- Now go in...
    ctx:state().g_posX, ctx:state().g_posY, ctx:state().g_posZ = ctx:self():pos() -- BOTMISSION.inc:119
    ctx:state().g_posX, ctx:state().g_nTemp, ctx:state().g_posZ = ctx:object("g_hRescueZone"):pos() -- BOTMISSION.inc:120
    ctx:self():runToPos("g_posX", "g_posY", "g_posZ", 12, "ReallyAtRescueZone") -- BOTMISSION.inc:122
...
script.labels["HavePrincessTick"] = function(ctx)
    ...
    ctx:self():runTo(ctx:object("g_hRescueZone"), 0, "AtRescueZone") -- BOTMISSION.inc:134
...
script.labels["FoundPrincess"] = function(ctx)
    ...
    ctx:state().g_bHavePrincess = true -- BOTMISSION.inc:144
...
script.labels["FindPrincessTick"] = function(ctx)
    ...
    ctx:self():runTo(ctx:object("g_hPrincess"), 36, "FoundPrincess") -- BOTMISSION.inc:156
...
script.labels["BotMissTick"] = function(ctx)
    ...
    ctx:wait("MISSION_WAIT", 0.5, "BotMissTick") -- BOTMISSION.inc:173
...
script.labels["PrincessLost"] = function(ctx)
    ...
    ctx:state().g_bHavePrincess = false -- BOTMISSION.inc:183
...
script.labels["Celebrate"] = function(ctx)
    ...
    if ctx:condition("g_nTemp==0") then -- BOTMISSION.inc:193
        ctx:state().g_nTemp = 1 -- BOTMISSION.inc:194
    else -- BOTMISSION.inc:195
        ctx:state().g_nTemp = 0 -- BOTMISSION.inc:196
    end -- BOTMISSION.inc:197
    ctx:self():setCrouch("g_nTemp") -- BOTMISSION.inc:199
    ctx:wait(8, 0.5, "Celebrate") -- BOTMISSION.inc:201
...
script.labels["PrincessRescued"] = function(ctx)
    ...
    ctx:self():stop() -- BOTMISSION.inc:213
    ctx:wait("MISSION_WAIT", 0, "DoNothing") -- BOTMISSION.inc:214
