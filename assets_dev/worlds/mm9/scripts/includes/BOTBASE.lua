...
script.labels["BB_AttackTarget"] = function(ctx)
    ...
    ctx:set("g_hObject", "g_hTarget") -- BOTBASE.inc:27
    ctx:state().g_hTarget = ctx:self():target() -- BOTBASE.inc:28
    if ctx:condition("g_hTarget==NULL") then -- BOTBASE.inc:30
        if ctx:condition("g_hObject!=NULL") then -- BOTBASE.inc:31
            ctx:breakpoint() -- BOTBASE.inc:32
        end -- BOTBASE.inc:33
        do return ctx:exit("FALSE") end -- BOTBASE.inc:34
    end -- BOTBASE.inc:35
    ctx:state().g_bAttacking = ctx:self():isAttacking() -- BOTBASE.inc:37
    if ctx:condition("g_bAttacking==TRUE") then -- BOTBASE.inc:39
        do return ctx:exit("FALSE") end -- BOTBASE.inc:40
    end -- BOTBASE.inc:41
    ctx:state().g_bInAttackRange = ctx:self():isTargetInRange() -- BOTBASE.inc:43
    ctx:state().g_bCanAttack = ctx:self():canAttack() -- BOTBASE.inc:44
...
script.labels["BB_OnDamage"] = function(ctx)
    ...
    ctx:self():faceObject(ctx:object("g_hAttacker")) -- BOTBASE.inc:61
...
script.labels["BB_OnProjectile"] = function(ctx)
    ...
    if ctx:condition("g_hTarget==NULL") then -- BOTBASE.inc:74
        ...
        ctx:self():setTarget(ctx:object("g_hTarget")) -- BOTBASE.inc:76
...
script.labels["BB_AttackTick"] = function(ctx)
    ...
    ctx:self():attack("BB_AttackDone") -- BOTBASE.inc:108
    ctx:state().attackCount = (tonumber(ctx:state().attackCount) or 0) + 1 -- BOTBASE.inc:110
    if ctx:condition("attackCount < 5") then -- BOTBASE.inc:112
        ctx:set("attackTime", 0.5) -- BOTBASE.inc:113
    else -- BOTBASE.inc:114
        ctx:set("attackTime", 0.8) -- BOTBASE.inc:115
        ctx:state().attackCount = 0 -- BOTBASE.inc:116
    end -- BOTBASE.inc:117
    ctx:wait("ATTACK_WAIT", "attackTime", "BB_AttackTick") -- BOTBASE.inc:119
...
script.labels["BB_FoundTarget"] = function(ctx)
    ...
    ctx:self():setTarget(ctx:object("g_hTarget")) -- BOTBASE.inc:142
...
script.labels["BB_CancelAttack"] = function(ctx)
    ...
    ctx:wait("ATTACK_WAIT", 0, "DoNothing") -- BOTBASE.inc:164
...
script.labels["BB_ClearTarget"] = function(ctx)
    ...
    ctx:self():stop() -- BOTBASE.inc:175
    ctx:self():setTarget(nil) -- BOTBASE.inc:176
    ctx:state().g_hTarget = nil -- BOTBASE.inc:177
...
script.labels["BB_MaybeSwitchTarget"] = function(ctx)
    ...
    if ctx:condition("hLastAttacker!=g_hTarget") then -- BOTBASE.inc:197
        ctx:set("g_hTarget", "hLastAttacker") -- BOTBASE.inc:198
        ctx:self():setTarget(ctx:object("g_hTarget")) -- BOTBASE.inc:199
...
script.labels["BotBaseInit"] = function(ctx)
    ...
    ctx:onEvent("OnFoundTarget", "BB_FoundTarget") -- BOTBASE.inc:222
    ctx:onEvent("OnLostTarget", "BB_LostTarget") -- BOTBASE.inc:223
    ctx:onEvent("OnTargetDead", "BB_TargetDead") -- BOTBASE.inc:224
    ctx:onEvent("OnDamage", "BB_OnDamage") -- BOTBASE.inc:225
    ctx:onEvent("OnProjectile", "BB_OnProjectile") -- BOTBASE.inc:227
    ctx:state().g_hTarget = ctx:self():target() -- BOTBASE.inc:230
