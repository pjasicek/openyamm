...
script.labels["InitCheckPass"] = function(ctx)
    ...
    ctx:onEvent("OnFoundTarget", "OnFoundTarget") -- DP_CHECKPASS.inc:28
    ctx:onEvent("OnDamage", "OnDamage") -- DP_CHECKPASS.inc:29
...
script.labels["OnFoundTarget"] = function(ctx)
    ...
    ctx:state().checkpass_bIsPlayer = ctx:object("checkpass_hObject"):isPlayer() -- DP_CHECKPASS.inc:38
    ...
    ctx:set("checkpass_bIsFriendly", "1 - checkpass_bIsFriendly") -- DP_CHECKPASS.inc:46
    -- == 0 if notplayer OR notvisitor OR notfriendly
    ctx:set("checkpass_bAttackOk", "checkpass_bIsPlayer * checkpass_bIsVisitor * checkpass_bIsFriendly") -- DP_CHECKPASS.inc:49
    -- if == 0, attack
...
script.labels["OnDamage"] = function(ctx)
    ...
    ctx:state().checkpass_bIsPlayer = ctx:object("checkpass_hObject"):isPlayer() -- DP_CHECKPASS.inc:63
    ...
    -- change to IsFriendly with IsFriendly=!IsHostile
    ctx:set("checkpass_bIsFriendly", "1 - checkpass_bIsFriendly") -- DP_CHECKPASS.inc:77
    -- == 0 if notplayer OR notvisitor OR notfriendly
    ctx:set("checkpass_bAttackOk", "checkpass_bIsPlayer * checkpass_bIsVisitor * checkpass_bIsFriendly") -- DP_CHECKPASS.inc:80
    -- if == 0, attack
