...
script.labels["OnAward"] = function(ctx)
    ...
    if ctx:condition("g_ntemp==0") then -- MOUNTAINPASS.scr:21
        ...
        if ctx:condition("keycheck==1") then -- MOUNTAINPASS.scr:24
            ...
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 24000, "FALSE", 100) -- MOUNTAINPASS.scr:28
    ...
    if ctx:condition("keycheck==0") then -- MOUNTAINPASS.scr:34
        ...
        ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- MOUNTAINPASS.scr:38
...
script.labels["OnStep"] = function(ctx)
    -- MOUNTAINPASS.scr:45
    ctx:set("g_ncounter", "g_ncounter + 1") -- MOUNTAINPASS.scr:48
...
script.labels["Main"] = function(ctx)
    ...
    ctx:state().g_ncounter = 0 -- MOUNTAINPASS.scr:62
