...
script.labels["OnSpawn"] = function(ctx)
    -- ENDCOUNT.scr:31
    ctx:set("nSpawnCount", "nSpawnCount + 1") -- ENDCOUNT.scr:34
...
script.labels["SpawnDemon"] = function(ctx)
    -- ENDCOUNT.scr:44
    ctx:state().XPos, ctx:state().YPos, ctx:state().ZPos = ctx:object("sSpawnMarker"):pos() -- ENDCOUNT.scr:48-49
    ctx:state().hDemon = ctx:spawn("Xpos", "YPos", "ZPos", "sDemon") -- ENDCOUNT.scr:51
...
script.labels["Main"] = function(ctx)
    -- ENDCOUNT.scr:56
    -- TraceOn
    ctx:set("sDemon", "sDemon + SCRIPT") -- ENDCOUNT.scr:62
