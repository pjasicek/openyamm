...
script.labels["OnUse"] = function(ctx)
    -- SPIKEDOORA.scr:17
    ctx:state().hMyDoor = ctx:self() -- SPIKEDOORA.scr:19
...
script.labels["OnePulled"] = function(ctx)
    -- SPIKEDOORA.scr:26
    ctx:set("count", "count + 1") -- SPIKEDOORA.scr:28
...
script.labels["Main2"] = function(ctx)
    -- SPIKEDOORA.scr:35
    ctx:state().hMyDoor = ctx:objectOrNil("sDoor") -- SPIKEDOORA.scr:37
...
script.labels["main"] = function(ctx)
    ...
    ctx:wait(0, 0.4, "Main2") -- SPIKEDOORA.scr:44
