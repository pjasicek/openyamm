...
script.labels["OnAgree"] = function(ctx)
    -- ARG_SVEN.scr:12
    ctx:command("playanim", "Agree Init") -- ARG_SVEN.scr:14
    do return ctx:exit("") end -- ARG_SVEN.scr:15
end

script.labels["OnApplause"] = function(ctx)
    -- ARG_SVEN.scr:18
    ctx:command("playanim", "Applause Init") -- ARG_SVEN.scr:21
    do return ctx:exit("") end -- ARG_SVEN.scr:22
end

script.labels["Init"] = function(ctx)
    -- ARG_SVEN.scr:24
    ctx:command("loopanim", "Sitting 0 DoNothing") -- ARG_SVEN.scr:27
    do return ctx:exit("") end -- ARG_SVEN.scr:28
end

script.labels["Onclap"] = function(ctx)
    -- ARG_SVEN.scr:31
    ctx:command("getrandomint", "1, 7 g_ntemp") -- ARG_SVEN.scr:33
    if ctx:condition("g_ntemp==1") then -- ARG_SVEN.scr:35
        ctx:command("playsound", "\\sounds\\events\\clap01.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:36
        do return ctx:exit("") end -- ARG_SVEN.scr:37
    end -- ARG_SVEN.scr:38
    if ctx:condition("g_ntemp==2") then -- ARG_SVEN.scr:40
        ctx:command("playsound", "\\sounds\\events\\clap02.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:41
        do return ctx:exit("") end -- ARG_SVEN.scr:42
    end -- ARG_SVEN.scr:43
    if ctx:condition("g_ntemp==3") then -- ARG_SVEN.scr:45
        ctx:command("playsound", "\\sounds\\events\\clap03.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:46
        do return ctx:exit("") end -- ARG_SVEN.scr:47
    end -- ARG_SVEN.scr:48
    if ctx:condition("g_ntemp==4") then -- ARG_SVEN.scr:50
        ctx:command("playsound", "\\sounds\\events\\clap04.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:51
        do return ctx:exit("") end -- ARG_SVEN.scr:52
    end -- ARG_SVEN.scr:53
    if ctx:condition("g_ntemp==5") then -- ARG_SVEN.scr:55
        ctx:command("playsound", "\\sounds\\events\\clap05.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:56
        do return ctx:exit("") end -- ARG_SVEN.scr:57
    end -- ARG_SVEN.scr:58
    if ctx:condition("g_ntemp==6") then -- ARG_SVEN.scr:60
        ctx:command("playsound", "\\sounds\\events\\clap06.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:61
        do return ctx:exit("") end -- ARG_SVEN.scr:62
    end -- ARG_SVEN.scr:63
    if ctx:condition("g_ntemp==7") then -- ARG_SVEN.scr:65
        ctx:command("playsound", "\\sounds\\events\\clap07.wav, DoNothing, 100, 24000, FALSE, 100") -- ARG_SVEN.scr:66
...
script.labels["Main"] = function(ctx)
    -- ARG_SVEN.scr:73
    -- TraceOn ;delete me!!
    ctx:command("onpoststartworld", "Init") -- ARG_SVEN.scr:77
    ctx:command("onpostminisaveload", "Init") -- ARG_SVEN.scr:78
    ctx:command("onpostsaveload", "Init") -- ARG_SVEN.scr:79
    ctx:command("wait", "1 .1 Init") -- ARG_SVEN.scr:80
    ctx:addTrigger("Clap", "OnApplause") -- ARG_SVEN.scr:81
    ctx:command("addmodelkey", "Clap OnClap") -- ARG_SVEN.scr:82
