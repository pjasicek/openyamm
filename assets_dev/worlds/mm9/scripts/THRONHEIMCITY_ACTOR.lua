...
script.labels["RunNormalScript"] = function(ctx)
    ...
    ctx:command("stop", "") -- THRONHEIMCITY_ACTOR.scr:20
    ctx:command("setstat", "g_hMyObject,WalkRunMode,WALKRUNMODE_FORWARD") -- THRONHEIMCITY_ACTOR.scr:22
    ctx:command("getstatstr", "g_hMyObject,ScriptName,g_sTemp") -- THRONHEIMCITY_ACTOR.scr:23
    ctx:command("runscript", "g_sTemp") -- THRONHEIMCITY_ACTOR.scr:24
    do return ctx:exit("") end -- THRONHEIMCITY_ACTOR.scr:26
end

script.labels["ShmoeDamage"] = function(ctx)
    -- THRONHEIMCITY_ACTOR.scr:29
    ctx:command("die", "") -- THRONHEIMCITY_ACTOR.scr:31
    ctx:command("getfacedir", "g_hMyObject,g_dirX,g_dirY,g_dirZ") -- THRONHEIMCITY_ACTOR.scr:33
    ctx:command("vecscale", "g_dirX,g_dirY,g_dirZ,-1") -- THRONHEIMCITY_ACTOR.scr:34
    ctx:command("g_diry", "= 0.45") -- THRONHEIMCITY_ACTOR.scr:35
    ctx:command("setpushback", "g_dirX,g_dirY,g_dirZ,1") -- THRONHEIMCITY_ACTOR.scr:36
...
script.labels["OnHereComesBadAssShmoe"] = function(ctx)
    ...
    ctx:command("stop", "") -- THRONHEIMCITY_ACTOR.scr:45
    ctx:getParam(0, "g_hObject") -- THRONHEIMCITY_ACTOR.scr:47
    ctx:command("target", "g_hObject,TRUE") -- THRONHEIMCITY_ACTOR.scr:48
...
script.labels["RunAwayFromBadAss"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "BadAss, g_hObject") -- THRONHEIMCITY_ACTOR.scr:98
    ...
    ctx:command("g_hrunawaytrigger", "= g_hObject") -- THRONHEIMCITY_ACTOR.scr:104
    ctx:command("g_htarget", "= g_hObject") -- THRONHEIMCITY_ACTOR.scr:105
    ctx:command("getobjecthandle", "Guard1,g_hObject") -- THRONHEIMCITY_ACTOR.scr:107
    ctx:command("target", "g_hTarget, FALSE") -- THRONHEIMCITY_ACTOR.scr:109
    ctx:command("runto", "g_hObject,0,BenAtGuard") -- THRONHEIMCITY_ACTOR.scr:111
    ctx:command("wait", "0, 1, YellForHelp") -- THRONHEIMCITY_ACTOR.scr:112
    do return ctx:exit("") end -- THRONHEIMCITY_ACTOR.scr:114
end

script.labels["BenAtMarker"] = function(ctx)
    -- THRONHEIMCITY_ACTOR.scr:117
    ctx:command("stop", "") -- THRONHEIMCITY_ACTOR.scr:119
    ctx:command("setstat", "g_hMyObject,WalkRunMode,WALKRUNMODE_FORWARD") -- THRONHEIMCITY_ACTOR.scr:121
...
script.labels["OnHereComesBadAssBen"] = function(ctx)
    ...
    ctx:command("stop", "") -- THRONHEIMCITY_ACTOR.scr:132
    ctx:getParam(0, "g_hObject") -- THRONHEIMCITY_ACTOR.scr:134
    ctx:command("target", "g_hObject,TRUE") -- THRONHEIMCITY_ACTOR.scr:135
    ctx:command("setstat", "g_hMyObject,WalkRunMode,WALKRUNMODE_TARGET") -- THRONHEIMCITY_ACTOR.scr:137
    ctx:command("getobjecthandle", "BenMarker,g_hObject") -- THRONHEIMCITY_ACTOR.scr:139
    ctx:command("runto", "g_hObject,0,BenAtMarker") -- THRONHEIMCITY_ACTOR.scr:141
...
script.labels["SetupBen"] = function(ctx)
    ...
    ctx:command("removetrigger", "RunAwayFromMe") -- THRONHEIMCITY_ACTOR.scr:152
    ...
    ctx:command("g_bsocializeenabled", "= FALSE") -- THRONHEIMCITY_ACTOR.scr:156
    do return ctx:exit("") end -- THRONHEIMCITY_ACTOR.scr:158
end

script.labels["Main"] = function(ctx)
    -- THRONHEIMCITY_ACTOR.scr:162
    ctx:command("getmyhandle", "g_hMyObject") -- THRONHEIMCITY_ACTOR.scr:164
    ctx:command("getobjectname", "g_hMyObject,sMyName") -- THRONHEIMCITY_ACTOR.scr:166
