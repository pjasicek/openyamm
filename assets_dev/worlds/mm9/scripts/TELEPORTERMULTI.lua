...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnTouchNotify", "OnTouchNotify") -- TELEPORTERMULTI.scr:23
...
script.labels["UpdateDestination"] = function(ctx)
    ...
    ctx:self():setStringProperty("TeleportDestination", "DESTINATION_NAME") -- TELEPORTERMULTI.scr:31
...
script.labels["OnTouchNotify"] = function(ctx)
    ...
    ctx:state().bIsPlayer = ctx:object("hContact"):isPlayer() -- TELEPORTERMULTI.scr:39
    if ctx:condition("bIsPlayer==1") then -- TELEPORTERMULTI.scr:40
        ctx:wait(0, .5, "ResetDestination") -- TELEPORTERMULTI.scr:41
