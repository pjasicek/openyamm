...
script.labels["CreateMarker"] = function(ctx)
    ...
    if ctx:condition("goto_location == Work") then -- MM_STURMFORDCITY.scr:95
        ctx:command("goto_marker", "= marker_work + npc_id") -- MM_STURMFORDCITY.scr:96
    end -- MM_STURMFORDCITY.scr:97
    if ctx:condition("goto_location == Home") then -- MM_STURMFORDCITY.scr:99
        ctx:command("goto_marker", "= marker_home + npc_id") -- MM_STURMFORDCITY.scr:100
    end -- MM_STURMFORDCITY.scr:101
    if ctx:condition("goto_location == Misc") then -- MM_STURMFORDCITY.scr:103
        ctx:command("goto_marker", "= marker_misc + npc_id") -- MM_STURMFORDCITY.scr:104
...
script.labels["GoToLocation"] = function(ctx)
    ...
    ctx:command("setstat", "npc_object, PARAM, goto_marker") -- MM_STURMFORDCITY.scr:115
...
script.labels["LaunchGroup"] = function(ctx)
    ...
    while ctx:condition("index < 10") do -- MM_STURMFORDCITY.scr:133
        ...
        ctx:command("index", "= index + 1") -- MM_STURMFORDCITY.scr:158
...
script.labels["Group1_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_STURMFORDCITY.scr:172
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:173
...
script.labels["Group1_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_STURMFORDCITY.scr:183
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:184
...
script.labels["Group1_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_STURMFORDCITY.scr:194
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:195
...
script.labels["Group1_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_STURMFORDCITY.scr:205
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:206
...
script.labels["Group1_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_STURMFORDCITY.scr:216
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:217
...
script.labels["Group1_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group1") -- MM_STURMFORDCITY.scr:227
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:228
...
script.labels["Group2_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_STURMFORDCITY.scr:239
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:240
...
script.labels["Group2_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_STURMFORDCITY.scr:250
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:251
...
script.labels["Group2_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_STURMFORDCITY.scr:261
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:262
...
script.labels["Group2_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_STURMFORDCITY.scr:272
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:273
...
script.labels["Group2_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_STURMFORDCITY.scr:283
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:284
...
script.labels["Group2_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group2") -- MM_STURMFORDCITY.scr:294
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:295
...
script.labels["Group3_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_STURMFORDCITY.scr:305
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:306
...
script.labels["Group3_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_STURMFORDCITY.scr:316
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:317
...
script.labels["Group3_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_STURMFORDCITY.scr:327
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:328
...
script.labels["Group3_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_STURMFORDCITY.scr:338
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:339
...
script.labels["Group3_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_STURMFORDCITY.scr:349
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:350
...
script.labels["Group3_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group3") -- MM_STURMFORDCITY.scr:360
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:361
...
script.labels["Group4_GoWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_STURMFORDCITY.scr:371
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:372
...
script.labels["Group4_WarpWork"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_STURMFORDCITY.scr:382
    ctx:command("goto_location", "= Work") -- MM_STURMFORDCITY.scr:383
...
script.labels["Group4_GoHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_STURMFORDCITY.scr:394
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:395
...
script.labels["Group4_WarpHome"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_STURMFORDCITY.scr:405
    ctx:command("goto_location", "= Home") -- MM_STURMFORDCITY.scr:406
...
script.labels["Group4_GoMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_STURMFORDCITY.scr:416
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:417
...
script.labels["Group4_WarpMisc"] = function(ctx)
    ...
    ctx:command("current_group", "= Group4") -- MM_STURMFORDCITY.scr:427
    ctx:command("goto_location", "= Misc") -- MM_STURMFORDCITY.scr:428
...
script.labels["InitWorkSchedule"] = function(ctx)
    ...
    ctx:command("@m", "6 : 15 Group1_GoWork Group1_WarpWork") -- MM_STURMFORDCITY.scr:442
    ctx:command("@m", "6 : 30 Group2_GoWork Group2_WarpWork") -- MM_STURMFORDCITY.scr:443
    ctx:command("@m", "6 : 45 Group3_GoWork Group3_WarpWork") -- MM_STURMFORDCITY.scr:444
    ctx:command("@m", "7 : 00 Group4_GoWork Group4_WarpWork") -- MM_STURMFORDCITY.scr:445
    do return ctx:exit("") end -- MM_STURMFORDCITY.scr:447
end

script.labels["InitHomeSchedule"] = function(ctx)
    -- MM_STURMFORDCITY.scr:451
    ctx:command("@m", "18 : 00 Group1_GoHome Group1_WarpHome") -- MM_STURMFORDCITY.scr:454
    ctx:command("@m", "18 : 15 Group2_GoHome Group2_WarpHome") -- MM_STURMFORDCITY.scr:455
    ctx:command("@m", "18 : 30 Group3_GoHome Group3_WarpHome") -- MM_STURMFORDCITY.scr:456
    ctx:command("@m", "18 : 45 Group4_GoHome Group4_WarpHome") -- MM_STURMFORDCITY.scr:457
...
script.labels["InitMiscSchedule"] = function(ctx)
    ...
    ctx:command("@m", "13 : 00 Group1_GoMisc Group1_WarpMisc") -- MM_STURMFORDCITY.scr:466
    ctx:command("@m", "13 : 15 Group2_GoMisc Group2_WarpMisc") -- MM_STURMFORDCITY.scr:467
    ctx:command("@m", "13 : 30 Group3_GoMisc Group3_WarpMisc") -- MM_STURMFORDCITY.scr:468
    ctx:command("@m", "13 : 45 Group4_GoMisc Group4_WarpMisc") -- MM_STURMFORDCITY.scr:469
    -- Go Back to work
    ctx:command("@m", "15 : 00 Group1_GoWork Group1_WarpWork") -- MM_STURMFORDCITY.scr:472
    ctx:command("@m", "15 : 15 Group2_GoWork Group2_WarpWork") -- MM_STURMFORDCITY.scr:473
    ctx:command("@m", "15 : 30 Group3_GoWork Group3_WarpWork") -- MM_STURMFORDCITY.scr:474
    ctx:command("@m", "15 : 45 Group4_GoWork Group4_WarpWork") -- MM_STURMFORDCITY.scr:475
    do return ctx:exit("") end -- MM_STURMFORDCITY.scr:477
end

script.labels["InitArrays"] = function(ctx)
    -- MM_STURMFORDCITY.scr:485
    ctx:command("index", "= 0") -- MM_STURMFORDCITY.scr:488
    while ctx:condition("index < 10") do -- MM_STURMFORDCITY.scr:489
        ctx:command("arrayput", "aGroup1, index , 0") -- MM_STURMFORDCITY.scr:490
        ctx:command("arrayput", "aGroup2, index , 0") -- MM_STURMFORDCITY.scr:491
        ctx:command("arrayput", "aGroup3, index , 0") -- MM_STURMFORDCITY.scr:492
        ctx:command("arrayput", "aGroup4, index , 0") -- MM_STURMFORDCITY.scr:493
        ctx:command("index", "= index + 1") -- MM_STURMFORDCITY.scr:494
...
script.labels["LoadGroup1"] = function(ctx)
    ...
    -- Gormla A'Feslo				( 68 )
    ctx:command("arrayput", "aGroup1,0,68") -- MM_STURMFORDCITY.scr:505
    -- Thorfinn Tjorvissen			( 72 )
    ctx:command("arrayput", "aGroup1,1,72") -- MM_STURMFORDCITY.scr:508
    -- Katrina Vianni				( 80 )
    ctx:command("arrayput", "aGroup1,2,80") -- MM_STURMFORDCITY.scr:511
    -- Eskil Tryygvassen			( 389 )
    ctx:command("arrayput", "aGroup1,3,389") -- MM_STURMFORDCITY.scr:514
    -- Olrun Fjalldotir			( 393 )
    ctx:command("arrayput", "aGroup1,4,393") -- MM_STURMFORDCITY.scr:517
    -- Yoltzin Oord				( 73 ) <<< REMOVED >>>
...
script.labels["LoadGroup2"] = function(ctx)
    ...
    -- Annabel A'Lyrae				( 69 )
    ctx:command("arrayput", "aGroup2,0,69") -- MM_STURMFORDCITY.scr:530
    -- Fearghus A'Feslo			( 81 )
    ctx:command("arrayput", "aGroup2,1,81") -- MM_STURMFORDCITY.scr:533
    -- Hafgrim Shorthands			( 78 )
    ctx:command("arrayput", "aGroup2,2,78") -- MM_STURMFORDCITY.scr:536
    -- Adotette Haji				( 390 )
    ctx:command("arrayput", "aGroup2,3,390") -- MM_STURMFORDCITY.scr:539
    -- Leppa the Shy				( 79 )
    ctx:command("arrayput", "aGroup2,4,79") -- MM_STURMFORDCITY.scr:542
    -- Yoltzin Oord				( 73 ) <<< REMOVED >>>
    -- ArrayPut aGroup1,5,73
...
script.labels["LoadGroup3"] = function(ctx)
    ...
    -- Eimhir A'Mor				( 70 )
    ctx:command("arrayput", "aGroup3,0,70") -- MM_STURMFORDCITY.scr:555
    -- Tynan A'Lyrae				( 82 )
    ctx:command("arrayput", "aGroup3,1,82") -- MM_STURMFORDCITY.scr:558
    -- Mirjam Thjordotir			( 77 )
    ctx:command("arrayput", "aGroup3,2,77") -- MM_STURMFORDCITY.scr:561
    -- Hildr Fjalldotir			( 391 )
    ctx:command("arrayput", "aGroup3,3,391") -- MM_STURMFORDCITY.scr:564
    -- Mazat Oord					( 75 ) <<< REMOVED >>>
...
script.labels["LoadGroup4"] = function(ctx)
    ...
    -- Cinaed A'Velsi				( 71 )
    ctx:command("arrayput", "aGroup4,0,71") -- MM_STURMFORDCITY.scr:576
    -- Halfdan Doorsbane			( 76 )
    ctx:command("arrayput", "aGroup4,1,76") -- MM_STURMFORDCITY.scr:579
    -- Tearlach A'Lyrae			( 83 )
    ctx:command("arrayput", "aGroup4,2,83") -- MM_STURMFORDCITY.scr:582
    -- Lili A'Ghrie				( 84 )
    ctx:command("arrayput", "aGroup4,3,84") -- MM_STURMFORDCITY.scr:585
    -- Devlin A'Norta a'meich		( 392 )
    ctx:command("arrayput", "aGroup4,4,392") -- MM_STURMFORDCITY.scr:588
