...
script.labels["KeepMoving"] = function(ctx)
    ...
    ctx:set("counter", "counter + 1") -- YANMIRPATROL.scr:80
    ctx:mod("counter", 16) -- YANMIRPATROL.scr:81
    if ctx:condition("counter == 0") then -- YANMIRPATROL.scr:82
        ctx:state().nMarker = 0 -- YANMIRPATROL.scr:83
        ctx:set("sMarker", "sPatrolPathA + nMarker") -- YANMIRPATROL.scr:84
        ctx:self():stop() -- YANMIRPATROL.scr:85
...
script.labels["GoToMarker"] = function(ctx)
    ...
    if ctx:condition("nMarker < nMarkersA") then -- YANMIRPATROL.scr:96
        ctx:set("nMarker", "nMarker + 1") -- YANMIRPATROL.scr:97
        ctx:set("sMarker", "sPatrolPathA + nMarker") -- YANMIRPATROL.scr:98
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- YANMIRPATROL.scr:99
        ctx:self():walkTo(ctx:object("hMarker"), 1, "GoToMarker") -- YANMIRPATROL.scr:100
...
script.labels["WalkToLastMarker"] = function(ctx)
    ...
    ctx:state().nMarker = 0 -- YANMIRPATROL.scr:108
    ctx:state().nDusting = 0 -- YANMIRPATROL.scr:109
    ctx:state().hMarker = ctx:objectOrNil("YanmirSquishMarker0") -- YANMIRPATROL.scr:110
    ctx:self():walkTo(ctx:object("hMarker"), 0, "Marker0") -- YANMIRPATROL.scr:111
...
script.labels["UnStuckMe"] = function(ctx)
    ...
    if ctx:condition("nForward == 0") then -- YANMIRPATROL.scr:117
        ctx:set("nMarker", "nMarker - 1") -- YANMIRPATROL.scr:118
...
script.labels["KickTheDoor"] = function(ctx)
    ...
    ctx:playSound("sounds\\AnimSounds\\YanmirAware.wav", "dn", 1000, 2000, "FALSE", 100) -- YANMIRPATROL.scr:132
    ctx:self():playAnimation("Hattack2", "dn") -- YANMIRPATROL.scr:133
    ctx:wait(1, .8, "Kicking") -- YANMIRPATROL.scr:134
    do return ctx:exit(1) end -- YANMIRPATROL.scr:135
end

script.labels["Kicking"] = function(ctx)
    -- YANMIRPATROL.scr:136
    ctx:set("sDusting", "sDustString + nDusting") -- YANMIRPATROL.scr:137
    ctx:set("sQuaking", "sDoorString + nDusting") -- YANMIRPATROL.scr:138
    ctx:state().hDustObject = ctx:objectOrNil("sDusting") -- YANMIRPATROL.scr:139
    ctx:state().hDoorQuake = ctx:objectOrNil("sQuaking") -- YANMIRPATROL.scr:140
    ctx:set("nDusting", "nDusting + 1") -- YANMIRPATROL.scr:141
    ctx:playSound("Sounds\\Door\\stonedoorslam.wav", "dn", 1000, 3500, "FALSE", 100) -- YANMIRPATROL.scr:142
    ctx:trigger("hDustObject", "On") -- YANMIRPATROL.scr:143
    ctx:set("nMarker", "nMarker - 1") -- YANMIRPATROL.scr:144
    ctx:trigger("hDoor", "use") -- YANMIRPATROL.scr:145
    ctx:wait(0, .25, "DustMe") -- YANMIRPATROL.scr:146
...
script.labels["DustMe"] = function(ctx)
    ...
    ctx:playSound("Sounds\\Door\\doorslammetal01.wav", "dn", 1000, 3500, "FALSE", 100) -- YANMIRPATROL.scr:151
    ctx:wait(0, 1, "GoToMarker") -- YANMIRPATROL.scr:152
...
script.labels["PlayScene"] = function(ctx)
    ...
    ctx:self():runTo(ctx:object("hMarker"), 0, "StepOn") -- YANMIRPATROL.scr:163
    do return ctx:exit(1) end -- YANMIRPATROL.scr:164
end

script.labels["StepOn"] = function(ctx)
    -- YANMIRPATROL.scr:165
    ctx:playSound("sounds\\Squish.wav", "dn", 100, 2000, "FALSE", 100) -- YANMIRPATROL.scr:166
    ctx:self():playAnimation("StepOn", "Wipe") -- YANMIRPATROL.scr:167
    ctx:object("hSquishVictim"):damage(3000, 4, "FALSE") -- YANMIRPATROL.scr:168
    do return ctx:exit(1) end -- YANMIRPATROL.scr:169
end

script.labels["Wipe"] = function(ctx)
    -- YANMIRPATROL.scr:170
    ctx:playSound("sounds\\Squish2.wav", "dn", 100, 2000, "FALSE", 100) -- YANMIRPATROL.scr:171
    -- PlaySound sounds\AnimSounds\YanmirWipe.wav, dn, 100, 1000, FALSE, 100
    ctx:self():playAnimation("Wipe", "Wince1") -- YANMIRPATROL.scr:173
    do return ctx:exit(1) end -- YANMIRPATROL.scr:174
end

script.labels["Wince1"] = function(ctx)
    -- YANMIRPATROL.scr:175
    ctx:playSound("sounds\\AnimSounds\\YanmirWipe.wav", "dn", 100, 1000, "FALSE", 100) -- YANMIRPATROL.scr:176
    ctx:self():playAnimation("Wince1", "dn") -- YANMIRPATROL.scr:177
    ctx:wait(0, 0.5, "Marker0") -- YANMIRPATROL.scr:178
    do return ctx:exit(1) end -- YANMIRPATROL.scr:179
end

script.labels["Marker0"] = function(ctx)
    -- YANMIRPATROL.scr:180
    ctx:state().hMarker = ctx:objectOrNil("YanmirPathA0") -- YANMIRPATROL.scr:181
    ctx:self():walkTo(ctx:object("hMarker"), 0, "FirstMarker") -- YANMIRPATROL.scr:182
    do return ctx:exit(1) end -- YANMIRPATROL.scr:183
end

script.labels["FirstMarker"] = function(ctx)
    -- YANMIRPATROL.scr:184
    ctx:playSound("sounds\\AnimSounds\\YanmirWipe.wav", "dn", 100, 1000, "FALSE", 100) -- YANMIRPATROL.scr:185
    ctx:self():playAnimation("Wince1", "GoToMarker") -- YANMIRPATROL.scr:186
...
script.labels["Main2"] = function(ctx)
    ...
    ctx:state().hMarker = ctx:objectOrNil("YanmirSquishMarker0") -- YANMIRPATROL.scr:197
    ctx:state().hSquishVictim = ctx:objectOrNil("SquishVictim0") -- YANMIRPATROL.scr:198
    ctx:set("nMarkersA", "nMarkersA - 1") -- YANMIRPATROL.scr:199
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnStuck", "UnStuckMe") -- YANMIRPATROL.scr:210
    ctx:onEvent("OnDoor", "KickTheDoor") -- YANMIRPATROL.scr:211
    ctx:onEvent("OnFoundTarget", "AlertCall") -- YANMIRPATROL.scr:212
    ctx:wait(0, .1, "main2") -- YANMIRPATROL.scr:213
