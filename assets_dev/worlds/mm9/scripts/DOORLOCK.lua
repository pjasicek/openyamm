...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:hasItem("nKey") then -- DOORLOCK.scr:25-26
        ctx:command("getmyhandle", "g_hmyobject") -- DOORLOCK.scr:27
        ctx:command("setstat", "g_hmyobject,Locked,FALSE") -- DOORLOCK.scr:28
        ctx:command("rollovertext", "17, 1") -- DOORLOCK.scr:29
        ...
        if ctx:condition("bLockDoor==TRUE") then -- DOORLOCK.scr:37
            ctx:command("setstat", "g_hmyobject,Locked,TRUE") -- DOORLOCK.scr:38
