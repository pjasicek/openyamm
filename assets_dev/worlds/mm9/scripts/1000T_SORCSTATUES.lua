...
script.labels["Start"] = function(ctx)
    ...
    ctx:command("biscasting", "= TRUE") -- 1000T_SORCSTATUES.scr:31
...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:command("wait", "1, 1, DoNothing") -- 1000T_SORCSTATUES.scr:39
    ctx:trigger("hCastingSmoke", "Off") -- 1000T_SORCSTATUES.scr:40
    ctx:command("biscasting", "= FALSE") -- 1000T_SORCSTATUES.scr:41
...
script.labels["Continue"] = function(ctx)
    ...
    ctx:command("playanim", "Taunt, StartSequence") -- 1000T_SORCSTATUES.scr:49
...
script.labels["StartSequence"] = function(ctx)
    ...
    ctx:command("playanim", "fidget2, Continue") -- 1000T_SORCSTATUES.scr:58
    do return ctx:exit("True") end -- 1000T_SORCSTATUES.scr:60
end

script.labels["Main2"] = function(ctx)
    -- 1000T_SORCSTATUES.scr:62
    ctx:command("playanim", "fidget2, DoNothing") -- 1000T_SORCSTATUES.scr:64
    ctx:addTrigger("Go", "Start") -- 1000T_SORCSTATUES.scr:65
    ctx:addTrigger("Stop", "TurnOff") -- 1000T_SORCSTATUES.scr:66
    ctx:command("getobjecthandle", "sShooter, hDummy") -- 1000T_SORCSTATUES.scr:67
    ctx:command("getobjecthandle", "sCastingSmoke, hCastingSmoke") -- 1000T_SORCSTATUES.scr:68
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("wait", "0, 0.5, Main2") -- 1000T_SORCSTATUES.scr:75
