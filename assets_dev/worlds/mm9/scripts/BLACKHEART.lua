...
script.labels["OnUse"] = function(ctx)
    ...
    ctx:command("getmyhandle", "g_hmyobject") -- BLACKHEART.scr:34
    ctx:command("removeobject", "g_hmyobject") -- BLACKHEART.scr:35
    ctx:giveKey(223) -- BLACKHEART.scr:36
    -- SJR(alarm sound)
    ctx:command("playsound", "\"sounds\\events\\alarmbell.wav\", DoNothing, 1, 5000, FALSE, 100") -- BLACKHEART.scr:39
    -- endSJR
...
script.labels["Init"] = function(ctx)
    ...
    if ctx:hasKey(223) then -- BLACKHEART.scr:54-55
        ctx:command("getmyhandle", "g_hmyobject") -- BLACKHEART.scr:56
        ctx:command("removeobject", "g_hmyobject") -- BLACKHEART.scr:57
...
script.labels["CacheFiles"] = function(ctx)
    -- BLACKHEART.scr:64
    ctx:command("cachesound", "\"sounds\\events\\alarmbell.wav\"") -- BLACKHEART.scr:66
...
script.labels["Main"] = function(ctx)
    ...
    -- SJR(cache the sound)
    ctx:command("oncachefiles", "CacheFiles") -- BLACKHEART.scr:80
    -- endSJR
    ctx:command("wait", "1 1 Init") -- BLACKHEART.scr:83
