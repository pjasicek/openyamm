...
script.labels["TriggerTrap"] = function(ctx)
    -- BUTTONPUZZLE.scr:54
    ctx:command("movedir", "0, nMoveDir2, 0, nMoveDistA, 300, DoNothing") -- BUTTONPUZZLE.scr:57
    do return ctx:exit(1) end -- BUTTONPUZZLE.scr:59
end

script.labels["TriggerMe"] = function(ctx)
    -- BUTTONPUZZLE.scr:62
    ctx:command("ntrig", "= 1") -- BUTTONPUZZLE.scr:65
    ctx:command("getmyhandle", "hHandle") -- BUTTONPUZZLE.scr:66
...
script.labels["UseMe"] = function(ctx)
    ...
    if ctx:condition("nTrig == 0") then -- BUTTONPUZZLE.scr:76
        ...
        if ctx:condition("nLockButtons == 0") then -- BUTTONPUZZLE.scr:78
            ctx:command("getobjecthandle", "sButtonPad, hHandle") -- BUTTONPUZZLE.scr:79
            ctx:trigger("hHandle", "sButtonName") -- BUTTONPUZZLE.scr:80
        end -- BUTTONPUZZLE.scr:81
    else -- BUTTONPUZZLE.scr:82
        ctx:command("ntrig", "= 0") -- BUTTONPUZZLE.scr:83
...
script.labels["UseStart"] = function(ctx)
    ...
    ctx:command("getmyhandle", "hHandle") -- BUTTONPUZZLE.scr:93
...
script.labels["MoveDoor"] = function(ctx)
    ...
    ctx:command("stop", "") -- BUTTONPUZZLE.scr:103
    ctx:command("removetrigger", "Use") -- BUTTONPUZZLE.scr:104
    ctx:trigger("hMe", "Lock") -- BUTTONPUZZLE.scr:105
    ctx:command("playsound", "sounds\\Door\\doorlatch02.wav, DoNothing, 0, 1000, 0, 70") -- BUTTONPUZZLE.scr:107
    ctx:command("wait", "0, .8, EndDoor") -- BUTTONPUZZLE.scr:108
    do return ctx:exit(1) end -- BUTTONPUZZLE.scr:110
end

script.labels["EndDoor"] = function(ctx)
    -- BUTTONPUZZLE.scr:113
    ctx:command("playsound", "sounds\\Door\\stonedoorslide02.wav, DoNothing, 0, 1000, 0, 70") -- BUTTONPUZZLE.scr:116
    ctx:command("movedir", "0, nMoveDir, 0, nMoveDistB, nMoveSpeed, EndScript") -- BUTTONPUZZLE.scr:117
...
script.labels["Main2"] = function(ctx)
    ...
    ctx:command("nmovedir2", "= nMoveDir - 2") -- BUTTONPUZZLE.scr:131
    ctx:command("getmyhandle", "hMe") -- BUTTONPUZZLE.scr:132
    ctx:command("setflag", "hMe FLAG_GOTHRUWORLD") -- BUTTONPUZZLE.scr:133
    ctx:command("movedir", "0, nMoveDir, 0, nMoveDistA, 0, DoNothing") -- BUTTONPUZZLE.scr:134
...
script.labels["UseMe"] = function(ctx)
    ...
    if ctx:condition("nTrig == 0") then -- BUTTONPUZZLE.scr:166
        ctx:command("isturnbased", "nTrig") -- BUTTONPUZZLE.scr:167
        if ctx:condition("nTrig == 1") then -- BUTTONPUZZLE.scr:168
            ctx:command("ntrig", "= 0") -- BUTTONPUZZLE.scr:169
            ctx:command("rollovertext", "19 0") -- BUTTONPUZZLE.scr:170
            ctx:command("wait", "30 1 UseMe") -- BUTTONPUZZLE.scr:171
            do return ctx:exit("") end -- BUTTONPUZZLE.scr:172
        else -- BUTTONPUZZLE.scr:173
            ctx:command("ntrig", "= 0") -- BUTTONPUZZLE.scr:174
        end -- BUTTONPUZZLE.scr:175
    else -- BUTTONPUZZLE.scr:177
        ctx:command("isturnbased", "nTrig") -- BUTTONPUZZLE.scr:178
        if ctx:condition("nTrig == 1") then -- BUTTONPUZZLE.scr:179
            ctx:command("ntrig", "= 1") -- BUTTONPUZZLE.scr:180
            ctx:command("rollovertext", "19 0") -- BUTTONPUZZLE.scr:181
            ctx:command("wait", "30 1 UseMe") -- BUTTONPUZZLE.scr:182
            do return ctx:exit("") end -- BUTTONPUZZLE.scr:183
        else -- BUTTONPUZZLE.scr:184
            ctx:command("ntrig", "= 1") -- BUTTONPUZZLE.scr:185
