...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("oncachefiles", "CacheFiles") -- BC_TREASURECHEST.scr:21
...
script.labels["CacheFiles"] = function(ctx)
    ...
    if ctx:condition("CHEST_TRAP==TRUE") then -- BC_TREASURECHEST.scr:28
        ctx:command("cacheclientfx", "SPELL_COLUMNOFFIRE") -- BC_TREASURECHEST.scr:29
        ctx:command("cachesound", "\"sounds\\door\\doorlatch01.wav\"") -- BC_TREASURECHEST.scr:30
...
script.labels["PlayOpenAnim"] = function(ctx)
    ...
    if ctx:condition("CHEST_TRAP==TRUE") then -- BC_TREASURECHEST.scr:38
        ...
        ctx:command("playanim", "open, SpringTrap") -- BC_TREASURECHEST.scr:40
    else -- BC_TREASURECHEST.scr:41
        ctx:command("playanim", "open, HoldOpenAnim") -- BC_TREASURECHEST.scr:42
...
script.labels["HoldOpenAnim"] = function(ctx)
    ...
    ctx:command("wait", "0, 2, PlayCloseAnim") -- BC_TREASURECHEST.scr:50
    do return ctx:exit("TRUE") end -- BC_TREASURECHEST.scr:52
end

script.labels["PlayCloseAnim"] = function(ctx)
    -- BC_TREASURECHEST.scr:55
    ctx:command("playanim", "Close, DoNothing") -- BC_TREASURECHEST.scr:57
    do return ctx:exit("TRUE") end -- BC_TREASURECHEST.scr:59
end

script.labels["SpringTrap"] = function(ctx)
    -- BC_TREASURECHEST.scr:62
    ctx:command("doclientfx", "hOpener, SPELL_COLUMNOFFIRE, FALSE, TRUE") -- BC_TREASURECHEST.scr:64
    ctx:command("playsound", "\"sounds\\door\\doorlatch01.wav\", DoNothing, 1, 1000, FALSE, 100") -- BC_TREASURECHEST.scr:66
    ctx:command("wait", "1, 1, KillTheGuy") -- BC_TREASURECHEST.scr:68
...
script.labels["KillTheGuy"] = function(ctx)
    ...
    ctx:command("wait", "2, 2, RemoveTheGuy") -- BC_TREASURECHEST.scr:79
...
script.labels["RemoveTheGuy"] = function(ctx)
    ...
    if ctx:condition("hOpener!=0") then -- BC_TREASURECHEST.scr:86
        ctx:command("removeobject", "hOpener") -- BC_TREASURECHEST.scr:87
