...
script.labels["SitStill"] = function(ctx)
    ...
    ctx:state().nCount = 0 -- DP_INTERROGATIONPRISONER.scr:65
    ctx:self():stop() -- DP_INTERROGATIONPRISONER.scr:66
    ctx:self():playAnimation("Cower", "DoNothing") -- DP_INTERROGATIONPRISONER.scr:67
...
script.labels["LeaveCell"] = function(ctx)
    ...
    ctx:state().hMarker = nil -- DP_INTERROGATIONPRISONER.scr:73
    ctx:state().nMarker = 4 -- DP_INTERROGATIONPRISONER.scr:74
    if ctx:condition("sCellMarker==CellMarker0") then -- DP_INTERROGATIONPRISONER.scr:75
        ctx:state().hMarker = ctx:objectOrNil("PrisonerPathA4") -- DP_INTERROGATIONPRISONER.scr:76
    else -- DP_INTERROGATIONPRISONER.scr:77
        if ctx:condition("sCellMarker==CellMarker1") then -- DP_INTERROGATIONPRISONER.scr:78
            ctx:state().hMarker = ctx:objectOrNil("PrisonerPathA5") -- DP_INTERROGATIONPRISONER.scr:79
        else -- DP_INTERROGATIONPRISONER.scr:80
            if ctx:condition("sCellMarker==CellMarker2") then -- DP_INTERROGATIONPRISONER.scr:81
                ctx:state().hMarker = ctx:objectOrNil("PrisonerPathA6") -- DP_INTERROGATIONPRISONER.scr:82
            end -- DP_INTERROGATIONPRISONER.scr:83
        end -- DP_INTERROGATIONPRISONER.scr:84
    end -- DP_INTERROGATIONPRISONER.scr:85
    ctx:self():walkTo(ctx:object("hMarker"), 10, "SignalWardenAgain") -- DP_INTERROGATIONPRISONER.scr:87
...
script.labels["SignalWardenAgain"] = function(ctx)
    ...
    ctx:state().nCount = 1 -- DP_INTERROGATIONPRISONER.scr:92
    ctx:self():stop() -- DP_INTERROGATIONPRISONER.scr:93
    ctx:wait(1, 2, "DoNothing") -- DP_INTERROGATIONPRISONER.scr:94
    ctx:self():playAnimation("Fidget3", "DoNothing") -- DP_INTERROGATIONPRISONER.scr:95
...
script.labels["GoInCell"] = function(ctx)
    ...
    ctx:state().hMarker = nil -- DP_INTERROGATIONPRISONER.scr:105
    ctx:wait(1, 2, "DoNothing") -- DP_INTERROGATIONPRISONER.scr:106
    ctx:state().hMarker = ctx:objectOrNil("sCellMarker") -- DP_INTERROGATIONPRISONER.scr:107
    ctx:self():walkTo(ctx:object("hMarker"), 10, "SignalWarden") -- DP_INTERROGATIONPRISONER.scr:108
...
script.labels["SignalWarden"] = function(ctx)
    ...
    ctx:state().nCount = 4 -- DP_INTERROGATIONPRISONER.scr:114
    ctx:self():stop() -- DP_INTERROGATIONPRISONER.scr:115
    ctx:trigger("hWarden", "CloseCell") -- DP_INTERROGATIONPRISONER.scr:116
    ctx:wait(1, 2, "DoNothing") -- DP_INTERROGATIONPRISONER.scr:117
    ctx:self():playAnimation("Fidget4", "DoNothing") -- DP_INTERROGATIONPRISONER.scr:118
    ctx:self():faceObject(ctx:object("hCellDoor"), 180, "DoNothing") -- DP_INTERROGATIONPRISONER.scr:119
...
script.labels["ToTheWarden"] = function(ctx)
    ...
    ctx:state().nCount = 3 -- DP_INTERROGATIONPRISONER.scr:126
    if ctx:condition("nMarker < nNumMarkers") then -- DP_INTERROGATIONPRISONER.scr:127
        ctx:set("nMarker", "nMarker + 1") -- DP_INTERROGATIONPRISONER.scr:128
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONPRISONER.scr:129
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONPRISONER.scr:130
        ctx:self():walkTo(ctx:object("hMarker"), 10, "ToTheWarden") -- DP_INTERROGATIONPRISONER.scr:131
    else -- DP_INTERROGATIONPRISONER.scr:132
        ctx:self():walkTo(ctx:object("hMarker"), 10, "WalkToLastMarker") -- DP_INTERROGATIONPRISONER.scr:133
...
script.labels["WardenWait"] = function(ctx)
    ...
    ctx:self():stop() -- DP_INTERROGATIONPRISONER.scr:139
    ctx:self():playAnimation("Fidget2", "DoNothing") -- DP_INTERROGATIONPRISONER.scr:140
    ctx:wait(1, 1, "DoNothing") -- DP_INTERROGATIONPRISONER.scr:141
...
script.labels["ToTheInterrogation"] = function(ctx)
    ...
    if ctx:condition("nMarker != 0") then -- DP_INTERROGATIONPRISONER.scr:148
        ctx:set("nMarker", "nMarker - 1") -- DP_INTERROGATIONPRISONER.scr:149
        ctx:set("sMarker", "sWayPoint + nMarker") -- DP_INTERROGATIONPRISONER.scr:150
        ctx:state().hMarker = ctx:objectOrNil("sMarker") -- DP_INTERROGATIONPRISONER.scr:151
        ctx:self():walkTo(ctx:object("hMarker"), 10, "ToTheInterrogation") -- DP_INTERROGATIONPRISONER.scr:152
...
script.labels["InterrogationRoom"] = function(ctx)
    ...
    if ctx:condition("nReset==5") then -- DP_INTERROGATIONPRISONER.scr:160
        ctx:state().nReset = 0 -- DP_INTERROGATIONPRISONER.scr:161
        ctx:self():stop() -- DP_INTERROGATIONPRISONER.scr:162
    else -- DP_INTERROGATIONPRISONER.scr:163
        ctx:state().nCount = 2 -- DP_INTERROGATIONPRISONER.scr:164
        ctx:state().nMarker = 0 -- DP_INTERROGATIONPRISONER.scr:165
        ctx:self():stop() -- DP_INTERROGATIONPRISONER.scr:166
        ctx:self():playAnimation("Aware", "DoNothing") -- DP_INTERROGATIONPRISONER.scr:167
        ctx:wait(1, 15, "DoTheWalk") -- DP_INTERROGATIONPRISONER.scr:168
...
script.labels["Main2"] = function(ctx)
    ...
    ctx:state().hWarden = ctx:objectOrNil("InterrWarden") -- DP_INTERROGATIONPRISONER.scr:210
    ctx:state().hCellDoor = ctx:objectOrNil("sCellDoor") -- DP_INTERROGATIONPRISONER.scr:211
    ctx:set("nNumMarkers", "nNumMarkers - 2") -- DP_INTERROGATIONPRISONER.scr:212
...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, .1, "main2") -- DP_INTERROGATIONPRISONER.scr:233
