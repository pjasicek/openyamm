...
script.labels["OnTargetWithinDist"] = function(ctx)
    ...
    ctx:command("target", "hPlayer, TRUE") -- NPC9MOD.scr:46
    ctx:command("ontargetbeyonddist", "WAIT_DISTANCE, OnTargetBeyondDist") -- NPC9MOD.scr:47
...
script.labels["OnTargetBeyondDist"] = function(ctx)
    ...
    ctx:command("target", "hPlayer, TRUE") -- NPC9MOD.scr:55
    ctx:command("ontargetwithindist", "RESUME_DISTANCE, OnTargetWithinDist") -- NPC9MOD.scr:56
...
script.labels["OnRudeExit"] = function(ctx)
    ...
    if ctx:condition("bHasKey==TRUE") then -- NPC9MOD.scr:64
        ctx:command("getplayerhandle", "hPlayer") -- NPC9MOD.scr:65
        ctx:command("target", "hPlayer, TRUE") -- NPC9MOD.scr:66
