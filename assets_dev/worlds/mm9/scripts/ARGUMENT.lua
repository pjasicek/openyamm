...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:hasKey(184) then -- ARGUMENT.scr:30-31
        ...
        ctx:playSound("voices\\NPC\\NPC_001.wav", "DoNothing", 100, 24000, "FALSE", 100) -- ARGUMENT.scr:33
...
script.labels["War"] = function(ctx)
    ...
    if not ctx:hasKey(184) then -- ARGUMENT.scr:47-48
        ...
        ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 24000, "FALSE", 100) -- ARGUMENT.scr:53
...
script.labels["OnRude"] = function(ctx)
    ...
    if not ctx:hasKey(185) then -- ARGUMENT.scr:70-71
        if ctx:hasKey(93) then -- ARGUMENT.scr:72-73
            ...
            -- GiveExp 16000
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 24000, "FALSE", 100) -- ARGUMENT.scr:76
...
script.labels["ForceStart"] = function(ctx)
    ...
    ctx:state().hSven = ctx:objectOrNil("Sven") -- ARGUMENT.scr:93
    ctx:state().hBjarni = ctx:objectOrNil("Bjarni") -- ARGUMENT.scr:94
    ctx:state().hSigmund = ctx:objectOrNil("Sigmund") -- ARGUMENT.scr:95
    ctx:state().hMarkel = ctx:objectOrNil("Markel") -- ARGUMENT.scr:96
    ctx:state().hTryygva = ctx:objectOrNil("Tryygva") -- ARGUMENT.scr:97
    ctx:state().hKira = ctx:objectOrNil("Kira") -- ARGUMENT.scr:98
    ctx:state().hForad = ctx:objectOrNil("Forad") -- ARGUMENT.scr:99
    -- letterbox true
    -- set ncamcount 18
    -- gosub Bjarni16
...
script.labels["Init"] = function(ctx)
    ...
    ctx:state().g_ncounter = 0 -- ARGUMENT.scr:116
    if ctx:hasKey(90) then -- ARGUMENT.scr:120-121
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- ARGUMENT.scr:122
    end -- ARGUMENT.scr:123
    if ctx:hasKey(91) then -- ARGUMENT.scr:125-126
        ctx:state().g_nCounter = (tonumber(ctx:state().g_nCounter) or 0) + 1 -- ARGUMENT.scr:127
    ...
    if ctx:condition("g_nCounter==2") then -- ARGUMENT.scr:130
        ...
        ctx:state().hSven = ctx:objectOrNil("Sven") -- ARGUMENT.scr:136
        ctx:state().hBjarni = ctx:objectOrNil("Bjarni") -- ARGUMENT.scr:137
        ctx:state().hSigmund = ctx:objectOrNil("Sigmund") -- ARGUMENT.scr:138
        ctx:state().hMarkel = ctx:objectOrNil("Markel") -- ARGUMENT.scr:139
        ctx:state().hTryygva = ctx:objectOrNil("Tryygva") -- ARGUMENT.scr:140
        ctx:state().hKira = ctx:objectOrNil("Kira") -- ARGUMENT.scr:141
        ctx:state().hForad = ctx:objectOrNil("Forad") -- ARGUMENT.scr:142
...
script.labels["OnStart"] = function(ctx)
    -- ARGUMENT.scr:152
    ctx:isTurnBased("g_nTemp") -- ARGUMENT.scr:155
    if ctx:condition("g_nTemp == TRUE") then -- ARGUMENT.scr:156
        ctx:screenFadeOut(1) -- ARGUMENT.scr:157
        ctx:rolloverText(18, 0) -- ARGUMENT.scr:158
        ctx:wait(0, 1, "OnStart") -- ARGUMENT.scr:159
        do return ctx:exit("") end -- ARGUMENT.scr:160
    end -- ARGUMENT.scr:161
    ctx:state().nStarted = true -- ARGUMENT.scr:163
    ctx:removeTrigger("start") -- ARGUMENT.scr:164
    ctx:state().nCamCount = 0 -- ARGUMENT.scr:165
    ctx:screenFadeOut(1) -- ARGUMENT.scr:166
    ctx:wait(1, 1, "FadeIn") -- ARGUMENT.scr:167
    do return ctx:exit("") end -- ARGUMENT.scr:168
end

script.labels["FadeIn"] = function(ctx)
    -- ARGUMENT.scr:171
    ctx:letterBox("true") -- ARGUMENT.scr:174
    local object = ctx:object("Camera0") -- ARGUMENT.scr:175
    object:trigger("On") -- ARGUMENT.scr:176
    object:trigger("Play") -- ARGUMENT.scr:177
    ctx:screenFadeIn(1) -- ARGUMENT.scr:178
    -- wait 1 1 ShootOn
...
script.labels["Cam1"] = function(ctx)
    -- ARGUMENT.scr:183
    ctx:screenFadeOut(.5) -- ARGUMENT.scr:186
    ctx:wait(1, .5, "Cam2B") -- ARGUMENT.scr:187
    do return ctx:exit("") end -- ARGUMENT.scr:188
end

script.labels["Cam2b"] = function(ctx)
    -- ARGUMENT.scr:191
    ctx:object("Camera0"):trigger("Off") -- ARGUMENT.scr:194-195
    ctx:object("Camera1"):trigger("On") -- ARGUMENT.scr:196-197
    ctx:screenFadeIn(.5) -- ARGUMENT.scr:198
    ctx:object("KiraCold"):trigger("KillMarkel") -- ARGUMENT.scr:200-201
    ctx:removeNpc(2, "g_hobject") -- ARGUMENT.scr:202
...
script.labels["Cam2"] = function(ctx)
    -- ARGUMENT.scr:209
    ctx:object("Camera1"):trigger("Off") -- ARGUMENT.scr:212-213
    ctx:object("Camera11"):trigger("On") -- ARGUMENT.scr:214-215
    ctx:trigger("hSigmund", "Shot1A") -- ARGUMENT.scr:217
    ctx:wait(1, 4, "Cam2c") -- ARGUMENT.scr:218
    do return ctx:exit("") end -- ARGUMENT.scr:219
end

script.labels["Cam2c"] = function(ctx)
    -- ARGUMENT.scr:222
    ctx:object("Camera11"):trigger("Off") -- ARGUMENT.scr:225-226
    ctx:object("Camera2"):trigger("On") -- ARGUMENT.scr:227-228
...
script.labels["Cam3"] = function(ctx)
    -- ARGUMENT.scr:237
    ctx:object("Camera2"):trigger("Off") -- ARGUMENT.scr:240-241
    ctx:object("Camera3"):trigger("On") -- ARGUMENT.scr:242-243
    ...
    ctx:wait(1, 4, "OnMarkel") -- ARGUMENT.scr:255
    do return ctx:exit("") end -- ARGUMENT.scr:257
end

script.labels["Cam4"] = function(ctx)
    -- ARGUMENT.scr:260
    ctx:object("Camera4"):trigger("Off") -- ARGUMENT.scr:263-264
    ctx:object("Camera1"):trigger("On") -- ARGUMENT.scr:265-266
    -- trigger Bjarni and Sigmund to Shake hands
...
script.labels["OnMarkel"] = function(ctx)
    -- ARGUMENT.scr:275
    ctx:object("Camera3"):trigger("Off") -- ARGUMENT.scr:279-280
    ctx:object("Camera4"):trigger("On") -- ARGUMENT.scr:281-282
...
script.labels["Sigmund3"] = function(ctx)
    -- ARGUMENT.scr:288
    ctx:object("Camera1"):trigger("Off") -- ARGUMENT.scr:291-292
    ctx:object("Camera2"):trigger("On") -- ARGUMENT.scr:293-294
...
script.labels["Markel4"] = function(ctx)
    -- ARGUMENT.scr:300
    ctx:object("Camera2"):trigger("Off") -- ARGUMENT.scr:304-305
    ctx:object("Camera4"):trigger("On") -- ARGUMENT.scr:306-307
...
script.labels["Kira5"] = function(ctx)
    -- ARGUMENT.scr:313
    ctx:object("Camera4"):trigger("Off") -- ARGUMENT.scr:317-318
    ctx:object("Camera5"):trigger("On") -- ARGUMENT.scr:319-320
...
script.labels["Forad6"] = function(ctx)
    -- ARGUMENT.scr:328
    ctx:object("Camera5"):trigger("Off") -- ARGUMENT.scr:332-333
    ctx:object("Camera6"):trigger("On") -- ARGUMENT.scr:334-335
...
script.labels["Kira7"] = function(ctx)
    -- ARGUMENT.scr:342
    ctx:object("Camera6"):trigger("Off") -- ARGUMENT.scr:346-347
    ctx:object("Camera5"):trigger("On") -- ARGUMENT.scr:348-349
...
script.labels["Markel8"] = function(ctx)
    -- ARGUMENT.scr:355
    ctx:object("Camera5"):trigger("Off") -- ARGUMENT.scr:359-360
    ctx:object("Camera4"):trigger("On") -- ARGUMENT.scr:361-362
...
script.labels["Bjarni9"] = function(ctx)
    -- ARGUMENT.scr:369
    ctx:object("Camera4"):trigger("Off") -- ARGUMENT.scr:373-374
    ctx:object("Camera7"):trigger("On") -- ARGUMENT.scr:375-376
...
script.labels["Markel11"] = function(ctx)
    -- ARGUMENT.scr:397
    ctx:object("Camera7"):trigger("Off") -- ARGUMENT.scr:401-402
    ctx:object("Camera4"):trigger("On") -- ARGUMENT.scr:403-404
...
script.labels["Kira12"] = function(ctx)
    -- ARGUMENT.scr:412
    ctx:object("Camera4"):trigger("Off") -- ARGUMENT.scr:416-417
    ctx:object("Camera5"):trigger("On") -- ARGUMENT.scr:418-419
...
script.labels["Markel13"] = function(ctx)
    -- ARGUMENT.scr:427
    ctx:object("Camera5"):trigger("Off") -- ARGUMENT.scr:431-432
    ctx:object("Camera4"):trigger("On") -- ARGUMENT.scr:433-434
...
script.labels["Kira14"] = function(ctx)
    -- ARGUMENT.scr:440
    ctx:object("Camera4"):trigger("Off") -- ARGUMENT.scr:444-445
    ctx:object("Camera5"):trigger("On") -- ARGUMENT.scr:446-447
...
script.labels["Markel15"] = function(ctx)
    -- ARGUMENT.scr:453
    ctx:object("Camera5"):trigger("Off") -- ARGUMENT.scr:457-458
    ctx:object("Camera4"):trigger("On") -- ARGUMENT.scr:459-460
...
script.labels["Bjarni16"] = function(ctx)
    -- ARGUMENT.scr:466
    ctx:object("Camera4"):trigger("Off") -- ARGUMENT.scr:470-471
    ctx:object("Camera7"):trigger("On") -- ARGUMENT.scr:472-473
...
script.labels["OnKiraStand"] = function(ctx)
    -- ARGUMENT.scr:486
    ctx:object("Camera7"):trigger("Off") -- ARGUMENT.scr:489-490
    ctx:object("Camera8"):trigger("On") -- ARGUMENT.scr:491-492
    do return ctx:exit("") end -- ARGUMENT.scr:493
end

script.labels["OnKiraStand2"] = function(ctx)
    -- ARGUMENT.scr:497
    ctx:object("Camera9"):trigger("Off") -- ARGUMENT.scr:500-501
    ctx:object("Camera8"):trigger("On") -- ARGUMENT.scr:502-503
...
script.labels["Agree"] = function(ctx)
    -- ARGUMENT.scr:508
    ctx:object("Camera10"):trigger("Off") -- ARGUMENT.scr:511-512
    ctx:object("Camera0"):trigger("On") -- ARGUMENT.scr:513-514
    ...
    ctx:wait(1, 2, "Kira19") -- ARGUMENT.scr:521
    do return ctx:exit("") end -- ARGUMENT.scr:522
end

script.labels["KiraCam"] = function(ctx)
    -- ARGUMENT.scr:525
    ctx:object("Camera8"):trigger("Off") -- ARGUMENT.scr:528-529
    ctx:object("Camera9"):trigger("On") -- ARGUMENT.scr:530-531
    do return ctx:exit("") end -- ARGUMENT.scr:532
end

script.labels["KiraCam2"] = function(ctx)
    -- ARGUMENT.scr:535
    ctx:object("Camera9"):trigger("Off") -- ARGUMENT.scr:538-539
    ctx:object("Camera10"):trigger("On") -- ARGUMENT.scr:540-541
...
script.labels["Kira19"] = function(ctx)
    -- ARGUMENT.scr:546
    ctx:object("Camera0"):trigger("Off") -- ARGUMENT.scr:549-550
    ctx:object("Camera10"):trigger("On") -- ARGUMENT.scr:551-552
...
script.labels["Forad20"] = function(ctx)
    -- ARGUMENT.scr:557
    ctx:object("Camera10"):trigger("Off") -- ARGUMENT.scr:560-561
    ctx:object("Camera6"):trigger("On") -- ARGUMENT.scr:562-563
...
script.labels["OnDone"] = function(ctx)
    -- ARGUMENT.scr:569
    ctx:set("nCamCount", "nCamCount + 1") -- ARGUMENT.scr:572
...
script.labels["End"] = function(ctx)
    ...
    ctx:screenFadeOut(1) -- ARGUMENT.scr:735
    ctx:wait(1, 1, "End2") -- ARGUMENT.scr:736
    do return ctx:exit("") end -- ARGUMENT.scr:737
end

script.labels["End2"] = function(ctx)
    -- ARGUMENT.scr:741
    ctx:object("Camera10"):trigger("Off") -- ARGUMENT.scr:745-746
    ctx:object("YrsatheTroll0"):trigger("appear") -- ARGUMENT.scr:747-748
    ctx:letterBox("false") -- ARGUMENT.scr:749
    ctx:screenFadeIn(1) -- ARGUMENT.scr:750
