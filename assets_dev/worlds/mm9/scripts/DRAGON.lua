...
script.labels["ClearAttackTimer"] = function(ctx)
    -- DRAGON.scr:129
    ctx:command("wait", "ATTACK_WAIT_NBR, 0, DoNothing") -- DRAGON.scr:131
...
script.labels["OnLostTarget"] = function(ctx)
    ...
    ctx:command("set", "g_hTarget, NULL") -- DRAGON.scr:141
    ctx:command("target", "NULL") -- DRAGON.scr:142
...
script.labels["AttackDone"] = function(ctx)
    -- DRAGON.scr:149
    ctx:command("set", "bAttacking, FALSE") -- DRAGON.scr:152
    ctx:command("target", "g_hTarget, TRUE") -- DRAGON.scr:154
    ...
    if ctx:condition("g_hTarget!=NULL") then -- DRAGON.scr:158
        ...
        ctx:command("setidle", "") -- DRAGON.scr:161
    end -- DRAGON.scr:162
...
script.labels["AttackFaceTargetDone"] = function(ctx)
    ...
    if ctx:condition("bAttacking==TRUE") then -- DRAGON.scr:170
        ctx:command("target", "g_hTarget, TRUE") -- DRAGON.scr:171
    end -- DRAGON.scr:172
...
script.labels["GetTargetHeight"] = function(ctx)
    ...
    ctx:command("set", "targetHeight, 0") -- DRAGON.scr:182
    if ctx:condition("g_hTarget==NULL") then -- DRAGON.scr:184
        do return ctx:exit("") end -- DRAGON.scr:185
    end -- DRAGON.scr:186
    ctx:command("getpos", "g_hMyObject, g_posX, g_posY, g_posZ") -- DRAGON.scr:188
    ctx:command("sub", "g_posY, dimsY") -- DRAGON.scr:189
    ctx:command("getpos", "g_hTarget, g_posX, targetHeight, g_posZ") -- DRAGON.scr:191
    ctx:command("sub", "targetHeight, g_posY") -- DRAGON.scr:192
...
script.labels["DoBreathAttack"] = function(ctx)
    ...
    if ctx:condition("g_hTarget!=NULL") then -- DRAGON.scr:205
        ...
        if ctx:condition("targetHeight > dimsZ") then -- DRAGON.scr:209
            ctx:command("playanim", "rAttack1, AttackDone") -- DRAGON.scr:210
        else -- DRAGON.scr:211
            ctx:command("playanim", "rAttack3, AttackDone") -- DRAGON.scr:212
        end -- DRAGON.scr:213
    else -- DRAGON.scr:214
        ctx:command("playanim", "rAttack3, AttackDone") -- DRAGON.scr:215
    end -- DRAGON.scr:216
...
script.labels["DoWingAttack"] = function(ctx)
    -- DRAGON.scr:221
    ctx:command("playanim", "WingAttack, WingAttackDone") -- DRAGON.scr:224
    do return ctx:exit("") end -- DRAGON.scr:226
end

script.labels["DoFireBoltAttack"] = function(ctx)
    -- DRAGON.scr:229
    ctx:command("playanim", "rAttack1, AttackDone") -- DRAGON.scr:232
    do return ctx:exit("") end -- DRAGON.scr:234
end

script.labels["CantAttackRightNow"] = function(ctx)
    -- DRAGON.scr:237
    ctx:command("battacking", "= FALSE") -- DRAGON.scr:239
    -- CPRINT Dragon can't attack yet!!
    ctx:command("wait", "ATTACK_WAIT_NBR, 0.2, DoAttack") -- DRAGON.scr:242
    do return ctx:exit("") end -- DRAGON.scr:243
end

script.labels["GetTargetDir"] = function(ctx)
    -- DRAGON.scr:246
    ctx:command("getpos", "g_hMyObject, g_posX, g_posY, g_posZ") -- DRAGON.scr:249
    ctx:command("getpos", "g_hTarget, g_targetDirX, g_targetdirY, g_targetDirZ") -- DRAGON.scr:250
    ctx:command("vecsub", "g_targetDirX, g_targetDirY, g_targetDirZ, g_posX, g_posY, g_posZ") -- DRAGON.scr:252
    ctx:command("vecnorm", "g_targetDirX, g_targetDirY, g_targetDirZ") -- DRAGON.scr:253
    ...
    if ctx:condition("g_nTemp < WING_ATTACK_DIST") then -- DRAGON.scr:273
        ...
        if ctx:condition("g_nTemp < BREATH_ATTACK_DIST") then -- DRAGON.scr:284
            ...
            if ctx:condition("g_nTemp < MAX_ATTACK_DIST") then -- DRAGON.scr:287
                ...
                ctx:command("setidle", "") -- DRAGON.scr:291
                ctx:command("battacking", "= FALSE") -- DRAGON.scr:292
...
script.labels["WingAttackDone"] = function(ctx)
    -- DRAGON.scr:301
    ctx:command("target", "g_hTarget, TRUE") -- DRAGON.scr:304
...
script.labels["DoHandAttack"] = function(ctx)
    -- DRAGON.scr:311
    ctx:command("playanim", "hAttack1, AttackDone") -- DRAGON.scr:314
...
script.labels["DoCloseAttack"] = function(ctx)
    ...
    ctx:command("set", "g_nTemp, 0") -- DRAGON.scr:329
    ctx:command("aigetdistance", "g_hTarget, currTargetDist") -- DRAGON.scr:331
    if ctx:condition("currTargetDist < MAX_HAND_ATTACK_DIST") then -- DRAGON.scr:333
        ctx:command("add", "g_nTemp, HAND_ATTACK_CHANCE") -- DRAGON.scr:334
    end -- DRAGON.scr:335
    mm9.gosub(script, ctx, "GetTargetHeight") -- DRAGON.scr:337
    if ctx:condition("targetHeight > 100") then -- DRAGON.scr:338
        ctx:command("set", "g_nTemp, 0") -- DRAGON.scr:339
    end -- DRAGON.scr:340
    ctx:command("getrandomint", "0,100,g_nRandom") -- DRAGON.scr:342
    ...
    -- endif
    -- endif
    ctx:command("getrandomint", "0, 100, g_nRandom") -- DRAGON.scr:355
    ctx:command("g_ntemp", "= WING_ATTACK_CHANCE") -- DRAGON.scr:357
    -- if ( currTargetDist < 100 )
    -- Set g_nTemp, 5
    -- endif
    -- TEST ->Force it to do breath attack...
    if ctx:condition("g_nRandom > g_nTemp") then -- DRAGON.scr:364
        ctx:command("canattack", "g_bTemp") -- DRAGON.scr:365
        ...
        ctx:command("canattack", "g_bTemp") -- DRAGON.scr:372
...
script.labels["TargetDead"] = function(ctx)
    -- DRAGON.scr:384
    ctx:command("target", "NULL") -- DRAGON.scr:386
    ctx:command("set", "g_hTarget, NULL") -- DRAGON.scr:387
    ...
    ctx:command("set", "g_hTarget, hFoundTarget") -- DRAGON.scr:395
...
script.labels["SetupAttack"] = function(ctx)
    -- DRAGON.scr:404
    ctx:command("getrandomfloat", "MIN_ATTACK_WAIT, MAX_ATTACK_WAIT, random") -- DRAGON.scr:407
    ctx:command("ontargetdead", "TargetDead") -- DRAGON.scr:409
    ctx:command("wait", "ATTACK_WAIT_NBR, random, DoAttack") -- DRAGON.scr:411
...
script.labels["SetupWingAttack"] = function(ctx)
    -- DRAGON.scr:429
    ctx:command("getrandomfloat", "MIN_WING_ATTACK_WAIT, MAX_WING_ATTACK_WAIT, random") -- DRAGON.scr:432
    ctx:command("ontargetdead", "TargetDead") -- DRAGON.scr:433
    ctx:command("wait", "ATTACK_WAIT_NBR, random, DoCloseAttack") -- DRAGON.scr:434
    do return ctx:exit("") end -- DRAGON.scr:436
end

script.labels["SetupPostWingAttack"] = function(ctx)
    -- DRAGON.scr:439
    ctx:command("ontargetdead", "TargetDead") -- DRAGON.scr:442
...
script.labels["WakingUpDamage"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=hObject") then -- DRAGON.scr:461
        ctx:command("breakobjectlink", "hWakeUpTarget") -- DRAGON.scr:462
        ctx:command("createobjectlink", "hObject") -- DRAGON.scr:463
    end -- DRAGON.scr:464
...
script.labels["OnDamage"] = function(ctx)
    ...
    if ctx:condition("hLastAttacker!=hObject") then -- DRAGON.scr:478
        ctx:command("set", "hLastAttacker, hObject") -- DRAGON.scr:479
        ctx:command("createobjectlink", "hLastAttacker") -- DRAGON.scr:480
    end -- DRAGON.scr:481
    -- See if we want to switch targets..
    -- For now, always switch target...
    if ctx:condition("g_hTarget==NULL") then -- DRAGON.scr:486
        ctx:command("set", "g_hTarget, hObject") -- DRAGON.scr:487
        ...
        if ctx:condition("hObject!=g_hTarget") then -- DRAGON.scr:491
            ...
            ctx:command("getrandomint", "0, 100, g_nRandom") -- DRAGON.scr:493
            if ctx:condition("g_nRandom > 80") then -- DRAGON.scr:494
                ctx:command("add", "switchHurryTime, 0.5") -- DRAGON.scr:495
            end -- DRAGON.scr:496
        end -- DRAGON.scr:497
    end -- DRAGON.scr:498
...
script.labels["ArrayFind"] = function(ctx)
    ...
    ctx:command("set", "g_nCounter, 0") -- DRAGON.scr:534
    ctx:command("set", "nArrayFindIndex, -1") -- DRAGON.scr:535
    while ctx:condition("g_nCounter < nTargetsFound") do -- DRAGON.scr:537
        ctx:command("arrayget", "hTargetArray, g_nCounter, g_hObject") -- DRAGON.scr:538
        if ctx:condition("g_hObject==hArrayFind") then -- DRAGON.scr:540
            ctx:command("set", "nArrayFindIndex, g_nCounter") -- DRAGON.scr:541
            do return ctx:exit("") end -- DRAGON.scr:542
        end -- DRAGON.scr:543
        ctx:command("add", "g_nCounter, 1") -- DRAGON.scr:545
    end -- DRAGON.scr:546
...
script.labels["CheckClearShot"] = function(ctx)
    ...
    -- input:	hFoundTarget
    -- output: bClearShot
    ctx:command("set", "bClearShot, FALSE") -- DRAGON.scr:562
    ctx:command("isclearshot", "hFoundTarget, bClearShot") -- DRAGON.scr:564
    if ctx:condition("bClearShot==FALSE") then -- DRAGON.scr:566
        -- Randomly decide if we should target them
        -- anyway...
        ctx:command("getrandomint", "0,100,g_nRandom") -- DRAGON.scr:569
        if ctx:condition("g_nRandom < NO_CLEAR_SHOT_IGNORE_CHANCE") then -- DRAGON.scr:570
            ctx:command("set", "bClearShot, FALSE") -- DRAGON.scr:571
...
script.labels["FindTarget"] = function(ctx)
    ...
    -- DebugOut XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    ctx:command("set", "hFoundTarget, NULL") -- DRAGON.scr:594
    ...
    -- most damage...
    ctx:command("getrandomint", "0, 100, g_nRandom") -- DRAGON.scr:605
    ctx:command("set", "nTargetsFound, 0") -- DRAGON.scr:606
    ctx:command("set", "g_nTemp, 50") -- DRAGON.scr:608
    if ctx:condition("g_hTarget!=hLastAttacker") then -- DRAGON.scr:610
        ...
        ctx:command("set", "g_nTemp, 20") -- DRAGON.scr:613
    end -- DRAGON.scr:614
    if ctx:condition("g_nRandom < 50") then -- DRAGON.scr:616
        ctx:command("findtargets", "hTargetArray,MAX_TARGETS,nTargetsFound,WING_ATTACK_DIST,0") -- DRAGON.scr:617
    end -- DRAGON.scr:618
    if ctx:condition("nTargetsFound==0") then -- DRAGON.scr:620
        ctx:command("findtargets", "hTargetArray,MAX_TARGETS,nTargetsFound,0,0") -- DRAGON.scr:621
    else -- DRAGON.scr:622
    ...
    -- priority....
    ctx:command("set", "hArrayFind, hLastAttacker") -- DRAGON.scr:637
    ...
    if ctx:condition("nArrayFindIndex!=-1") then -- DRAGON.scr:640
        ...
        ctx:command("set", "g_nTemp, nArrayFindIndex") -- DRAGON.scr:642
        ctx:command("div", "g_nTemp, nTargetsFound") -- DRAGON.scr:643
        ctx:command("mul", "g_nTemp, 100") -- DRAGON.scr:644
        ctx:command("add", "g_nTemp, 15") -- DRAGON.scr:646
        ctx:command("getrandomint", "0, 100, g_nRandom") -- DRAGON.scr:648
        if ctx:condition("g_nRandom > g_nTemp") then -- DRAGON.scr:650
            -- Use last attacker...
            ctx:command("set", "hFoundTarget, hLastAttacker") -- DRAGON.scr:652
            ctx:command("aigetdistance", "hFoundTarget, g_nTemp") -- DRAGON.scr:654
            if ctx:condition("g_nTemp >= BREATH_ATTACK_DIST") then -- DRAGON.scr:656
                ...
                if ctx:condition("bClearShot==FALSE") then -- DRAGON.scr:658
                    ctx:command("set", "hFoundTarget, NULL") -- DRAGON.scr:659
                end -- DRAGON.scr:660
            end -- DRAGON.scr:661
    ...
    while ctx:condition("g_nCounter < nTargetsFound") do -- DRAGON.scr:683
        ...
        ctx:command("aigetdistance", "hFoundTarget, g_nTemp") -- DRAGON.scr:700
...
script.labels["FindTargetNext"] = function(ctx)
    -- DRAGON.scr:725
    ctx:command("add", "g_nCounter, 1") -- DRAGON.scr:727
...
script.labels["MaybeSwitchTarget"] = function(ctx)
    ...
    -- or not..
    ctx:command("gettime", "g_nTemp") -- DRAGON.scr:747
    -- See if it's too soon to switch targets....
    ctx:command("sub", "g_nTemp, MIN_SAME_TARGET_TIME") -- DRAGON.scr:750
    ctx:command("add", "g_nTemp, switchHurryTime") -- DRAGON.scr:751
    ...
    ctx:command("set", "switchChance, 20") -- DRAGON.scr:770
    ctx:command("aigetdistance", "g_hTarget, currTargetDist") -- DRAGON.scr:772
    ctx:command("aigetdistance", "hFoundTarget, foundTargetDist") -- DRAGON.scr:773
    if ctx:condition("currTargetDist > foundTargetDist") then -- DRAGON.scr:775
        ctx:command("set", "switchChance, 80") -- DRAGON.scr:776
    end -- DRAGON.scr:777
    if ctx:condition("hFoundTarget==hLastAttacker") then -- DRAGON.scr:779
        ctx:command("add", "switchChance, 45") -- DRAGON.scr:780
    end -- DRAGON.scr:781
    ctx:command("gettime", "g_nTemp") -- DRAGON.scr:783
    ctx:command("sub", "g_nTemp, MAX_SAME_TARGET_TIME") -- DRAGON.scr:785
    ctx:command("add", "g_nTemp, switchHurryTime") -- DRAGON.scr:786
    ...
    ctx:command("getrandomint", "0, 100, random") -- DRAGON.scr:792
...
script.labels["NewTarget"] = function(ctx)
    -- DRAGON.scr:799
    ctx:command("set", "g_hTarget, hFoundTarget") -- DRAGON.scr:802
...
script.labels["SetupNewTarget"] = function(ctx)
    -- DRAGON.scr:809
    ctx:command("gettime", "lastTargetSwitch") -- DRAGON.scr:812
    ctx:command("set", "switchHurryTime, 0") -- DRAGON.scr:813
    ctx:command("target", "g_hTarget, TRUE") -- DRAGON.scr:814
...
script.labels["DragonAwake"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=NULL") then -- DRAGON.scr:824
        ctx:command("set", "g_hTarget, hWakeUpTarget") -- DRAGON.scr:825
    end -- DRAGON.scr:826
    ctx:command("ondamage", "OnDamage") -- DRAGON.scr:828
    ctx:command("onlosttarget", "OnLostTarget") -- DRAGON.scr:829
    ctx:command("onfoundtarget", "OnFoundTarget, MAX_ATTACK_DIST") -- DRAGON.scr:830
    -- jsl--> I think we just want to find a target normal, ie: doesn't HAVE to
    -- be the guy that just shot us...
    ctx:command("set", "g_hTarget, NULL") -- DRAGON.scr:836
    if ctx:condition("g_hTarget==NULL") then -- DRAGON.scr:838
        ...
        if ctx:condition("hFoundTarget==NULL") then -- DRAGON.scr:842
            ctx:command("setidle", "") -- DRAGON.scr:843
            do return ctx:exit("") end -- DRAGON.scr:844
        end -- DRAGON.scr:845
        ctx:command("set", "g_hTarget, hFoundTarget") -- DRAGON.scr:847
    end -- DRAGON.scr:848
...
script.labels["DamageWakeUp"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=0") then -- DRAGON.scr:860
        ctx:command("createobjectlink", "hWakeUpTarget") -- DRAGON.scr:861
    end -- DRAGON.scr:862
...
script.labels["WakeUpTrigger"] = function(ctx)
    ...
    if ctx:condition("hWakeUpTarget!=0") then -- DRAGON.scr:873
        ctx:command("createobjectlink", "hWakeUpTarget") -- DRAGON.scr:874
    end -- DRAGON.scr:875
...
script.labels["WakeUp"] = function(ctx)
    ...
    ctx:command("onfoundplayer", "") -- DRAGON.scr:888
    ctx:command("onattackready", "") -- DRAGON.scr:889
    ctx:command("ondamage", "WakingUpDamage") -- DRAGON.scr:890
    ctx:command("playanim", "WakeUp, DragonAwake") -- DRAGON.scr:892
...
script.labels["SetupSleeping"] = function(ctx)
    ...
    ctx:command("loopanim", "Sleep,0") -- DRAGON.scr:904
    -- When we find the player, we'll need to wake up...
    ctx:command("ondamage", "DamageWakeUp") -- DRAGON.scr:907
...
script.labels["OnObjectLinkBroken"] = function(ctx)
    ...
    if ctx:condition("hObject==hWakeUpTarget") then -- DRAGON.scr:926
        ctx:command("set", "hWakeUpTarget, NULL") -- DRAGON.scr:927
    end -- DRAGON.scr:928
    if ctx:condition("hObject==hLastAttacker") then -- DRAGON.scr:930
        ctx:command("set", "hLastAttacker, NULL") -- DRAGON.scr:931
    end -- DRAGON.scr:932
    if ctx:condition("hObject==g_hTarget") then -- DRAGON.scr:934
        ctx:command("target", "NULL") -- DRAGON.scr:935
        ctx:command("set", "g_hTarget, NULL") -- DRAGON.scr:936
    end -- DRAGON.scr:937
...
script.labels["OnTest"] = function(ctx)
    -- DRAGON.scr:942
    ctx:command("playanim", "rAttack2, AttackDone") -- DRAGON.scr:945
    do return ctx:exit("") end -- DRAGON.scr:948
end

script.labels["TargetTooFar"] = function(ctx)
    -- DRAGON.scr:951
    ctx:command("target", "NULL") -- DRAGON.scr:954
    ctx:command("set", "g_hTarget, NULL") -- DRAGON.scr:955
    mm9.gosub(script, ctx, "ClearAttackTimer") -- DRAGON.scr:956
    ctx:command("setidle", "") -- DRAGON.scr:957
    ctx:command("ontargetbeyonddist", "MAX_ATTACK_DIST, TargetTooFar") -- DRAGON.scr:958
...
script.labels["SpawnMutants"] = function(ctx)
    -- DRAGON.scr:976
    ctx:command("spawn_interval", "= SPAWN_INTERVAL * 2") -- DRAGON.scr:982
    ctx:command("wait", "22,SPAWN_INTERVAL,SpawnMutants") -- DRAGON.scr:984
    ctx:command("getobjecthandle", "MutantMarker0,g_hObject") -- DRAGON.scr:986
    if ctx:condition("g_hObject!=NULL") then -- DRAGON.scr:988
        ctx:command("getpos", "g_hObject,x,y,z") -- DRAGON.scr:989
        ctx:command("spawn", "g_hObject,x,y,z,SpawnCmd") -- DRAGON.scr:990
        if ctx:condition("g_hObject!=NULL") then -- DRAGON.scr:991
            ctx:trigger("g_hObject", "GetMe") -- DRAGON.scr:992
        end -- DRAGON.scr:993
    end -- DRAGON.scr:994
    ctx:command("getobjecthandle", "MutantMarker1,g_hObject") -- DRAGON.scr:996
    if ctx:condition("g_hObject!=NULL") then -- DRAGON.scr:998
        ctx:command("getpos", "g_hObject,x,y,z") -- DRAGON.scr:999
        ctx:command("spawn", "g_hObject,x,y,z,SpawnCmd") -- DRAGON.scr:1000
...
script.labels["NormalSetup"] = function(ctx)
    -- DRAGON.scr:1009
    ctx:command("getstat", "g_hMyObject, VisibleRange, g_nTemp") -- DRAGON.scr:1011
    ...
    if ctx:condition("g_nTemp > MAX_ATTACK_DIST") then -- DRAGON.scr:1015
        ...
        ctx:command("set", "MAX_ATTACK_DIST, g_nTemp") -- DRAGON.scr:1017
    end -- DRAGON.scr:1018
    ctx:command("oncongestion", "OnCongestion") -- DRAGON.scr:1020
    ctx:command("onobjectlinkbroken", "OnObjectLinkBroken") -- DRAGON.scr:1021
    ctx:command("ontargetwithindist", "WING_ATTACK_DIST, TargetWithinWindDist") -- DRAGON.scr:1022
    ctx:command("ontargetbeyonddist", "MAX_ATTACK_DIST, TargetTooFar") -- DRAGON.scr:1023
    ...
    ctx:command("getdims", "g_hMyObject, dimsX, dimsY, dimsZ") -- DRAGON.scr:1030
    ctx:command("ondamage", "OnDamage") -- DRAGON.scr:1032
    ctx:command("onlosttarget", "OnLostTarget") -- DRAGON.scr:1033
    ctx:command("onfoundtarget", "OnFoundTarget, MAX_ATTACK_DIST") -- DRAGON.scr:1034
    ctx:command("wait", "22,SPAWN_INTERVAL,SpawnMutants") -- DRAGON.scr:1036
    do return ctx:exit("") end -- DRAGON.scr:1038
end

script.labels["TauntDone"] = function(ctx)
    -- DRAGON.scr:1042
    ctx:command("stop", "") -- DRAGON.scr:1044
    ctx:command("setidle", "") -- DRAGON.scr:1045
    mm9.gosub(script, ctx, "NormalSetup") -- DRAGON.scr:1046
    ctx:command("getplayerhandle", "g_hTarget") -- DRAGON.scr:1048
...
script.labels["OnLanded"] = function(ctx)
    -- DRAGON.scr:1057
    ctx:command("playanim", "Taunt, TauntDone") -- DRAGON.scr:1059
    do return ctx:exit("") end -- DRAGON.scr:1061
end

script.labels["OnTrigger"] = function(ctx)
    -- DRAGON.scr:1064
    ctx:command("removetrigger", "Trigger") -- DRAGON.scr:1066
    ctx:command("setflag", "g_hMyObject, FLAG_VISIBLE") -- DRAGON.scr:1068
    ctx:command("setflag", "g_hMyObject, FLAG_SOLID") -- DRAGON.scr:1069
    ctx:command("playanim", "Land, OnLanded") -- DRAGON.scr:1071
...
script.labels["HideSetup"] = function(ctx)
    -- DRAGON.scr:1078
    ctx:command("clearflag", "g_hMyObject,FLAG_VISIBLE") -- DRAGON.scr:1081
    ctx:command("clearflag", "g_hMyObject,FLAG_SOLID") -- DRAGON.scr:1082
...
script.labels["DoBreath"] = function(ctx)
    -- DRAGON.scr:1094
    ctx:command("wait", "BREATHING_WAIT,2.5,DoBreath") -- DRAGON.scr:1096
    ctx:command("doclientfx", "g_hMyObject,sDragonSmoke,FALSE,FALSE") -- DRAGON.scr:1098
    do return ctx:exit("") end -- DRAGON.scr:1100
end

script.labels["CacheFiles"] = function(ctx)
    -- DRAGON.scr:1104
    ctx:command("cacheclientfx", "sDragonSmoke") -- DRAGON.scr:1107
...
script.labels["OnDeath"] = function(ctx)
    ...
    ctx:command("isplayer", "g_hObject,g_bTemp") -- DRAGON.scr:1116
...
script.labels["OnGrowl1"] = function(ctx)
    -- DRAGON.scr:1125
    ctx:command("playsound", "sounds\\animsounds\\dragon\\wince1.wav,DoNothing,2000,4000") -- DRAGON.scr:1127
    do return ctx:exit("") end -- DRAGON.scr:1129
end

script.labels["OnGrowl2"] = function(ctx)
    -- DRAGON.scr:1132
    ctx:command("playsound", "sounds\\animsounds\\dragon\\wince2.wav,DoNothing,2000,4000") -- DRAGON.scr:1134
    do return ctx:exit("") end -- DRAGON.scr:1136
end

script.labels["OnHitFloor"] = function(ctx)
    -- DRAGON.scr:1139
    ctx:command("playsound", "sounds\\animsounds\\dragon\\land.wav,DoNothing,2000,4000") -- DRAGON.scr:1141
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("addenemy", "AIBase") -- DRAGON.scr:1158
    ctx:command("getmyhandle", "g_hMyObject") -- DRAGON.scr:1160
    ...
    ctx:command("addmodelkey", "Growl1,OnGrowl1") -- DRAGON.scr:1171
    ctx:command("addmodelkey", "Growl2,OnGrowl2") -- DRAGON.scr:1172
    ctx:command("addmodelkey", "HitFloor,OnHitFloor") -- DRAGON.scr:1173
    ctx:command("oncachefiles", "CacheFiles") -- DRAGON.scr:1174
    mm9.gosub(script, ctx, "CacheFiles") -- DRAGON.scr:1176
    ctx:command("ondeath", "OnDeath") -- DRAGON.scr:1178
