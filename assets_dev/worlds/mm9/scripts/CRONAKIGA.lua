...
script.labels["Onuse"] = function(ctx)
    ...
    if ctx:condition("hTrigger==0") then -- CRONAKIGA.scr:23
        ctx:command("getobjecthandle", "sTriggerName, hTrigger") -- CRONAKIGA.scr:24
    ...
    if ctx:condition("g_ntemp==1") then -- CRONAKIGA.scr:34
        ...
        if ctx:condition("keycheck==0") then -- CRONAKIGA.scr:37
            ...
            ctx:command("removetrigger", "Use") -- CRONAKIGA.scr:46
            ctx:giveItem(390) -- CRONAKIGA.scr:48
            ctx:giveExp(10000) -- CRONAKIGA.scr:49
            ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- CRONAKIGA.scr:50
            -- SJR
            -- gotta wait to remove object for the
            -- mummy trigger to be sent
            ctx:command("wait", "0, 1, RemoveMe") -- CRONAKIGA.scr:54
            -- SJR
    ...
    if ctx:condition("keycheck==0") then -- CRONAKIGA.scr:61
        ...
        ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- CRONAKIGA.scr:70
        ctx:command("removetrigger", "Use") -- CRONAKIGA.scr:72
        -- SJR
        -- gotta wait to remove object for the
        -- mummy trigger to be sent
        ctx:command("wait", "0, 1, RemoveMe") -- CRONAKIGA.scr:77
        -- SJR
...
script.labels["RemoveMe"] = function(ctx)
    -- CRONAKIGA.scr:86
    ctx:command("getmyhandle", "g_hObject") -- CRONAKIGA.scr:88
    ctx:command("removeobject", "g_hobject") -- CRONAKIGA.scr:89
...
script.labels["Main"] = function(ctx)
    ...
    if ctx:condition("g_ntemp==1") then -- CRONAKIGA.scr:103
        ctx:command("getobjecthandle", "CronaKiga g_hobject") -- CRONAKIGA.scr:104
        ctx:command("removeobject", "g_hobject") -- CRONAKIGA.scr:105
        ctx:command("exitscript", "") -- CRONAKIGA.scr:106
    ...
    if ctx:condition("g_ntemp==1") then -- CRONAKIGA.scr:111
        ctx:command("getobjecthandle", "CronaKiga g_hobject") -- CRONAKIGA.scr:112
        ctx:command("removeobject", "g_hobject") -- CRONAKIGA.scr:113
        ctx:command("exitscript", "") -- CRONAKIGA.scr:114
