...
script.labels["MoveToMarker"] = function(ctx)
    ...
    ctx:cprint("MoveToMarker") -- YF_EXPLODINGFLOOR.scr:31
...
script.labels["DelayAction"] = function(ctx)
    ...
    ctx:self():setFlag("FLAG_GOTHRUWORLD", true) -- YF_EXPLODINGFLOOR.scr:37
    ctx:self():setFlag("FLAG_SOLID", false) -- YF_EXPLODINGFLOOR.scr:38
    ctx:cprint("DelayAction") -- YF_EXPLODINGFLOOR.scr:40
    ctx:wait(0, 1.5, "MoveToMarker") -- YF_EXPLODINGFLOOR.scr:41
...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, .1, "main2") -- YF_EXPLODINGFLOOR.scr:53
