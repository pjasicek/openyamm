...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "InitMummyAwaken") -- MUMMYAWAKEN.scr:31
    do return ctx:exit("TRUE") end -- MUMMYAWAKEN.scr:33
end

script.labels["InitMummyAwaken"] = function(ctx)
    -- MUMMYAWAKEN.scr:36
    ctx:state().hNext = ctx:objectOrNil("sNextName") -- MUMMYAWAKEN.scr:40
    if ctx:condition("hNext!=0") then -- MUMMYAWAKEN.scr:41
        ctx:self():link(ctx:object("hNext")) -- MUMMYAWAKEN.scr:42
        ctx:onEvent("OnObjectLinkBroken", "OnObjectLinkBroken") -- MUMMYAWAKEN.scr:43
    end -- MUMMYAWAKEN.scr:44
    ctx:state().bAnimOk = ctx:self():isClass("Mummy") -- MUMMYAWAKEN.scr:46
    if ctx:condition("bAnimOk==FALSE") then -- MUMMYAWAKEN.scr:47
        ctx:state().bAnimOk = ctx:self():isClass("Zombie") -- MUMMYAWAKEN.scr:48
    end -- MUMMYAWAKEN.scr:49
    if ctx:condition("bAnimOk==TRUE") then -- MUMMYAWAKEN.scr:51
        ctx:self():loopAnimation("coffin", 0) -- MUMMYAWAKEN.scr:52
    end -- MUMMYAWAKEN.scr:53
    if ctx:condition("bNoChain==TRUE") then -- MUMMYAWAKEN.scr:55
        ctx:onEvent("OnDeath", "OnDeath") -- MUMMYAWAKEN.scr:56
    else -- MUMMYAWAKEN.scr:57
        ctx:onEvent("OnDeath", "DoNothing") -- MUMMYAWAKEN.scr:58
    end -- MUMMYAWAKEN.scr:59
    ctx:addTrigger("awaken", "WakeUp") -- MUMMYAWAKEN.scr:61
    ctx:onEvent("OnDamage", "WakeUp") -- MUMMYAWAKEN.scr:62
...
script.labels["WakeUp"] = function(ctx)
    ...
    ctx:removeTrigger("awaken") -- MUMMYAWAKEN.scr:70
    ctx:onEvent("OnDamage", "DoNothing") -- MUMMYAWAKEN.scr:71
...
script.labels["OnObjectLinkBroken"] = function(ctx)
    -- MUMMYAWAKEN.scr:92
    ctx:state().hNext = nil -- MUMMYAWAKEN.scr:94
