...
script.labels["Stop"] = function(ctx)
    ...
    ctx:self():runTo(ctx:player(), 50, "BaseInit") -- DARKP_WARRIOR.scr:22
...
script.labels["BeginSequence"] = function(ctx)
    ...
    ctx:self():playAnimation("Hattack1", "AnimateC") -- DARKP_WARRIOR.scr:28
...
script.labels["AnimateC"] = function(ctx)
    ...
    ctx:self():playAnimation("Hattack2", "Stop") -- DARKP_WARRIOR.scr:34
    do return ctx:exit("TRUE") end -- DARKP_WARRIOR.scr:35
end

script.labels["Main2"] = function(ctx)
    -- DARKP_WARRIOR.scr:37
    ctx:state().hNpc = ctx:objectOrNil("NPCAdventurer0") -- DARKP_WARRIOR.scr:39
...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, 0.1, "Main2") -- DARKP_WARRIOR.scr:45
