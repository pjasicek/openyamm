...
script.labels["NpcDie"] = function(ctx)
    ...
    ctx:command("playanim", "RAttack1, Killem") -- IS_KILLINGLICH.scr:21
    do return ctx:exit("TRUE") end -- IS_KILLINGLICH.scr:22
end

script.labels["KillNpc"] = function(ctx)
    -- IS_KILLINGLICH.scr:24
    ctx:command("playanim", "Fidget2, NpcDie") -- IS_KILLINGLICH.scr:26
    do return ctx:exit("TRUE") end -- IS_KILLINGLICH.scr:27
end

script.labels["Main2"] = function(ctx)
    -- IS_KILLINGLICH.scr:29
    ctx:command("getobjecthandle", "GreenPartyDude0, hNpc") -- IS_KILLINGLICH.scr:31
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("wait", "0 .1 main2") -- IS_KILLINGLICH.scr:37
