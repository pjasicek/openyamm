...
script.labels["Main"] = function(ctx)
    ...
    ctx:wait(0, .1, "InitPeasantTransformee") -- PEASANTTRANSFORMEE.scr:23
...
script.labels["InitPeasantTransformee"] = function(ctx)
    ...
    ctx:onEvent("OnStuck", "OnStuck") -- PEASANTTRANSFORMEE.scr:32
...
script.labels["WalkToSpawner"] = function(ctx)
    ...
    ctx:state().x, ctx:state().t, ctx:state().z = ctx:object("hSpawner"):pos() -- PEASANTTRANSFORMEE.scr:40
    ctx:state().t, ctx:state().y, ctx:state().t = ctx:self():pos() -- PEASANTTRANSFORMEE.scr:41
    ctx:self():walkToPos("x", "y", "z", 5, "PlayMagicSound") -- PEASANTTRANSFORMEE.scr:43
    do return ctx:exit("TRUE") end -- PEASANTTRANSFORMEE.scr:45
end

script.labels["OnStuck"] = function(ctx)
    -- PEASANTTRANSFORMEE.scr:48
    ctx:self():stop() -- PEASANTTRANSFORMEE.scr:50
    ctx:wait(0, 1, "Continue") -- PEASANTTRANSFORMEE.scr:51
    do return ctx:exit("TRUE") end -- PEASANTTRANSFORMEE.scr:53
end

script.labels["Continue"] = function(ctx)
    -- PEASANTTRANSFORMEE.scr:56
    ctx:self():walkToPos("x", "y", "z", 5, "PlayMagicSound") -- PEASANTTRANSFORMEE.scr:58
    do return ctx:exit("TRUE") end -- PEASANTTRANSFORMEE.scr:60
end

script.labels["PlayMagicSound"] = function(ctx)
    -- PEASANTTRANSFORMEE.scr:63
    ctx:self():stop() -- PEASANTTRANSFORMEE.scr:65
    ctx:self():loopAnimation("cower", 1, "TriggerSpawner") -- PEASANTTRANSFORMEE.scr:66
    ctx:playSound("sounds\\magic\\wizardeyeloop.wav", "DoNothing", 1, 1000, "FALSE", 100) -- PEASANTTRANSFORMEE.scr:67
    do return ctx:exit("TRUE") end -- PEASANTTRANSFORMEE.scr:69
end

script.labels["TriggerSpawner"] = function(ctx)
    -- PEASANTTRANSFORMEE.scr:72
    ctx:playSound("sounds\\animsounds\\pig\\wince1.wav", "DoNothing", 1, 500, "FALSE", 100) -- PEASANTTRANSFORMEE.scr:74
