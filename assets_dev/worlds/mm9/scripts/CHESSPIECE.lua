...
script.labels["Main"] = function(ctx)
    ...
    while ctx:condition("nLocation>=BOARDSIZE") do -- CHESSPIECE.scr:59
        ctx:command("nlocation", "= nLocation - BOARDSIZE") -- CHESSPIECE.scr:60
        ctx:command("zme", "= zMe + 1") -- CHESSPIECE.scr:61
    end -- CHESSPIECE.scr:62
    ctx:command("xme", "= nLocation") -- CHESSPIECE.scr:63
    ctx:command("nlocation", "= BOARDSIZE * zMe + xMe") -- CHESSPIECE.scr:64
    ctx:command("listname", "= sSquareName") -- CHESSPIECE.scr:66
    ctx:command("listfirst", "= 0") -- CHESSPIECE.scr:67
    ctx:command("listlast", "= BOARDSIZE * BOARDSIZE - 1") -- CHESSPIECE.scr:68
    ctx:command("sizeindex", "= BOARDSIZE - 1") -- CHESSPIECE.scr:69
    ctx:command("onpoststartworld", "InitChessPiece") -- CHESSPIECE.scr:71
    do return ctx:exit("TRUE") end -- CHESSPIECE.scr:73
end

script.labels["InitChessPiece"] = function(ctx)
    -- CHESSPIECE.scr:79
    ctx:command("setcallback", "TYPE_PAWN  , CheckPawnPath") -- CHESSPIECE.scr:81
    ctx:command("setcallback", "TYPE_KNIGHT, CheckKnightPath") -- CHESSPIECE.scr:82
    ctx:command("setcallback", "TYPE_BISHOP, CheckBishopPath") -- CHESSPIECE.scr:83
    ...
    ctx:command("getobjecthandle", "CinemaMgr, hCamera") -- CHESSPIECE.scr:90
    ctx:command("getmyhandle", "hMe") -- CHESSPIECE.scr:91
    ctx:command("getpos", "hMe, nTemp,cy,nTemp") -- CHESSPIECE.scr:92
...
script.labels["CheckBoard"] = function(ctx)
    ...
    ctx:command("docallback", "nPieceType") -- CHESSPIECE.scr:100
...
script.labels["HostileMove"] = function(ctx)
    ...
    ctx:command("removetrigger", "Ping") -- CHESSPIECE.scr:118
    mm9.gosub(script, ctx, "StartAttack") -- CHESSPIECE.scr:119
    ctx:command("nlocation", "= LISTINDEX") -- CHESSPIECE.scr:120
    ctx:command("zme", "= 0") -- CHESSPIECE.scr:121
    -- convert 1-D coordinates to 2-D
    while ctx:condition("nLocation>=BOARDSIZE") do -- CHESSPIECE.scr:123
        ctx:command("nlocation", "= nLocation - BOARDSIZE") -- CHESSPIECE.scr:124
        ctx:command("zme", "= zMe + 1") -- CHESSPIECE.scr:125
    end -- CHESSPIECE.scr:126
    ctx:command("xme", "= nLocation") -- CHESSPIECE.scr:127
    ctx:command("nlocation", "= LISTINDEX") -- CHESSPIECE.scr:128
...
script.labels["StartAttack"] = function(ctx)
    ...
    ctx:command("clearflag", "hMe, FLAG_SOLID") -- CHESSPIECE.scr:136
    ctx:command("setflag", "hMe, FLAG_GOTHRUWORLD") -- CHESSPIECE.scr:137
    ctx:command("playsound", "sounds\\door\\doorslidestone.wav, DoNothing, 1000, 2000, FALSE, 100") -- CHESSPIECE.scr:138
    if ctx:condition("hPlayer==0") then -- CHESSPIECE.scr:139
        ctx:command("getplayerhandle", "hPlayer") -- CHESSPIECE.scr:140
    end -- CHESSPIECE.scr:141
    ctx:command("getpos", "hPlayer, cx,nTemp,cz") -- CHESSPIECE.scr:142
    ctx:command("movetopos", "cx,cy,cz, 128, FinishAttack") -- CHESSPIECE.scr:143
...
script.labels["RemoveFloor"] = function(ctx)
    -- CHESSPIECE.scr:148
    ctx:command("listname", "= sFloorName") -- CHESSPIECE.scr:150
    mm9.gosub(script, ctx, "GetCurrentObject") -- CHESSPIECE.scr:151
    ctx:command("htrigger", "= LISTOBJECT") -- CHESSPIECE.scr:152
    ctx:command("clearflag", "hTrigger, FLAG_SOLID") -- CHESSPIECE.scr:153
    do return ctx:exit("TRUE") end -- CHESSPIECE.scr:154
end

script.labels["FinishAttack"] = function(ctx)
    -- CHESSPIECE.scr:157
    ctx:command("setvelocity", "hPlayer, 0, -1, 0") -- CHESSPIECE.scr:159
    ctx:trigger("hCamera", "TurnOff") -- CHESSPIECE.scr:160
    ctx:command("setflag", "hMe, FLAG_SOLID") -- CHESSPIECE.scr:161
    ctx:command("clearflag", "hMe, FLAG_GOTHRUWORLD") -- CHESSPIECE.scr:162
    ctx:command("listname", "= sSquareName") -- CHESSPIECE.scr:163
    ctx:command("getpos", "hTrigger, cx,nTemp,cz") -- CHESSPIECE.scr:164
    ctx:command("setpos", "hMe, cx,cy,cz") -- CHESSPIECE.scr:165
    ctx:addTrigger("Ping", "CheckBoard") -- CHESSPIECE.scr:166
    ctx:command("setflag", "hTrigger, FLAG_SOLID") -- CHESSPIECE.scr:167
...
script.labels["CheckPawnPath"] = function(ctx)
    ...
    ctx:command("listindex", "= zMe + 1 * BOARDSIZE + xMe - 1") -- CHESSPIECE.scr:184
    ...
    if ctx:condition("xMe!=SIZEINDEX") then -- CHESSPIECE.scr:195
        ctx:command("listindex", "= LISTINDEX + 2") -- CHESSPIECE.scr:196
...
script.labels["CheckKnightPath"] = function(ctx)
    ...
    ctx:command("nsquares", "= 8") -- CHESSPIECE.scr:211
    ctx:command("dx", "= 1") -- CHESSPIECE.scr:212
    ctx:command("dz", "= 2") -- CHESSPIECE.scr:213
    ...
    while ctx:condition("nSquares>0") do -- CHESSPIECE.scr:216
        ...
        if ctx:condition("nSquares==4") then -- CHESSPIECE.scr:219
            ctx:command("dx", "= 2") -- CHESSPIECE.scr:220
            ctx:command("dz", "= 1") -- CHESSPIECE.scr:221
        end -- CHESSPIECE.scr:222
        ctx:command("ztemp", "= zMe + dz") -- CHESSPIECE.scr:224
        ...
        if ctx:condition("zTemp<BOARDSIZE") then -- CHESSPIECE.scr:226
            if ctx:condition("zTemp>=0") then -- CHESSPIECE.scr:227
                ...
                ctx:command("xtemp", "= xMe + dx") -- CHESSPIECE.scr:229
                ...
                if ctx:condition("xTemp<BOARDSIZE") then -- CHESSPIECE.scr:231
                    if ctx:condition("xTemp >= 0") then -- CHESSPIECE.scr:232
                        ...
                        ctx:command("listindex", "= BOARDSIZE * zTemp + xMe + dx") -- CHESSPIECE.scr:234
                ...
                ctx:command("xtemp", "= xMe - dx") -- CHESSPIECE.scr:243
                ...
                if ctx:condition("xTemp<BOARDSIZE") then -- CHESSPIECE.scr:246
                    if ctx:condition("xTemp>=0") then -- CHESSPIECE.scr:247
                        -- change index coords to plane coords
                        ctx:command("listindex", "= BOARDSIZE * zTemp + xMe - dx") -- CHESSPIECE.scr:249
        ...
        ctx:command("dz", "= dz * -1") -- CHESSPIECE.scr:261
        ctx:command("nsquares", "= nSquares - 2") -- CHESSPIECE.scr:263
...
script.labels["CheckBishopPath"] = function(ctx)
    ...
    ctx:command("ncheckdir", "= 1") -- CHESSPIECE.scr:274
    mm9.gosub(script, ctx, "CheckDiagonal") -- CHESSPIECE.scr:275
    -- check the (0,N)->(N,0) direction
    ctx:command("ncheckdir", "= -1") -- CHESSPIECE.scr:278
...
script.labels["CheckDiagonal"] = function(ctx)
    ...
    ctx:command("diagsize", "= BOARDSIZE * nCheckDir + 1") -- CHESSPIECE.scr:293
    ctx:command("listindex", "= zTemp * BOARDSIZE + xTemp") -- CHESSPIECE.scr:294
    while ctx:condition("nSquares>0") do -- CHESSPIECE.scr:296
        ctx:command("nsquares", "= nSquares - 1") -- CHESSPIECE.scr:297
        ...
        ctx:command("listindex", "= LISTINDEX + DIAGSIZE") -- CHESSPIECE.scr:307
...
script.labels["NormalizeDiagonal"] = function(ctx)
    ...
    ctx:command("xtemp", "= xMe") -- CHESSPIECE.scr:317
    ctx:command("ztemp", "= zMe") -- CHESSPIECE.scr:318
    if ctx:condition("nCheckDir>0") then -- CHESSPIECE.scr:320
        if ctx:condition("xTemp==zTemp") then -- CHESSPIECE.scr:321
            ctx:command("xtemp", "= 0") -- CHESSPIECE.scr:322
            ctx:command("ztemp", "= 0") -- CHESSPIECE.scr:323
        end -- CHESSPIECE.scr:324
        if ctx:condition("xTemp>zTemp") then -- CHESSPIECE.scr:325
            ctx:command("xtemp", "= xTemp - zTemp") -- CHESSPIECE.scr:326
            ctx:command("ztemp", "= 0") -- CHESSPIECE.scr:327
        end -- CHESSPIECE.scr:328
        if ctx:condition("xTemp<zTemp") then -- CHESSPIECE.scr:329
            ctx:command("ztemp", "= zTemp - xTemp") -- CHESSPIECE.scr:330
            ctx:command("xtemp", "= 0") -- CHESSPIECE.scr:331
        end -- CHESSPIECE.scr:332
    end -- CHESSPIECE.scr:333
    if ctx:condition("nCheckDir<0") then -- CHESSPIECE.scr:334
        ctx:command("ntemp", "=\tSIZEINDEX - xTemp - zTemp") -- CHESSPIECE.scr:335
        if ctx:condition("nTemp == 0") then -- CHESSPIECE.scr:336
            ctx:command("xtemp", "= 0") -- CHESSPIECE.scr:337
            ctx:command("ztemp", "= SIZEINDEX") -- CHESSPIECE.scr:338
        end -- CHESSPIECE.scr:339
        if ctx:condition("nTemp<0") then -- CHESSPIECE.scr:340
            ctx:command("xtemp", "= xTemp - BOARDSIZE + zTemp + 1") -- CHESSPIECE.scr:341
            ctx:command("ztemp", "= SIZEINDEX") -- CHESSPIECE.scr:342
        end -- CHESSPIECE.scr:343
        if ctx:condition("nTemp>0") then -- CHESSPIECE.scr:344
            ctx:command("ztemp", "= xTemp + zTemp") -- CHESSPIECE.scr:345
            if ctx:condition("zTemp<0") then -- CHESSPIECE.scr:346
                ctx:command("ztemp", "= zTemp * -1") -- CHESSPIECE.scr:347
            end -- CHESSPIECE.scr:348
            ctx:command("xtemp", "= 0") -- CHESSPIECE.scr:349
        end -- CHESSPIECE.scr:350
    end -- CHESSPIECE.scr:351
    if ctx:condition("xTemp==0") then -- CHESSPIECE.scr:352
        ctx:command("nsquares", "= BOARDSIZE - zTemp") -- CHESSPIECE.scr:353
    end -- CHESSPIECE.scr:354
    if ctx:condition("zTemp==0") then -- CHESSPIECE.scr:355
        ctx:command("nsquares", "= BOARDSIZE - xTemp") -- CHESSPIECE.scr:356
    end -- CHESSPIECE.scr:357
    if ctx:condition("zTemp==SIZEINDEX") then -- CHESSPIECE.scr:358
        ctx:command("nsquares", "= BOARDSIZE - xTemp") -- CHESSPIECE.scr:359
...
script.labels["CheckForQueen"] = function(ctx)
    ...
    if ctx:condition("zMe==SIZEINDEX") then -- CHESSPIECE.scr:368
        ctx:command("getpos", "hMe, xMe,yMe,zMe") -- CHESSPIECE.scr:369
        ctx:command("spawn", "hDummy, xMe,yMe,zMe, Eye") -- CHESSPIECE.scr:370
        ctx:command("removeobject", "hMe") -- CHESSPIECE.scr:371
