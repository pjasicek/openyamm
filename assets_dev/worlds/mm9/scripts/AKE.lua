...
script.labels["Onblabber"] = function(ctx)
    ...
    ctx:command("target", "g_hobject") -- AKE.scr:27
    if ctx:condition("shutup==1") then -- AKE.scr:29
        do return mm9.gotoLabel(script, ctx, "Onexit") end -- AKE.scr:30
    end -- AKE.scr:31
    ctx:command("killsound", "soundhandle") -- AKE.scr:32
    ctx:command("getrandomint", "5, 10, knutwait") -- AKE.scr:33
    ctx:command("wait", "1 knutwait, blabber") -- AKE.scr:34
...
script.labels["blabber"] = function(ctx)
    -- AKE.scr:42
    -- plays random heckle
    ctx:command("set", "sound, 1") -- AKE.scr:48
    if ctx:condition("g_ntemp==1") then -- AKE.scr:49
        ctx:command("converse", "-1 DoNothing") -- AKE.scr:50
        ctx:command("playsoundhandle", "voices\\cinema\\socialism\\ake01.wav, soundhandle, 768, FALSE, 100") -- AKE.scr:51
        ctx:command("getsoundduration", ", soundhandle, sounddur") -- AKE.scr:52
        ctx:command("set", "g_ntemp, 2") -- AKE.scr:53
        ctx:command("wait", "1 sounddur, Onblabber") -- AKE.scr:54
        do return ctx:exit("") end -- AKE.scr:55
    end -- AKE.scr:56
    if ctx:condition("g_ntemp==2") then -- AKE.scr:58
        ctx:command("converse", "-1 DoNothing") -- AKE.scr:59
        ctx:command("playsoundhandle", "voices\\cinema\\socialism\\ake02.wav, soundhandle, 768, FALSE, 100") -- AKE.scr:60
        ctx:command("getsoundduration", ", soundhandle, sounddur") -- AKE.scr:61
        ctx:command("set", "g_ntemp, 3") -- AKE.scr:62
        ctx:command("wait", "1 sounddur, Onblabber") -- AKE.scr:63
        do return ctx:exit("") end -- AKE.scr:64
    end -- AKE.scr:65
    if ctx:condition("g_ntemp==3") then -- AKE.scr:67
        ctx:command("converse", "-1 DoNothing") -- AKE.scr:68
        ctx:command("playsoundhandle", "voices\\cinema\\socialism\\ake03.wav, soundhandle, 768, FALSE, 100") -- AKE.scr:69
        ctx:command("getsoundduration", ", soundhandle, sounddur") -- AKE.scr:70
        ctx:command("set", "g_ntemp, 4") -- AKE.scr:71
        ctx:command("wait", "1 sounddur, Onblabber") -- AKE.scr:72
        do return ctx:exit("") end -- AKE.scr:73
    end -- AKE.scr:74
    if ctx:condition("g_ntemp==4") then -- AKE.scr:76
        ctx:command("converse", "-1 DoNothing") -- AKE.scr:77
        ctx:command("playsoundhandle", "voices\\cinema\\socialism\\ake04.wav, soundhandle, 768, FALSE, 100") -- AKE.scr:78
        ctx:command("getsoundduration", ", soundhandle, sounddur") -- AKE.scr:79
        ctx:command("set", "g_ntemp, 5") -- AKE.scr:80
        ctx:command("wait", "1 sounddur, Onblabber") -- AKE.scr:81
        do return ctx:exit("") end -- AKE.scr:82
    end -- AKE.scr:83
    if ctx:condition("g_ntemp==5") then -- AKE.scr:84
        ctx:command("converse", "-1 DoNothing") -- AKE.scr:85
        ctx:command("playsoundhandle", "voices\\cinema\\socialism\\ake05.wav, soundhandle, 768, FALSE, 100") -- AKE.scr:86
        ctx:command("getsoundduration", ", soundhandle, sounddur") -- AKE.scr:87
        ctx:command("set", "g_ntemp, 1") -- AKE.scr:88
        ctx:command("wait", "1 sounddur, Onblabber") -- AKE.scr:89
...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:condition("sound==1") then -- AKE.scr:105
        ctx:command("killsound", "soundhandle") -- AKE.scr:106
        ctx:command("set", "sound, 0") -- AKE.scr:108
        ctx:command("set", "g_ntemp, 0") -- AKE.scr:109
    end -- AKE.scr:110
    -- start rude dialog
    -- DoRude 261
...
script.labels["Onexit"] = function(ctx)
    ...
    ctx:command("set", "shutup, 1") -- AKE.scr:122
    ctx:command("issounddone", "soundhandle, sounddone") -- AKE.scr:123
    if ctx:condition("sounddone==1") then -- AKE.scr:124
        ctx:command("killsound", "soundhandle") -- AKE.scr:125
    end -- AKE.scr:126
...
script.labels["GoPosition1"] = function(ctx)
    -- AKE.scr:132
    ctx:command("setpos", "g_hMyObject,3328.0,1344.0,-480.0") -- AKE.scr:134
    ctx:command("facedir", "0,0,0,0") -- AKE.scr:135
    do return ctx:exit("") end -- AKE.scr:137
end

script.labels["GoPosition2"] = function(ctx)
    -- AKE.scr:140
    ctx:command("setpos", "g_hMyObject,3557,1254,3331") -- AKE.scr:142
    ctx:command("facedir", "-0.62,0,-0.79,0") -- AKE.scr:143
    do return ctx:exit("") end -- AKE.scr:145
end

script.labels["GoPosition3"] = function(ctx)
    -- AKE.scr:148
    ctx:command("setpos", "g_hMyObject,-720,1246,2166") -- AKE.scr:151
    ctx:command("facedir", "-0.7,0,-0.7,0") -- AKE.scr:152
    do return ctx:exit("") end -- AKE.scr:154
end

script.labels["GoPosition4"] = function(ctx)
    -- AKE.scr:157
    ctx:command("setpos", "g_hMyObject,-2176,1246,4711") -- AKE.scr:160
    ctx:command("facedir", "-0.54,0,-0.84,0") -- AKE.scr:161
    do return ctx:exit("") end -- AKE.scr:163
end

script.labels["SetupPosition"] = function(ctx)
    -- AKE.scr:167
    ctx:command("getmyhandle", "g_hMyObject") -- AKE.scr:170
    ctx:command("add", "nPosition,1") -- AKE.scr:172
    if ctx:condition("nPosition>4") then -- AKE.scr:174
        ctx:command("nposition", "= 1") -- AKE.scr:175
    end -- AKE.scr:176
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("set", "shutup, 0") -- AKE.scr:217
    ctx:command("set", "sound, 0") -- AKE.scr:218
    ctx:command("set", "g_ntemp, 1") -- AKE.scr:219
    if ctx:hasKey(114) then -- AKE.scr:220-221
        ctx:command("set", "sound, 1") -- AKE.scr:222
    end -- AKE.scr:223
    mm9.gosub(script, ctx, "SetupPosition") -- AKE.scr:225
    ctx:command("onpostminisaveload", "PostMiniSaveLoad") -- AKE.scr:226
