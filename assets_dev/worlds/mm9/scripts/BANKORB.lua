...
script.labels["OnRude"] = function(ctx)
    ...
    if ctx:hasKey(330) then -- BANKORB.scr:51-52
        ...
        if ctx:hasKey("nKey") then -- BANKORB.scr:54-55
            ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 24000, "FALSE", 100) -- BANKORB.scr:56
...
script.labels["CheckAll"] = function(ctx)
    ...
    ctx:state().g_ncounter = 0 -- BANKORB.scr:75
    if ctx:hasKey(331) then -- BANKORB.scr:77-78
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- BANKORB.scr:79
    end -- BANKORB.scr:80
    if ctx:hasKey(332) then -- BANKORB.scr:82-83
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- BANKORB.scr:84
    end -- BANKORB.scr:85
    if ctx:hasKey(333) then -- BANKORB.scr:87-88
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- BANKORB.scr:89
    end -- BANKORB.scr:90
    if ctx:hasKey(334) then -- BANKORB.scr:92-93
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- BANKORB.scr:94
    end -- BANKORB.scr:95
    if ctx:hasKey(335) then -- BANKORB.scr:97-98
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- BANKORB.scr:99
    end -- BANKORB.scr:100
    if ctx:hasKey(336) then -- BANKORB.scr:102-103
        ctx:state().g_ncounter = (tonumber(ctx:state().g_ncounter) or 0) + 1 -- BANKORB.scr:104
    end -- BANKORB.scr:105
    if ctx:condition("g_ncounter==6") then -- BANKORB.scr:107
        ...
        ctx:playSound("sounds\\events\\quest.wav", "DoNothing", 100, 240, "FALSE", 100) -- BANKORB.scr:111
    end -- BANKORB.scr:112
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "Init") -- BANKORB.scr:182
    ctx:onEvent("OnPostMiniSaveLoad", "Init") -- BANKORB.scr:183
    ctx:onEvent("OnPostSaveLoad", "Init") -- BANKORB.scr:184
    ctx:onEvent("OnPostSaveLoad", "Init") -- BANKORB.scr:185
    ctx:wait(1, .1, "Init") -- BANKORB.scr:186
