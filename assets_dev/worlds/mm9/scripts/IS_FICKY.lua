...
script.labels["PickMarker"] = function(ctx)
    -- IS_FICKY.scr:36
    ctx:randomInt(0, "nNumMarkers", "nMarker") -- IS_FICKY.scr:39
    if ctx:condition("nMarker == nPrevMarker") then -- IS_FICKY.scr:40
        ...
        ctx:set("nPrevMarker", "nMarker") -- IS_FICKY.scr:43
    end -- IS_FICKY.scr:44
...
script.labels["Go"] = function(ctx)
    ...
    ctx:set("sMarker", "sMarkerRoot") -- IS_FICKY.scr:53
    ctx:add("sMarker", "nMarker") -- IS_FICKY.scr:54
    ctx:state().hMarker = ctx:objectOrNil("sMarker") -- IS_FICKY.scr:55
    ctx:self():walkTo(ctx:object("hMarker"), 30, "Go") -- IS_FICKY.scr:56
...
script.labels["scatter"] = function(ctx)
    ...
    if ctx:condition("nCount < nNumBirds") then -- IS_FICKY.scr:64
        ctx:set("sBirdName", "sBirdNameRoot + nCount") -- IS_FICKY.scr:65
        ctx:object("sBirdName"):trigger("go") -- IS_FICKY.scr:66-67
        ctx:set("nCount", "nCount + 1") -- IS_FICKY.scr:68
        ctx:wait(0, .2, "scatter") -- IS_FICKY.scr:69
    else -- IS_FICKY.scr:70
        -- Gosub go
        ctx:removeTrigger("scatter") -- IS_FICKY.scr:72
    end -- IS_FICKY.scr:73
...
script.labels["Main"] = function(ctx)
    ...
    ctx:set("nNumMarkers", "nNumMarkers - 1") -- IS_FICKY.scr:88
    ctx:addTrigger("Scatter", "scatter") -- IS_FICKY.scr:89
    mm9.gosub(script, ctx, "Go") -- IS_FICKY.scr:90
    ctx:onEvent("OnStuck", "Go") -- IS_FICKY.scr:91
