...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnCacheFiles", "CacheFiles") -- LICHLABCAMERA.scr:19
...
script.labels["CacheFiles"] = function(ctx)
    ...
    -- cache all for scene
    ctx:cacheClientFx("SPELL_DARKGRASP") -- LICHLABCAMERA.scr:27
    ctx:cacheClientFx("SPELL_PARALYZE") -- LICHLABCAMERA.scr:28
    ctx:cacheClientFx("SPELL_ELEMBLAST") -- LICHLABCAMERA.scr:29
    ctx:cacheClientFx("SPELL_SPARKLIES") -- LICHLABCAMERA.scr:30
    ctx:cacheClientFx("SPELL_TRANSFUSION") -- LICHLABCAMERA.scr:31
    ctx:cacheClientFx("SPELL_BLUEFIRE") -- LICHLABCAMERA.scr:32
    do return ctx:exit("TRUE") end -- LICHLABCAMERA.scr:34
end

script.labels["SoftExit"] = function(ctx)
    -- LICHLABCAMERA.scr:37
    ctx:removeTrigger("next") -- LICHLABCAMERA.scr:39
    ctx:addTrigger("next", "StartNextScene") -- LICHLABCAMERA.scr:40
    mm9.gosub(script, ctx, "RemoveCreatures") -- LICHLABCAMERA.scr:42
    ctx:screenFadeOut(0) -- LICHLABCAMERA.scr:44
    ctx:wait(0, 2, "SoftEntrance") -- LICHLABCAMERA.scr:46
...
script.labels["SoftEntrance"] = function(ctx)
    ...
    ctx:screenFadeIn(2) -- LICHLABCAMERA.scr:54
    do return ctx:exit("TRUE") end -- LICHLABCAMERA.scr:56
end

script.labels["OnSceneDone"] = function(ctx)
    -- LICHLABCAMERA.scr:59
    ctx:screenFadeOut(0) -- LICHLABCAMERA.scr:61
    ctx:screenFadeIn(4) -- LICHLABCAMERA.scr:62
