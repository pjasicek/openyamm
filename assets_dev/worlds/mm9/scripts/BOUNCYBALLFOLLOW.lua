...
script.labels["CheckPlayer"] = function(ctx)
    ...
    ctx:state().PlayerToChase = ctx:player() -- BOUNCYBALLFOLLOW.scr:46
    if ctx:condition("PlayerToChase==NULL") then -- BOUNCYBALLFOLLOW.scr:48
        ctx:state().Chasing = 0 -- BOUNCYBALLFOLLOW.scr:49
        mm9.gosub(script, ctx, "ReturnToCenter") -- BOUNCYBALLFOLLOW.scr:50
    end -- BOUNCYBALLFOLLOW.scr:51
    ctx:state().xplayer, ctx:state().yplayer, ctx:state().zplayer = ctx:player():pos() -- BOUNCYBALLFOLLOW.scr:53
    -- Get the position of the Bouncy Ball
    ctx:state().xball, ctx:state().yball, ctx:state().zball = ctx:self():pos() -- BOUNCYBALLFOLLOW.scr:57
    ctx:state().Chasing = 1 -- BOUNCYBALLFOLLOW.scr:59
    -- MoveToPos xplayer, yball, zplayer, velocity
    ctx:self():faceObject(ctx:player(), 90) -- BOUNCYBALLFOLLOW.scr:63
    mm9.gosub(script, ctx, "Bounce") -- BOUNCYBALLFOLLOW.scr:65
    ctx:wait(.1, .1, "CheckPlayer") -- BOUNCYBALLFOLLOW.scr:67
...
script.labels["Bounce"] = function(ctx)
    ...
    if ctx:condition("xplayer > xball") then -- BOUNCYBALLFOLLOW.scr:75
        ctx:state().xball = (tonumber(ctx:state().xball) or 0) - 1 -- BOUNCYBALLFOLLOW.scr:76
    end -- BOUNCYBALLFOLLOW.scr:77
    if ctx:condition("zplayer > xball") then -- BOUNCYBALLFOLLOW.scr:79
        ctx:state().xball = (tonumber(ctx:state().xball) or 0) - 1 -- BOUNCYBALLFOLLOW.scr:80
    end -- BOUNCYBALLFOLLOW.scr:81
    if ctx:condition("xplayer < xball") then -- BOUNCYBALLFOLLOW.scr:83
        ctx:state().xball = (tonumber(ctx:state().xball) or 0) + 1 -- BOUNCYBALLFOLLOW.scr:84
    end -- BOUNCYBALLFOLLOW.scr:85
    if ctx:condition("zplayer < xball") then -- BOUNCYBALLFOLLOW.scr:87
        ctx:state().xball = (tonumber(ctx:state().xball) or 0) + 1 -- BOUNCYBALLFOLLOW.scr:88
    end -- BOUNCYBALLFOLLOW.scr:89
    if ctx:condition("up==TRUE") then -- BOUNCYBALLFOLLOW.scr:91
        ctx:state().heightcounter = (tonumber(ctx:state().heightcounter) or 0) + 16 -- BOUNCYBALLFOLLOW.scr:92
        ctx:state().yball = (tonumber(ctx:state().yball) or 0) + 16 -- BOUNCYBALLFOLLOW.scr:93
        if ctx:condition("heightcounter > bounceheight") then -- BOUNCYBALLFOLLOW.scr:94
            ctx:state().up = 0 -- BOUNCYBALLFOLLOW.scr:95
        end -- BOUNCYBALLFOLLOW.scr:96
    end -- BOUNCYBALLFOLLOW.scr:97
    if ctx:condition("up=FALSE") then -- BOUNCYBALLFOLLOW.scr:98
        ctx:state().heightcounter = (tonumber(ctx:state().heightcounter) or 0) - 16 -- BOUNCYBALLFOLLOW.scr:99
        ctx:state().yball = (tonumber(ctx:state().yball) or 0) - 16 -- BOUNCYBALLFOLLOW.scr:100
        if ctx:condition("heightcounter < 0") then -- BOUNCYBALLFOLLOW.scr:101
            ctx:state().up = 1 -- BOUNCYBALLFOLLOW.scr:102
        end -- BOUNCYBALLFOLLOW.scr:103
    end -- BOUNCYBALLFOLLOW.scr:104
    ctx:self():moveToPos("xball", "yball", "zball", 1000) -- BOUNCYBALLFOLLOW.scr:106
    ctx:debugOut("heightcounter") -- BOUNCYBALLFOLLOW.scr:108
    ctx:debugOut("xball") -- BOUNCYBALLFOLLOW.scr:109
    ctx:debugOut("xplayer") -- BOUNCYBALLFOLLOW.scr:110
    ctx:debugOut("yball") -- BOUNCYBALLFOLLOW.scr:111
    ctx:debugOut("yplayer") -- BOUNCYBALLFOLLOW.scr:112
    ctx:debugOut("zball") -- BOUNCYBALLFOLLOW.scr:113
    ctx:debugOut("zplayer") -- BOUNCYBALLFOLLOW.scr:114
...
script.labels["Main"] = function(ctx)
    ...
    ctx:state().xstart, ctx:state().ystart, ctx:state().zstart = ctx:self():pos() -- BOUNCYBALLFOLLOW.scr:138
    -- set up the triggers
    ...
    if ctx:condition("g_nTemp!=0") then -- BOUNCYBALLFOLLOW.scr:147
        ctx:set("velocity", "g_nTemp") -- BOUNCYBALLFOLLOW.scr:148
    ...
    if ctx:condition("g_nTemp!=0") then -- BOUNCYBALLFOLLOW.scr:153
        ctx:set("chasearea", "g_nTemp") -- BOUNCYBALLFOLLOW.scr:154
    ...
    if ctx:condition("g_nTemp!=0") then -- BOUNCYBALLFOLLOW.scr:159
        ctx:set("bounceheight", "g_nTemp") -- BOUNCYBALLFOLLOW.scr:160
