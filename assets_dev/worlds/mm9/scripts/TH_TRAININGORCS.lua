...
script.labels["Start"] = function(ctx)
    ...
    ctx:state().bIsTraining = true -- TH_TRAININGORCS.scr:19
...
script.labels["TurnOff"] = function(ctx)
    ...
    ctx:wait(1, 1, "DoNothing") -- TH_TRAININGORCS.scr:25
    ctx:state().bIsTraining = false -- TH_TRAININGORCS.scr:26
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnPostStartWorld", "Main2") -- TH_TRAININGORCS.scr:74
