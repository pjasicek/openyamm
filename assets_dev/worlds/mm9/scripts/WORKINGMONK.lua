...
script.labels["OnUse"] = function(ctx)
    ...
    if ctx:condition("NPC_ID!=NULL") then -- WORKINGMONK.scr:46
        ctx:state().Talking = true -- WORKINGMONK.scr:47
        ctx:self():stop() -- WORKINGMONK.scr:48
        mm9.gosub(script, ctx, "BasewanderStop") -- WORKINGMONK.scr:49
        ctx:self():getCurrentAnimation("g_ntemp") -- WORKINGMONK.scr:51
        ctx:self():getAnimationName("g_ntemp", "g_stemp") -- WORKINGMONK.scr:52
        -- cprint g_stemp
        -- if (g_stemp==Monk_Anim)
        ctx:self():playAnimation("Fidget_Name", "FidgetStand") -- WORKINGMONK.scr:55
        -- endif
        ctx:getParam(0, "g_hobject") -- WORKINGMONK.scr:57
        ctx:self():faceObject(ctx:object("g_hobject"), 200, "DoNothing") -- WORKINGMONK.scr:58
        ctx:self():pauseWait(-1) -- WORKINGMONK.scr:59
...
script.labels["FidgetStand"] = function(ctx)
    -- WORKINGMONK.scr:68
    ctx:self():loopAnimation("Fidget_Stand", 0, "Donothing") -- WORKINGMONK.scr:72
    do return ctx:exit("TRUE") end -- WORKINGMONK.scr:74
end

script.labels["OnRude"] = function(ctx)
    -- WORKINGMONK.scr:77
    ctx:self():resumeWait(-1) -- WORKINGMONK.scr:81
    ctx:state().talking = false -- WORKINGMONK.scr:82
    ctx:state().g_hobject2 = ctx:objectOrNil("Face_Object") -- WORKINGMONK.scr:83
    if ctx:condition("g_hobject2!=NULL") then -- WORKINGMONK.scr:85
        ctx:self():faceObject(ctx:object("g_hobject2"), 200, "DoNothing") -- WORKINGMONK.scr:86
    end -- WORKINGMONK.scr:87
    ctx:self():loopAnimation("Monk_Anim", 0, "Donothing") -- WORKINGMONK.scr:89
...
script.labels["OnDamage"] = function(ctx)
    -- WORKINGMONK.scr:100
    ctx:self():detachProp(ctx:object("g_hobject2"), "false") -- WORKINGMONK.scr:104
    ctx:object("g_hobject2"):remove() -- WORKINGMONK.scr:105
    ctx:state().Attacked = true -- WORKINGMONK.scr:106
...
script.labels["SetupWork"] = function(ctx)
    -- WORKINGMONK.scr:112
    ctx:self():attachProp("Prop_Name", "Skin_Name", "Socket_Name", ctx:object("g_hobject2")) -- WORKINGMONK.scr:114
    ctx:state().Working = true -- WORKINGMONK.scr:115
    ctx:self():loopAnimation("Fidget_Stand", 0, "Donothing") -- WORKINGMONK.scr:117
    do return ctx:exit("") end -- WORKINGMONK.scr:119
end

script.labels["StartWork"] = function(ctx)
    -- WORKINGMONK.scr:122
    ctx:randomInt(1, 10, "g_ntemp") -- WORKINGMONK.scr:125
    ctx:wait(1, "g_ntemp", "OnWorkStart") -- WORKINGMONK.scr:126
    do return ctx:exit("") end -- WORKINGMONK.scr:127
end

script.labels["OnWorkStart"] = function(ctx)
    -- WORKINGMONK.scr:130
    ctx:state().Working = true -- WORKINGMONK.scr:133
    ctx:wait(1, 500, "Rest") -- WORKINGMONK.scr:134
    ctx:self():loopAnimation("Monk_Anim", 0, "Donothing") -- WORKINGMONK.scr:135
...
script.labels["Rest"] = function(ctx)
    -- WORKINGMONK.scr:142
    ctx:self():playAnimation("Fidget_Name", "StartWork") -- WORKINGMONK.scr:145
    do return ctx:exit("") end -- WORKINGMONK.scr:146
end

script.labels["BaseWanderGo"] = function(ctx)
    -- WORKINGMONK.scr:149
    ctx:self():playAnimation("Fidget_Name", "WanderGo") -- WORKINGMONK.scr:152
    do return ctx:exit("") end -- WORKINGMONK.scr:153
end

script.labels["WanderGo"] = function(ctx)
    -- WORKINGMONK.scr:156
    ctx:self():loopAnimation("Fidget_Stand", 0, "Donothing") -- WORKINGMONK.scr:159
...
script.labels["BaseWanderStopTick"] = function(ctx)
    -- WORKINGMONK.scr:167
    ctx:wait("WANDER_LEASH_WAIT", 0, "DoNothing") -- WORKINGMONK.scr:170
    ctx:self():stop() -- WORKINGMONK.scr:171
    ctx:self():loopAnimation("Monk_Anim", 0, "Donothing") -- WORKINGMONK.scr:172
...
script.labels["BaseWanderObstacle"] = function(ctx)
    ...
    ctx:randomInt(0, 100, "g_nRandom") -- WORKINGMONK.scr:184
    ctx:getParam(0, "g_hObject") -- WORKINGMONK.scr:186
    ctx:state().g_bTemp = ctx:object("g_hObject"):isClass("Actor") -- WORKINGMONK.scr:187
    ...
    ctx:self():stop() -- WORKINGMONK.scr:204
    ctx:self():loopAnimation("Monk_Anim", 0, "Donothing") -- WORKINGMONK.scr:205
    ctx:wait("WANDER_LEASH_WAIT", 0, "DoNothing") -- WORKINGMONK.scr:206
    ctx:state().bObstacle = true -- WORKINGMONK.scr:207
    mm9.gosub(script, ctx, "BaseWanderResume") -- WORKINGMONK.scr:208
    ctx:getParam(0, "g_hObject") -- WORKINGMONK.scr:210
    ctx:state().g_bTemp = ctx:object("g_hObject"):isClass("Actor") -- WORKINGMONK.scr:211
    if ctx:condition("g_bTemp==FALSE") then -- WORKINGMONK.scr:212
        ctx:self():faceDir("normalX", 0, "normalZ", 360) -- WORKINGMONK.scr:213
...
script.labels["WorkInit"] = function(ctx)
    ...
    if ctx:condition("Monk_Anim==Hoe") then -- WORKINGMONK.scr:223
        ctx:set("Prop_Name", "MonkHoe.ABC") -- WORKINGMONK.scr:224
        ctx:set("Skin_Name", "MonkHoe.dtx") -- WORKINGMONK.scr:225
        ctx:set("Socket_Name", "Hoe") -- WORKINGMONK.scr:226
        ctx:set("Fidget_Name", "HoeFidget") -- WORKINGMONK.scr:227
        ctx:set("Fidget_Stand", "Hoewait") -- WORKINGMONK.scr:228
    ...
    if ctx:condition("Monk_Anim==Sweep") then -- WORKINGMONK.scr:232
        ctx:set("Prop_Name", "MonkBroom.ABC") -- WORKINGMONK.scr:233
        ctx:set("Skin_Name", "MonkBroom.dtx") -- WORKINGMONK.scr:234
        ctx:set("Socket_Name", "Broom") -- WORKINGMONK.scr:235
        ctx:set("Fidget_Name", "sweepfidget") -- WORKINGMONK.scr:236
        ctx:set("Fidget_Stand", "Sweepwait") -- WORKINGMONK.scr:237
    ...
    if ctx:condition("Monk_Anim==Hammer") then -- WORKINGMONK.scr:241
        ctx:set("Prop_Name", "MonkHammer.ABC") -- WORKINGMONK.scr:242
        ctx:set("Skin_Name", "MonkHammer.dtx") -- WORKINGMONK.scr:243
        ctx:set("Socket_Name", "Hammer") -- WORKINGMONK.scr:244
        ctx:set("Fidget_Name", "HammerFidget") -- WORKINGMONK.scr:245
        ctx:set("Fidget_Stand", "Hammerwait") -- WORKINGMONK.scr:246
    ...
    if ctx:condition("Monk_Anim==Wash") then -- WORKINGMONK.scr:250
        ctx:set("Prop_Name", "MonkCloth.ABC") -- WORKINGMONK.scr:251
        ctx:set("Skin_Name", "MonkCloth.dtx") -- WORKINGMONK.scr:252
        ctx:set("Socket_Name", "Cloth") -- WORKINGMONK.scr:253
        ctx:set("Fidget_Name", "WashFidget") -- WORKINGMONK.scr:254
        ctx:set("Fidget_Stand", "WashWait") -- WORKINGMONK.scr:255
...
script.labels["Main"] = function(ctx)
    ...
    ctx:onEvent("OnDamage", "OnDamage") -- WORKINGMONK.scr:283
    ctx:onEvent("OnPostStartWorld", "Init") -- WORKINGMONK.scr:284
    -- jsl-->OnPostMiniSaveLoad Init
    -- jsl-->OnPostSaveLoad Init
    ctx:wait(1, .1, "Init") -- WORKINGMONK.scr:287
