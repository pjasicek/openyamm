...
script.labels["OnUse"] = function(ctx)
    ...
    ctx:self():faceObject(ctx:object("g_hObject"), 180) -- ZOMBIECAMP.scr:39
...
script.labels["ZombieOnAlert"] = function(ctx)
    ...
    if ctx:condition("g_hTarget!=NULL") then -- ZOMBIECAMP.scr:46
        ...
        ctx:randomInt(0, 100, "g_nRandom") -- ZOMBIECAMP.scr:48
    ...
    ctx:state().sAlertName = ctx:object("hAlertedBy"):className() -- ZOMBIECAMP.scr:55
    ...
    ctx:state().g_sTemp = ctx:object("g_hObject"):className() -- ZOMBIECAMP.scr:66
    ...
    ctx:set("g_hTarget", "g_hObject") -- ZOMBIECAMP.scr:72
    ctx:self():setTarget(ctx:object("g_hTarget")) -- ZOMBIECAMP.scr:73
...
script.labels["ZombieFindTarget"] = function(ctx)
    -- ZOMBIECAMP.scr:80
    ctx:getObjects("g_sEnemyName", 50000, 5, "g_hEnemyArray", "g_nObjects") -- ZOMBIECAMP.scr:82
    if ctx:condition("g_nObjects != NULL") then -- ZOMBIECAMP.scr:84
        if ctx:condition("g_hTarget == NULL") then -- ZOMBIECAMP.scr:85
            ...
            ctx:state().g_nObjects = (tonumber(ctx:state().g_nObjects) or 0) - 1 -- ZOMBIECAMP.scr:87
            ctx:randomInt(0, "g_nObjects", "g_nRandom") -- ZOMBIECAMP.scr:88
            ctx:arrayGet("g_hEnemyArray", "g_nRandom", "g_hTarget") -- ZOMBIECAMP.scr:89
            ctx:self():setTarget(ctx:object("g_hTarget")) -- ZOMBIECAMP.scr:90
        ...
        ctx:self():setIdle() -- ZOMBIECAMP.scr:97
        ctx:wait(0, 5, "ZombieFindTarget") -- ZOMBIECAMP.scr:98
...
script.labels["ZombieTargetDead"] = function(ctx)
    ...
    ctx:self():setTarget(nil) -- ZOMBIECAMP.scr:109
    ctx:state().g_hTarget = nil -- ZOMBIECAMP.scr:110
...
script.labels["ZombieDamageDone"] = function(ctx)
    ...
    ctx:state().sAlertName = ctx:object("g_hAttacker"):className() -- ZOMBIECAMP.scr:136
...
script.labels["ZombieAttackReady"] = function(ctx)
    ...
    ctx:state().sAlertName = ctx:object("g_hTarget"):className() -- ZOMBIECAMP.scr:156
    if ctx:condition("sAlertName == g_sMyClassName") then -- ZOMBIECAMP.scr:157
        ctx:self():setTarget(nil) -- ZOMBIECAMP.scr:158
        ctx:state().g_hTarget = nil -- ZOMBIECAMP.scr:159
        mm9.gosub(script, ctx, "ZombieFindTarget") -- ZOMBIECAMP.scr:160
    else -- ZOMBIECAMP.scr:161
        ctx:state().g_bFighting = true -- ZOMBIECAMP.scr:162
        ctx:getTime("g_nLastAttackTime") -- ZOMBIECAMP.scr:163
        ctx:self():attack() -- ZOMBIECAMP.scr:164
...
script.labels["ZombieLostTarget"] = function(ctx)
    ...
    if ctx:condition("g_hTarget != NULL") then -- ZOMBIECAMP.scr:174
        ctx:self():setTarget(ctx:object("g_hTarget")) -- ZOMBIECAMP.scr:175
        mm9.gosub(script, ctx, "BaseGoGetHim") -- ZOMBIECAMP.scr:176
    else -- ZOMBIECAMP.scr:177
        ctx:self():setTarget(nil) -- ZOMBIECAMP.scr:178
        ctx:state().g_hTarget = nil -- ZOMBIECAMP.scr:179
...
script.labels["ZombieOutOfRangeWait"] = function(ctx)
    ...
    ctx:state().g_bAttacking = ctx:self():isAttacking() -- ZOMBIECAMP.scr:197
    if ctx:condition("g_bAttacking==TRUE") then -- ZOMBIECAMP.scr:199
        ctx:wait(0, 0.5, "ZombieOutOfRangeWait") -- ZOMBIECAMP.scr:200
        do return ctx:exit("TRUE") end -- ZOMBIECAMP.scr:201
    end -- ZOMBIECAMP.scr:202
    ctx:state().g_bCanAttack = ctx:self():canAttack() -- ZOMBIECAMP.scr:204
    if ctx:condition("g_bCanAttack==TRUE") then -- ZOMBIECAMP.scr:205
        ctx:state().g_bAttacking = ctx:self():isAttacking() -- ZOMBIECAMP.scr:206
    ...
    ctx:randomInt(0, 100, "g_nRandom") -- ZOMBIECAMP.scr:217
    if ctx:condition("g_nRandom < 30") then -- ZOMBIECAMP.scr:219
        if ctx:condition("g_nRandom < 15") then -- ZOMBIECAMP.scr:220
            ctx:self():taunt("ZombieAttackWaitAnimDone") -- ZOMBIECAMP.scr:221
        else -- ZOMBIECAMP.scr:222
            ctx:self():aware("ZombieAttackWaitAnimDone") -- ZOMBIECAMP.scr:223
    ...
    ctx:self():walkTo(ctx:object("g_hTarget")) -- ZOMBIECAMP.scr:231
    -- Wait 0, 0.5, ZombieOutOfRangeWalkingWait
    -- Exit TRUE
    -- endif
    -- Continue waiting....
    ctx:wait(0, 0.5, "ZombieOutOfRangeWait") -- ZOMBIECAMP.scr:238
...
script.labels["ZombieStuckDone"] = function(ctx)
    ...
    if ctx:condition("g_nStuckTime==0.0") then -- ZOMBIECAMP.scr:260
        ctx:getTime("g_nStuckTime") -- ZOMBIECAMP.scr:261
    else -- ZOMBIECAMP.scr:262
        ctx:getTime("g_nTemp") -- ZOMBIECAMP.scr:263
        ctx:sub("g_nTemp", "g_nStuckTime") -- ZOMBIECAMP.scr:264
        if ctx:condition("g_nTemp > MIN_STUCK_TIME") then -- ZOMBIECAMP.scr:266
            ctx:state().g_nStuckTime = 0 -- ZOMBIECAMP.scr:267
...
script.labels["ZombieOutOfRangeWalkingWait"] = function(ctx)
    ...
    -- we are attack ready...
    ctx:state().g_bCanAttack = ctx:self():canAttack() -- ZOMBIECAMP.scr:285
    if ctx:condition("g_bCanAttack==TRUE") then -- ZOMBIECAMP.scr:286
        ctx:state().g_bAttacking = ctx:self():isAttacking() -- ZOMBIECAMP.scr:287
    ...
    ctx:wait(0, 0.5, "ZombieOutOfRangeWait") -- ZOMBIECAMP.scr:297
...
script.labels["ZombieTargetOutOfRange"] = function(ctx)
    ...
    -- Go after him!
    ctx:state().g_bCanAttack = ctx:self():canAttack() -- ZOMBIECAMP.scr:319
    ctx:state().g_bAttacking = ctx:self():isAttacking() -- ZOMBIECAMP.scr:320
    if ctx:condition("g_bAttacking==TRUE") then -- ZOMBIECAMP.scr:322
        ctx:wait(0, 0.5, "ZombieOutOfRangeWait") -- ZOMBIECAMP.scr:323
    ...
    if ctx:condition("g_bCanAttack==TRUE") then -- ZOMBIECAMP.scr:326
        ...
        ctx:wait(0, 0.5, "ZombieOutOfRangeWait") -- ZOMBIECAMP.scr:329
...
script.labels["ZombieObstacle"] = function(ctx)
    ...
    ctx:state().g_sObstacleName = ctx:object("g_hObstacle"):className() -- ZOMBIECAMP.scr:340
    if ctx:condition("g_sObstacleName == g_sEnemyName") then -- ZOMBIECAMP.scr:342
        ctx:randomInt(0, 10, "g_nRandom") -- ZOMBIECAMP.scr:343
        if ctx:condition("g_nRandom > 3") then -- ZOMBIECAMP.scr:344
            ctx:set("g_hTarget", "g_hObstacle") -- ZOMBIECAMP.scr:345
            ctx:self():setTarget(ctx:object("g_hTarget")) -- ZOMBIECAMP.scr:346
...
script.labels["Init"] = function(ctx)
    -- ZOMBIECAMP.scr:367
    ctx:state().g_hCampDirector = ctx:objectOrNil("CampDirector") -- ZOMBIECAMP.scr:370
    ctx:state().g_hTarget = ctx:self():target() -- ZOMBIECAMP.scr:372
...
script.labels["Main"] = function(ctx)
    ...
    -- at script startup...
    ctx:state().g_sMyClassName = ctx:self():className() -- ZOMBIECAMP.scr:388
    -- Setup our event handlers...
    -- Base callbacks
    ctx:onEvent("OnDamage", "BaseDamage") -- ZOMBIECAMP.scr:396
    ctx:onEvent("OnPathClear", "BasePathClear") -- ZOMBIECAMP.scr:397
    -- OnObstacle					BaseObstacle
    -- Zombie script call backs
    ctx:onEvent("OnAlert", "ZombieOnAlert") -- ZOMBIECAMP.scr:401
    ctx:onEvent("OnTargetDead", "ZombieTargetDead") -- ZOMBIECAMP.scr:402
    ctx:onEvent("OnDamageDone", "ZombieDamageDone") -- ZOMBIECAMP.scr:403
    ctx:onEvent("OnAttackReady", "ZombieAttackReady") -- ZOMBIECAMP.scr:404
    ctx:onEvent("OnLostTarget", "ZombieLostTarget") -- ZOMBIECAMP.scr:405
    ctx:onEvent("OnDeathDone", "ZombieDeathDone") -- ZOMBIECAMP.scr:406
    ctx:onEvent("OnTargetOutOfRange", "ZombieTargetOutOfRange") -- ZOMBIECAMP.scr:407
    ctx:onEvent("OnStuckDone", "ZombieStuckDone") -- ZOMBIECAMP.scr:408
    ctx:onEvent("OnObstacle", "ZombieObstacle") -- ZOMBIECAMP.scr:409
    ctx:state().g_bHasRangeAttack = ctx:self():hasRangeAttack() -- ZOMBIECAMP.scr:412
    if ctx:condition("g_bHasRangeAttack == TRUE") then -- ZOMBIECAMP.scr:414
        -- OnFoundPlayer BaseFoundPlayerRange
    end -- ZOMBIECAMP.scr:416
    ctx:self():setTargetLostTime(30) -- ZOMBIECAMP.scr:418
    ctx:state().g_bAlwaysRunToTarget = true -- ZOMBIECAMP.scr:419
    ctx:set("g_sEnemyName", "Dwarf") -- ZOMBIECAMP.scr:420
    ...
    -- this one...
    ctx:wait(0, 0.1, "Init") -- ZOMBIECAMP.scr:428
