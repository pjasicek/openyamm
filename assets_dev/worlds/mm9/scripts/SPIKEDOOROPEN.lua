...
script.labels["OnUse"] = function(ctx)
    ...
    ctx:command("getmyhandle", "hMyDoor") -- SPIKEDOOROPEN.scr:17
...
script.labels["OnePulled"] = function(ctx)
    ...
    ctx:command("count", "= count + 1") -- SPIKEDOOROPEN.scr:26
...
script.labels["Main2"] = function(ctx)
    ...
    ctx:command("getobjecthandle", "ABDoorBoards0, hMyDoor") -- SPIKEDOOROPEN.scr:35
...
script.labels["main"] = function(ctx)
    ...
    ctx:command("wait", "0, 0.4, Main2") -- SPIKEDOOROPEN.scr:41
