...
script.labels["Init"] = function(ctx)
    -- NPC127.scr:29
    ctx:command("loopanim", "Sit 0 DoNothing") -- NPC127.scr:32
    if ctx:hasKey(40) then -- NPC127.scr:33-34
        ctx:command("set", "bVanish TRUE") -- NPC127.scr:35
        mm9.gosub(script, ctx, "vanish") -- NPC127.scr:36
    end -- NPC127.scr:37
    if ctx:hasKey(108) then -- NPC127.scr:39-40
        ctx:command("set", "bVanish False") -- NPC127.scr:41
...
script.labels["Vanish"] = function(ctx)
    -- NPC127.scr:49
    ctx:command("getmyhandle", "g_hobject") -- NPC127.scr:52
    if ctx:condition("bVanish==TRUE") then -- NPC127.scr:54
        ctx:command("clearflag", "g_hobject, visible") -- NPC127.scr:55
        ctx:command("clearflag", "g_hobject, solid") -- NPC127.scr:56
        ctx:command("clearflag", "g_hobject, gravity") -- NPC127.scr:57
        do return ctx:exit("") end -- NPC127.scr:58
    else -- NPC127.scr:59
        ctx:command("setflag", "g_hobject, visible") -- NPC127.scr:60
        ctx:command("setflag", "g_hobject, solid") -- NPC127.scr:61
        ctx:command("setflag", "g_hobject, gravity") -- NPC127.scr:62
...
script.labels["Bookofrules"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC127.scr:88
        ...
        if ctx:hasKey(61) then -- NPC127.scr:90-91
            ...
            ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- NPC127.scr:96
...
script.labels["Ivan"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC127.scr:120
        ...
        if ctx:hasKey(62) then -- NPC127.scr:122-123
            ...
            ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- NPC127.scr:128
...
script.labels["Dook"] = function(ctx)
    ...
    if ctx:condition("keycheck==0") then -- NPC127.scr:152
        ...
        if ctx:hasKey(66) then -- NPC127.scr:154-155
            ...
            ctx:command("playsound", "sounds\\events\\quest.wav, DoNothing, 100, 240, FALSE, 100") -- NPC127.scr:160
            -- gives reward
...
script.labels["OnUse"] = function(ctx)
    ...
    ctx:command("getrandomint", "1, 4, g_ntemp") -- NPC127.scr:181
    if ctx:condition("g_ntemp==1") then -- NPC127.scr:183
        ctx:command("playsound", "voices\\NPC\\NPC_127.wav, Onexit, 100, 240, FALSE, 100") -- NPC127.scr:184
        do return ctx:exit("") end -- NPC127.scr:185
    end -- NPC127.scr:186
    if ctx:condition("g_ntemp==2") then -- NPC127.scr:188
        ctx:command("playsound", "voices\\NPC\\NPC_127.wav, Onexit, 100, 240, FALSE, 100") -- NPC127.scr:189
        do return ctx:exit("") end -- NPC127.scr:190
    end -- NPC127.scr:191
    if ctx:condition("g_ntemp==3") then -- NPC127.scr:193
        ctx:command("playsound", "voices\\NPC\\NPC_127.wav, Onexit, 100, 240, FALSE, 100") -- NPC127.scr:194
        do return ctx:exit("") end -- NPC127.scr:195
    end -- NPC127.scr:196
    if ctx:condition("g_ntemp==4") then -- NPC127.scr:198
        ctx:command("playsound", "voices\\NPC\\NPC_127b.wav, Onexit, 100, 240, FALSE, 100") -- NPC127.scr:199
...
script.labels["Main"] = function(ctx)
    ...
    ctx:command("set", "Jarl, Markel") -- NPC127.scr:223
