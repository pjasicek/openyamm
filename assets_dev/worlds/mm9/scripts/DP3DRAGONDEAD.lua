...
script.labels["CheckAllMonsters"] = function(ctx)
    ...
    ctx:command("add", "Counter, 1") -- DP3DRAGONDEAD.scr:27
    ...
    ctx:command("getobjecthandle", "Door13, g_hobject") -- DP3DRAGONDEAD.scr:35
    ctx:trigger("g_hobject", "Open") -- DP3DRAGONDEAD.scr:36
    ctx:command("set", "BeenDone, true") -- DP3DRAGONDEAD.scr:37
    ctx:command("wait", "0.2, killme") -- DP3DRAGONDEAD.scr:38
    do return ctx:exit("") end -- DP3DRAGONDEAD.scr:41
end

script.labels["killme"] = function(ctx)
    -- DP3DRAGONDEAD.scr:44
    ctx:command("exitscript", "") -- DP3DRAGONDEAD.scr:47
end
