...
RegisterEvent(6, "Legacy event 6", function()
    ...
    if not HasItem(611) then return end -- Lost Book of Kehl
    SetQBit(QBit(210))
    return
end)
...
RegisterEvent(501, "Leave the Uplifted Library", function()
    evt.MoveToMap(14848, -19669, 257, 1536, 0, 0, 0, 0, "Out01.odm")
    return
