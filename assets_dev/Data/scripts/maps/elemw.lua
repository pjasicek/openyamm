...
RegisterEvent(12, "Riverglass' House", function()
    return
end, "Riverglass' House")
...
RegisterEvent(14, "Clearcreek's House", function()
    return
end, "Clearcreek's House")
...
RegisterEvent(22, "Black Current's House", function()
    return
end, "Black Current's House")
...
RegisterNoOpEvent(401, "Gate out of the Plane of Water", "Gate out of the Plane of Water")
