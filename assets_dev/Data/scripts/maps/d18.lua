...
RegisterEvent(11, "Door", function()
    ...
    evt.SummonMonsters(1, 3, 1, 416, 1296, -128, 1, 0)
    SetValue(MapVar(11), 1)
    return
end, "Door")

RegisterEvent(12, "Door", function()
    evt.SetDoorState(72, 2)
...
RegisterEvent(13, "Door", function()
    ...
    evt.SetDoorState(73, 2)
    evt.SetDoorState(3, 0)
    evt.SummonMonsters(1, 3, 1, 1744, 368, -128, 1, 0)
...
RegisterEvent(14, "Door", function()
    ...
    evt.SetDoorState(74, 2)
    evt.SetDoorState(4, 0)
    evt.SummonMonsters(1, 3, 1, 864, -560, -128, 1, 0)
...
RegisterEvent(15, "Door", function()
    ...
    evt.SetDoorState(75, 2)
    evt.SetDoorState(5, 0)
    evt.SummonMonsters(1, 3, 1, 416, -576, -128, 1, 0)
...
RegisterEvent(501, "Leave the Naga Vault", function()
    evt.MoveToMap(-14220, 2552, 290, 1536, 0, 0, 0, 0, "Out05.odm")
    return
